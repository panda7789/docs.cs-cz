...
Předpokládejme, že chcete vytvořit `StudentNotFoundException` , který obsahuje `StudentName` vlastnost.
...
Problém s předchozí čárou je `"The student cannot be found."` pouze konstantní řetězec. V lokalizované aplikaci chcete mít různé zprávy v závislosti na jazykové verzi uživatele.
...
1. Přidejte do něj nový soubor prostředků. Provedete to tak, že v aplikaci Visual Studio kliknete pravým tlačítkem na složku v **Průzkumník řešení**a vyberete **Přidat**  >  **Nový**  >  **soubor prostředků**položek. Pojmenujte soubor *ExceptionMessages. resx*. Toto je výchozí soubor prostředků.
