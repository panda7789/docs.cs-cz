...
LINQ poskytuje funkce pro dotazování na úrovni jazyka a rozhraní API s [vyšším pořadím](https://en.wikipedia.org/wiki/Higher-order_function) pro C# a Visual Basic jako způsob, jak napsat výrazující, deklarativní kód.
...
Stejný příklad s použitím `IEnumerable<T>` rozhraní API:
...
Úplný seznam ukázek LINQ najdete v [101Ch ukázkách LINQ](https://docs.microsoft.com/samples/dotnet/try-samples/101-linq-samples/).
...
* [Ukázky 101 LINQ](https://docs.microsoft.com/samples/dotnet/try-samples/101-linq-samples/)
