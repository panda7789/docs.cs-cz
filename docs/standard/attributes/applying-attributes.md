...
## <a name="applying-attributes-at-the-assembly-level"></a>Používání atributů na úrovni sestavení  
 ...
 Pokud použijete tento atribut, bude řetězec `"My Assembly"` umístěn v manifestu sestavení v části souboru s metadaty. Atribut můžete zobrazit buď pomocí [jazyka MSIL Disassembler (Ildasm. exe)](../../framework/tools/ildasm-exe-il-disassembler.md) , nebo vytvořením vlastního programu pro načtení atributu.  
