...
### [Implementace opakovaných volání HTTP exponenciálním omezením rychlosti knihovnou Polly](implement-resilient-applications/implement-http-call-retries-exponential-backoff-polly.md)
