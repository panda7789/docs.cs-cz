...
3. [Kompilace MSIL do nativního kódu](#compiling_msil_to_native_code).  
...
- Rozhraní .NET Framework [Ngen.exe (Nativní generátor obrázků)](../../docs/framework/tools/ngen-exe-native-image-generator.md).  
