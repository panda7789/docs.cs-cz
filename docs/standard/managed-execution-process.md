...
- .NET Framework [Ngen. exe (generátor nativních imagí)](../framework/tools/ngen-exe-native-image-generator.md).  
...
- [Jazyková nezávislost a jazykově nezávislé komponenty](language-independence-and-language-independent-components.md)
- [Metadata a komponenty popisující samy sebe](metadata-and-self-describing-components.md)
