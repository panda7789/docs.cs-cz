...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 [Postupy: extrahování protokolu a číslo portu z adresy URL](../../../docs/standard/base-types/how-to-extract-a-protocol-and-port-number-from-a-url.md)  
 ...
 [Postupy: Ověřte, zda řetězce jsou ve formátu platné e-mailu](../../../docs/standard/base-types/how-to-verify-that-strings-are-in-valid-email-format.md)  
 Poskytuje příklad, který můžete použít k ověření, že je řetězec ve formátu platné e-mailu.  
