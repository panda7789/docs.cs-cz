...
Regulární výrazy poskytují výkonný, flexibilní a efektivní způsob zpracování textu. Rozsáhlý zápis regulárních výrazů pro porovnávání vzorů umožňuje rychle analyzovat velké množství textu na:

- Najít konkrétní vzory znaků.
- Ověřte text, abyste zajistili, že odpovídá předdefinovanému vzoru (například e-mailové adrese).
- Extrahujte, upravujte, nahrazujte nebo odstraňujte textové podřetězce.
- Přidejte extrahované řetězce do kolekce za účelem generování sestavy.
...
## <a name="how-regular-expressions-work"></a>Jak fungují regulární výrazy
