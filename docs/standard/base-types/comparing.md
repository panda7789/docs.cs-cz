...
> <xref:System.String.Compare%2A?displayProperty=nameWithType> Metoda je primárně určena pro použití při řazení nebo řazení řetězců. Tuto <xref:System.String.Compare%2A?displayProperty=nameWithType> metodu byste neměli používat k otestování rovnosti (to znamená pro explicitní vyhledání návratové hodnoty 0 bez ohledu na to, zda je jeden řetězec menší nebo větší než druhý). Místo toho pro určení, zda jsou dva řetězce stejné, použijte <xref:System.String.Equals%28System.String%2CSystem.String%2CSystem.StringComparison%29?displayProperty=nameWithType> metodu.  
 ...
 Tento příklad se `-1` zobrazí v konzole nástroje.  
  
 V předchozím příkladu je standardně závislá na jazykové verzi. Chcete-li provést porovnání řetězců nezávisle na jazykové verzi, použijte přetížení <xref:System.String.Compare%2A?displayProperty=nameWithType> metody, která umožňuje určit jazykovou verzi, která má být použita, zadáním parametru *jazykové verze* . Příklad, který ukazuje, jak použít <xref:System.String.Compare%2A?displayProperty=nameWithType> metodu k provedení porovnání nezávislého na jazykové verzi, naleznete v tématu [provádění porovnávání řetězců nezávislých na jazykové verzi](../../../docs/standard/globalization-localization/performing-culture-insensitive-string-comparisons.md).  
...
> [!IMPORTANT]
> <xref:System.String.CompareOrdinal%2A?displayProperty=nameWithType> Metoda je primárně určena pro použití při řazení nebo řazení řetězců. Tuto <xref:System.String.CompareOrdinal%2A?displayProperty=nameWithType> metodu byste neměli používat k otestování rovnosti (to znamená pro explicitní vyhledání návratové hodnoty 0 bez ohledu na to, zda je jeden řetězec menší nebo větší než druhý). Místo toho pro určení, zda jsou dva řetězce stejné, použijte <xref:System.String.Equals%28System.String%2CSystem.String%2CSystem.StringComparison%29?displayProperty=nameWithType> metodu.  
 ...
 Tento příklad se `-32` zobrazí v konzole nástroje.  
...
> [!IMPORTANT]
> <xref:System.String.CompareTo%2A?displayProperty=nameWithType> Metoda je primárně určena pro použití při řazení nebo řazení řetězců. Tuto <xref:System.String.CompareTo%2A?displayProperty=nameWithType> metodu byste neměli používat k otestování rovnosti (to znamená pro explicitní vyhledání návratové hodnoty 0 bez ohledu na to, zda je jeden řetězec menší nebo větší než druhý). Místo toho pro určení, zda jsou dva řetězce stejné, použijte <xref:System.String.Equals%28System.String%2CSystem.String%2CSystem.StringComparison%29?displayProperty=nameWithType> metodu.  
  
 Následující příklad používá <xref:System.String.CompareTo%2A?displayProperty=nameWithType> metodu pro `string1` porovnání objektu s `string2` objektem.  
...
## <a name="equals"></a>Je rovno  
 ...
 Tento příklad se `True` zobrazí v konzole nástroje.  
...
## <a name="startswith-and-endswith"></a>StartsWith a EndsWith  
 ...
 Tento příklad se `False` zobrazí v konzole nástroje.  
...
## <a name="indexof-and-lastindexof"></a>IndexOf a LastIndexOf  
 ...
 Tento příklad se `2` zobrazí v konzole nástroje.  
 ...
 Tento příklad se `9` zobrazí v konzole nástroje.  
