...
description: Přečtěte si o složeném formátování aplikace .NET, které přijímá jako vstupní seznam objektů a složený formátovací řetězec obsahující pevný text s indexovanými zástupnými symboly.
ms.date: 10/26/2018
