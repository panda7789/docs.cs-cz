 ...
 **Poznámka:** Další informace o delegáti obecně platí, najdete v části [delegáti](../../csharp/programming-guide/delegates/index.md) a [delegáti](../../visual-basic/programming-guide/language-features/delegates/index.md). Další informace o výrazy lambda v jazyce C# a [!INCLUDE[vbprvb](../../../includes/vbprvb-md.md)], najdete v části [výrazy Lambda](~/docs/csharp/programming-guide/statements-expressions-operators/lambda-expressions.md) a [výrazy Lambda](~/docs/visual-basic/programming-guide/language-features/procedures/lambda-expressions.md).  
