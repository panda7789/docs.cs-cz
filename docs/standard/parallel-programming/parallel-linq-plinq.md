...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 [Porozumění zrychlení v PLINQ](../../../docs/standard/parallel-programming/understanding-speedup-in-plinq.md)  
 ...
 [Postupy: zápis agregační funkce vlastní PLINQ](../../../docs/standard/parallel-programming/how-to-write-a-custom-plinq-aggregate-function.md)  
