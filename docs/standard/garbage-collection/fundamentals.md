...
![Při aktivaci vlákno kolekce uvolnění paměti](../../../docs/standard/garbage-collection/media/gc-triggered.png "GC_Triggered") podproces, který spustí uvolnění paměti
...
![Vlákna uvolňování paměti serveru](../../../docs/standard/garbage-collection/media/gc-server.png "GC_Server") uvolnění paměti serveru
...
![Souběžných vláken pro uvolnění](../../../docs/standard/garbage-collection/media/gc-concurrent.png "GC_Concurrent") souběžné uvolňování paměti
