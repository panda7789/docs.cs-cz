...
description: Seznamte se s obecnými typy v .NET. Definujte & použít obecné typy, Naučte se jejich výhody & nevýhodami, principy knihovny tříd & jazykové podpory a další.
ms.date: 03/30/2017
