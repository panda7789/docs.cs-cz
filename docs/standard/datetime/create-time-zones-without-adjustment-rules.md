...
Toto téma ukazuje, jak vytvořit časových pásem bez pravidel úpravy. Vytvoření časového pásma, které podporuje pravidla úpravy letního času, najdete v tématu [postupy: vytváření časových pásem s pravidly úpravy](../../../docs/standard/datetime/create-time-zones-with-adjustment-rules.md).
