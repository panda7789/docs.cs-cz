...
-   Implementace Start a zrušit metody  
 ...
 Zkopírujte kód v tomto tématu v jednom seznamu, najdete v části [postupy: implementace komponenty, která podporuje asynchronní vzor založený na událostech](../../../docs/standard/asynchronous-programming-patterns/component-that-supports-the-event-based-asynchronous-pattern.md).  
