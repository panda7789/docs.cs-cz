...
## <a name="implementing-the-iserializable-interface"></a>Implementace rozhraní ISerializable  
 Druhý způsob, jak řídit serializaci, je dosaženo implementací <xref:System.Runtime.Serialization.ISerializable> rozhraní objektu. Upozorňujeme však, že metoda v předchozím oddílu nahrazuje tuto metodu za účelem serializace ovládacího prvku.  
