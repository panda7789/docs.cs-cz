...
Další informace o použití tohoto nástroje naleznete v tématu [Nástroj definice schématu XML (XSD. exe)](xml-schema-definition-tool-xsd-exe.md).  
