...
|Hodnota|Description|  
|-----------|-----------------|  
|**podmínka**|Vyhledá sestavení v adresářích určených proměnnou prostředí mechanismu DEVPATH.|  
|**chybné**|Nehledá sestavení v adresářích určených proměnnou prostředí mechanismu DEVPATH. Toto je výchozí nastavení.|  
