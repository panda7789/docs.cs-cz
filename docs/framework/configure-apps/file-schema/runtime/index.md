...
## <a name="the-runtime-section-and-its-parent-and-child-elements"></a>Oddíl > \<runtime a jeho nadřazené a podřízené prvky
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[\<> zjišťování](probing-element.md)\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[\<qualifyAssembly >](qualifyassembly-element.md)\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[\<značka supportportability >](supportportability-element.md)\
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[\<přidat >](add-element-for-namedcaches.md)\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[\<clear >](clear-element-for-namedcaches.md)\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[\<odebrat >](remove-element-for-namedcaches.md)  

## <a name="alphabetical-list-of-runtime-elements"></a>Abecední seznam > prvků \<runtime

|Prvek|Popis|
|-------------|-----------------|
|[\<přidat >](add-element-for-namedcaches.md)|Přidá pojmenovanou mezipaměť do kolekce `namedCaches` pro mezipaměť paměti.|
...
|[\<vymazat >](clear-element-for-namedcaches.md)|Vymaže kolekci `namedCaches` mezipaměti paměti.|
|[\<základ kódu >](codebase-element.md)|Určuje, kde modul runtime může najít sestavení.|
...
|[\<namedCaches >](namedcaches-element-cache-settings.md)|Obsahuje kolekci konfiguračních nastavení pro instanci `namedCache`.|
...
|[\<> zjišťování](probing-element.md)|Určuje podadresáře, které modul runtime vyhledává při načítání sestavení.|
...
|[\<odebrat >](remove-element-for-namedcaches.md)|Odebere pojmenovanou položku mezipaměti z kolekce `namedCaches` pro mezipaměť paměti.|
...
|[\<TimeSpan_LegacyFormatMode >](runtime-element.md)|Určuje, zda modul runtime používá pro <xref:System.TimeSpan> hodnoty formátování starší verze.|
