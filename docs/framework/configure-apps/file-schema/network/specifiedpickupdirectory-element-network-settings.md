...
---
# <a name="specifiedpickupdirectory-element-network-settings"></a>@no__t – element > 0specifiedPickupDirectory (nastavení sítě)
...
## <a name="remarks"></a>Poznámky  
 Atribut `specifiedPickupDirectory` Nastavuje adresář, ve kterém aplikace ukládají e-mailové zprávy, které server SMTP zpracuje.  
