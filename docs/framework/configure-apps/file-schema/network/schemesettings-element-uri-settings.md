...
Určuje, jak se <xref:System.Uri> bude analyzovat pro konkrétní schémata.  
...
|[odebrány](remove-element-for-schemesettings-uri-settings.md)|Odebere nastavení schématu pro název schématu.|  
