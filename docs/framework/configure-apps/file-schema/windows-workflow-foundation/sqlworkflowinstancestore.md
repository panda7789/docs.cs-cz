...
|instanceEncodingOption|Volitelné hodnotu, která určuje, zda informace o stavu instance je komprimován pomocí algoritmu GZip před informace jsou uloženy v úložišti stálost... Tato hodnota je typu `System.Activities.DurableInstancing.InstanceEncodingAction`. Možné hodnoty této vlastnosti nejsou "Žádný", který určuje bez komprese a "GZip", který určuje tato instance je komprimován a používá algoritmus gzip.|  
