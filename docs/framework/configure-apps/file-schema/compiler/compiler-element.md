...
\<Konfigurace Element > \<System.CodeDom – Element > \<kompilátory Element > \<kompilátoru > – Element
...
- [Zadání plně kvalifikované názvy typů]-(.. /.. /.. /.. /.. / docs/framework/reflection-and-codedom/specifying-fully-qualified-type-names.md)
