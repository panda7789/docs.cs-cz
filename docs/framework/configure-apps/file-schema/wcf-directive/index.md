...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Definuje atributy specifické pro stránku používané kompilátorem .svc. Mohou být součástí jenom hledání souborů .svc.  
  
## <a name="related-sections"></a>Související oddíly  
 [Postupy: Hostování služby WCF v IIS](../../../../../docs/framework/wcf/feature-details/how-to-host-a-wcf-service-in-iis.md)  
 Popisuje, jak @ServiceHost – direktiva se používá při hostování služby v Internetové informační služby (IIS)  
