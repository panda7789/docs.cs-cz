...
Určuje sadu požadovaných deklarací pro příchozí tokeny zabezpečení.  
...
|Prvek|Popis|  
|-------------|-----------------|  
|[\<claimType>](claimtype.md)|Určuje jednu volitelnou nebo požadovanou deklaraci příchozích tokenů zabezpečení.|  
