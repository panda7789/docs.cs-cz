...
---
# \<trustedIssuers>
Nakonfiguruje seznam certifikátů důvěryhodných vystavitelů, které používá registr názvů vystavitelů na základě konfigurace ( <xref:System.IdentityModel.Tokens.ConfigurationBasedIssuerNameRegistry> ).  
