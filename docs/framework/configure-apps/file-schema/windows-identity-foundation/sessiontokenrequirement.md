...
Poskytuje konfiguraci pro <xref:System.IdentityModel.Tokens.SessionSecurityTokenHandler> třídu nebo odvozené třídy.  
...
|Atribut|Popis|  
|---------------|-----------------|  
|doba platnosti|Určuje dobu života tokenů relací.|  
