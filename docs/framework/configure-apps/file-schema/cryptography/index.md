...
|Prvek|Description|  
|-------------|-----------------|  
|[**\<cryptoClasses**>](cryptoclasses-element.md)|Obsahuje seznam kryptografických tříd, které mají mapování na popisný název v **\<nameEntry>** elementu.|  
...
|[**\<mscorlib>**– element pro nastavení kryptografie](mscorlib-element-for-cryptography-settings.md)|Obsahuje **\<cryptographySettings>** element.|  
