...
## <a name="remarks"></a>Poznámky  
 Element `msmqTransport` umožňuje uživateli nastavit vlastnosti komunikačního kanálu ve frontě. Komunikační kanál ve frontě používá službu Řízení front zpráv pro přenos.  
