...
|deadLetterQueue|Určuje typ fronty nepoužívaných dopisů používat.<br /><br /> Platné hodnoty jsou<br /><br /> – Vlastní: Vlastní frontu nedoručených zpráv.<br />-Žádný: Žádná fronta nedoručených zpráv se má použít.<br />– System: Použití fronty nedoručených zpráv systému.<br /><br /> Tento atribut je typu DeadLetterQueue.|  
