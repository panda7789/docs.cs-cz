...
---
# <a name="participants-of-wcf"></a>\<participants>služby WCF
...
|Prvek|Description|  
|-------------|-----------------|  
|[\<tracking>](../windows-workflow-foundation/tracking.md)|Představuje konfiguračního oddílu pro definování nastavení sledování služby pracovního postupu.|  
