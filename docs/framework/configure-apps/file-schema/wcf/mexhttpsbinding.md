...
## <a name="remarks"></a>Poznámky  
 Tato vazba je v podstatě `WSHttpBinding` vazba, která podporuje zabezpečení na úrovni přenosu pomocí certifikátů. Další informace o konfiguraci a použití tohoto koncového bodu metadat naleznete v tématu [How to: Configure a Custom WS-Metadata Exchange Binding](../../../wcf/extending/how-to-configure-a-custom-ws-metadata-exchange-binding.md), [How to: načítat metadata přes vazbu mimo MEX](../../../wcf/extending/how-to-retrieve-metadata-over-a-non-mex-binding.md)a ukázkový [Vlastní zabezpečený koncový bod metadat](../../../wcf/samples/custom-secure-metadata-endpoint.md).  
