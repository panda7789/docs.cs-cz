# [Konfigurační schéma služby WCF](index.md)
...
######## [<add> z <defaultPorts>](add-of-defaultports.md)
...
####### [<connectionPoolSettings> z <namedPipeTransport>](connectionpoolsettings.md)
...
##### [<add> z <namespaceTable>](add-of-namespacetable.md)
