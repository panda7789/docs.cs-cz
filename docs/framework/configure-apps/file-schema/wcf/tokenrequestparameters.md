...
Tento element konfigurace obsahuje podřízené elementy, které lze použít k určení dalších elementů XML k odeslání v textu zprávy do služby tokenů zabezpečení žádosti o token.  
