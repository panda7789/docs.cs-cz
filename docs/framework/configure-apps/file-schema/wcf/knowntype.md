...
---
# \<knownType>
Určuje typ, který má být použit <xref:System.Runtime.Serialization.DataContractSerializer> během deserializace. Element určuje známý typ, který je vrácen polem nebo vlastností deklarovaného typu. Další informace najdete v tématu [známé typy kontraktu dat](../../../wcf/feature-details/data-contract-known-types.md).  
...
|Prvek|Description|  
|-------------|-----------------|  
|[\<parameter>](parameter.md)|Určuje index parametru, pokud je deklarovaný typ obecný typ.|  
