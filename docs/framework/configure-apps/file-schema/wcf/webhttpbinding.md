...
|writeEncoding|Určuje, že znak kódování, které se používá pro text zprávy. Platné hodnoty patří:<br /><br /> UnicodeFffeTextEncoding: Unicode BigEndian kódování.<br /><br /> Utf16TextEncoding: kódování 16 bitů.<br /><br /> Utf8TextEncoding: 8 bitů kódování.<br /><br /> Výchozí hodnota je Utf8TextEncoding.|  
