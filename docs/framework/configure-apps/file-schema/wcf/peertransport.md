...
|Prvek|Description|  
|-------------|-----------------|  
|[\<security>](security-of-peertransport.md)|Definuje nastavení zabezpečení pro tento přenos. Tento prvek je typu <xref:System.ServiceModel.Configuration.PeerSecurityElement> .|  
