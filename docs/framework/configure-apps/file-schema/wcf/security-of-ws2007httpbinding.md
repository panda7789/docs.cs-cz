...
Představuje nastavení zabezpečení používané [> elementu\<WS2007HttpBinding](ws2007httpbinding.md) .  
...
|Prvek|Popis|  
|-------------|-----------------|  
|[> přenos \<](transport-of-ws2007httpbinding.md)|Definuje nastavení zabezpečení přenosu. Tento prvek odpovídá typu <xref:System.ServiceModel.Configuration.HttpTransportSecurityElement>. Tato nastavení se aplikují jenom v případě, že je režim nastavený na přenos.|  
|[> \<zprávy](message-of-ws2007httpbinding.md)|Definuje nastavení zabezpečení zprávy. Tento prvek odpovídá typu <xref:System.ServiceModel.Configuration.MessageSecurityOverHttpElement>. Tato nastavení se neaplikují, pokud je režim nastavený na přenos.|  
