...
---
# <a name="certificate-of-peer"></a>\<certificate> z \<peer>
...
## <a name="remarks"></a>Poznámky  
 Tento prvek konfigurace obsahuje instanci, která se `X509Certificate2` používá při ověřování sousedních sítí v partnerské síti.  
