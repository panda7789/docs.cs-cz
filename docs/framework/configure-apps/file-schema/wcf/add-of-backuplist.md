...
---
# <a name="add-of-backuplist"></a>\<add> z \<backupList>
...
|Prvek|Description|  
|-------------|-----------------|  
|[\<routing>](routing.md)|Obsahuje seznam koncových bodů, které by služba Směrování měla použít pro případ, že primární koncový bod není dostupný.|  
