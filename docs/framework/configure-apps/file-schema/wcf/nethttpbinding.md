...
|Prvek|Popis|  
|-------------|-----------------|  
|[\<zabezpečení >](../../../../../docs/framework/configure-apps/file-schema/wcf/security-of-basichttpbinding.md)|Definuje nastavení zabezpečení pro vazbu. Tento element je typu `NetHttpSecurityElement`.|  
...
## <a name="remarks"></a>Poznámky  
 Vazeb NetHttpBinding využívá protokol HTTP jako přenosu pro odesílání zpráv. Při použití s duplexního kontraktu, použije se Websocket.  Při použití s kontraktu požadavku a odpovědi, které NetHttpBinding budou chovat jako BasicHttpBinding pomocí binární kodéru.  
