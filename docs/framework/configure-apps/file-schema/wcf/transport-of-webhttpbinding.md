...
---
# <a name="transport-of-webhttpbinding"></a>> \<přenosů \<webHttpBinding >
...
|Prvek|Popis|  
|-------------|-----------------|  
|[> zabezpečení \<](security-of-webhttpbinding.md)|Představuje možnosti zabezpečení [\<wsHttpBinding >](wshttpbinding.md) elementu.|  
