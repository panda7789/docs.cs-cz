...
---
# <a name="behavior-of-endpointbehaviors"></a>\<behavior> z \<endpointBehaviors>
...
|[\<enableWebScript>](enablewebscript.md)|Umožňuje chování koncového bodu, které umožňuje využívat službu z webových stránek ASP.NET AJAX. Chování by mělo být použito pouze ve spojení se \<webHttpBinding> standardní vazbou nebo \<webMessageEncoding> prvkem vazby.|  
...
|[\<webHttp>](webhttp.md)|Určuje WebHttpBehavior na koncovém bodu prostřednictvím konfigurace. Toto chování, při použití ve spojení se \<webHttpBinding> standardní vazbou, umožňuje model webového programování pro službu WCF.|  
