...
## <a name="remarks"></a>Poznámky  
 ...
 Kódování textu reprezentované elementem `textMessageEncoding` je nejvíce interoperabilní, ale nejméně efektivní kodér pro zprávy XML.  Kodér textu vytváří textovou zprávu na straně kabelu. Zprávy vytvářené v tomto kodéru jsou vhodné pro interoperabilitu WS-*. Webové služby nebo klient webové služby můžou obecně pochopit text XML. Přenos velkých bloků binárních dat jako textu je však nejefektivnější metodou pro kódování zpráv XML.  
