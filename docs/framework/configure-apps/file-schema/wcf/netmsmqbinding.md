...
|[\<security>](security-of-netmsmqbinding.md)|Definuje nastavení zabezpečení pro vazbu. Tento prvek je typu <xref:System.ServiceModel.Configuration.NetMsmqSecurityElement> .|  
