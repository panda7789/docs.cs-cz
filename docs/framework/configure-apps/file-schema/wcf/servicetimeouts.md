...
|Atribut|Popis|  
|---------------|-----------------|  
|`transactionTimeout`|A <xref:System.TimeSpan> hodnotu, která určuje transakce musí procházet od klienta k serveru časový interval. Výchozí hodnota je "00: 00:00".|  
