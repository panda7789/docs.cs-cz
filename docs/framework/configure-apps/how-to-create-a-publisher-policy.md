...
> [!IMPORTANT]
> Sestavení zásady vydavatele nelze přidat do globální mezipaměti sestavení (GAC), pokud původní soubor zásad vydavatele zadaný v `/link` argumentu není umístěn ve stejném adresáři jako sestavení.
