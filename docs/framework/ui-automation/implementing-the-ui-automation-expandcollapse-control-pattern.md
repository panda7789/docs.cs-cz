...
|----------------------|-----------------|-----------|
|<xref:System.Windows.Automation.Provider.IExpandCollapseProvider.ExpandCollapseState%2A>|Vlastnost|Žádný|
|<xref:System.Windows.Automation.ExpandCollapsePattern.Expand%2A>|Metoda|Žádný|
