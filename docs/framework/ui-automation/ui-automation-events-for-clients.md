...
> [!NOTE]
> Nepředpokládá se, že jsou všechny možné události vyvolány poskytovatelem [!INCLUDE[TLA#tla_uiautomation](../../../includes/tlasharptla-uiautomation-md.md)]. Například ne všechny změny vlastností způsobují, že události budou vyvolány standardními poskytovateli proxy pro model Windows Forms a ovládací prvky Win32.  
