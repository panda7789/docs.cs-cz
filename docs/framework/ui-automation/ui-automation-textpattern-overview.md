...
## <a name="textpattern-provider-apis"></a>Poskytovatele vlastnosti TextPattern rozhraní API  
...
Následující znázorňuje sadu počátečního a koncového bodu.  
