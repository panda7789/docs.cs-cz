...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 [Vzory ovládacích prvků automatizace uživatelského rozhraní podporované získat](../../../docs/framework/ui-automation/get-supported-ui-automation-control-patterns.md)  
