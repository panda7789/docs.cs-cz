...
|------------------|------------------|  
|Záhlaví<br /><br /> -HeaderItem (1 nebo více)|Žádná|  
...
|---------------------------------------------------------------------------------|-------------|-----------|  
|<xref:System.Windows.Automation.AutomationElement.BoundingRectangleProperty> události změny vlastnosti.|Požadováno|Žádná|  
|<xref:System.Windows.Automation.AutomationElement.IsOffscreenProperty> události změny vlastnosti.|Požadováno|Žádná|  
|<xref:System.Windows.Automation.AutomationElement.IsEnabledProperty> události změny vlastnosti.|Požadováno|Žádná|  
