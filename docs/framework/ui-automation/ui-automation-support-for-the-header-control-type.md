...
|------------------|------------------|  
|Záhlaví<br /><br /> -HeaderItem (1 nebo více)|Žádný|  
...
|---------------------------------------------------------------------------------|-------------|-----------|  
|<xref:System.Windows.Automation.AutomationElement.BoundingRectangleProperty> události změny vlastnosti.|Požadováno|Žádný|  
