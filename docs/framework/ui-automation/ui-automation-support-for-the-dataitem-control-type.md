...
|<xref:System.Windows.Automation.Provider.ISelectionItemProvider>|Ano|All data items must support the Selection Item pattern to indicate when the item is selected.|  
