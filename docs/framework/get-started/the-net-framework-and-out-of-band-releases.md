...
3.  Po dokončení stahování restartujte aplikaci Visual Studio.  
 ...
 Podrobné pokyny k instalaci naleznete v tématu [instalace balíčků NuGet](http://docs.nuget.org/docs/start-here/installing-nuget) na webu NuGet Docs. Další informace o systému NuGet najdete v tématu [dokumentace pro NuGet](http://docs.nuget.org/).  
