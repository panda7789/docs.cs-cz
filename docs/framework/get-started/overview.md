...
- K poskytnutí konzistentního programovacího prostředí orientovaného na objekty bez ohledu na to, jestli je kód objektu uložený a spouštěný místně, spuštěný místně, ale webový nebo spuštěný vzdáleně.
...
> [!NOTE]
> Obecný úvod k .NET Framework uživatelům a vývojářům najdete v tématu [Začínáme](index.md).
