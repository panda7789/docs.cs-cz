...
V tabulkách v tomto tématu najdete hardwaru, operačního systému a požadavky na software pro rozhraní .NET Framework 4.5 a jeho verze bodu (4.5.1 a 4.5.2), [!INCLUDE[net_v46](../../../includes/net-v46-md.md)] nebo jeho verze bodu (4.6.1 a 4.6.2) a rozhraní .NET Framework 4.7 a jeho bod verze (4.7.1). Vývojové prostředí, které vám umožní vyvíjet aplikace pro rozhraní .NET Framework mít samostatnou sadu požadavků.
...
- V systémech Windows 7 se vyžaduje rozhraní .NET Framework Windows 7 SP1. Pokud jste na systému Windows 7 a aktualizací Service Pack 1 ještě nenainstalovali, budete muset učinit před instalací rozhraní .NET Framework.
...
| Operační systém | Podporované edice | Předinstalována s operačním systémem | Instalovat samostatně |
| ---------------- | ------------------ | ------------------------ | ---------------------- |
| Windows Server, verze. 1709 | 64bitových | Rozhraní .NET framework 4.7.1 | -- |
