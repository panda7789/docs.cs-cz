...
#### <a name="help-creating-forms-and-controls"></a>Pomoc při tvorbě formulářů a ovládacích prvků  
...
#### <a name="help-deploying-clickonce-applications"></a>Nápověda, nasazování aplikací ClickOnce  
