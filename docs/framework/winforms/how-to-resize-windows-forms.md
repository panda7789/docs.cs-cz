...
## <a name="resize-a-form-programmatically"></a>Změnit velikost formuláře prostřednictvím kódu programu
...
## <a name="change-form-width-and-height-programmatically"></a>Změnit výšku a šířku formuláře prostřednictvím kódu programu
...
## <a name="change-form-size-by-increments-programmatically"></a>Změnit velikost formuláře přírůstky prostřednictvím kódu programu
