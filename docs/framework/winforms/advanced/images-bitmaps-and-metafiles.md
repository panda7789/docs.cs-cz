...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Tento článek popisuje metody pro oříznutí a změna měřítka vektoru a rastrových obrázků se spravovaným kódem  
...
## <a name="reference"></a>Odkaz  
 ...
 Tato třída popisuje a obsahuje odkazy na všechny jeho členy  
  
## <a name="related-sections"></a>Související oddíly  
 [Práce s obrázky, rastrovými obrázky, ikonami a metasoubory](working-with-images-bitmaps-icons-and-metafiles.md)  
 Obsahuje odkazy na témata, která ukazují, jak pomocí imagí ve vaší aplikaci.
