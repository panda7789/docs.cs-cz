...
## <a name="reference"></a>Odkaz  
 <xref:Accessibility>  
 Obor názvů obsahující počet třídy související s usnadnění.  
...
## <a name="related-sections"></a>Související oddíly  
 ...
 Popisuje, jak chcete-li vaše Windows Forms aplikace reagovat na změny v systému velikost písma.
