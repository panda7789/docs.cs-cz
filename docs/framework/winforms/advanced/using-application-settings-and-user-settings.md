...
## <a name="in-this-section"></a>V tomto oddílu  
 [Postupy: Vytvoření nového nastavení v době návrhu](../../../../docs/framework/winforms/advanced/how-to-create-a-new-setting-at-design-time.md)  
 ...
 [Postupy: Přidání více množin nastavení do vaší aplikace v jazyce C#](../../../../docs/framework/winforms/advanced/how-to-add-multiple-sets-of-settings-to-your-application-in-csharp.md)  
