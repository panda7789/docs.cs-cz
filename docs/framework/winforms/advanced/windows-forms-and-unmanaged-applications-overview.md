...
-   Každý formulář Windows pro zobrazení v novém vláknu. Další informace najdete v tématu [jak: komunikace s objekty COM podporu zobrazení každý formulář Windows na jeho vlastní vlákně](../../../../docs/framework/winforms/advanced/how-to-support-com-interop-by-displaying-each-windows-form-on-its-own-thread.md).  
