...
- [Postupy: Vytváření uživatelského rozhraní s více podokny s Windows Forms pomocí Návrháře](create-a-multipane-user-interface-with-wf-using-the-designer.md)
