...
### <a name="avoid-visual-inheritance"></a>Vyhněte se vizuálního dědění
 <xref:System.Windows.Forms.TableLayoutPanel> Ovládací prvek nepodporuje vizuálního dědění v Návrháři formulářů Windows v sadě Visual Studio. A <xref:System.Windows.Forms.TableLayoutPanel> ovládací prvek v odvozené třídě se zobrazí jako "uzamčená" v době návrhu.
