...
1.  Přidat <xref:System.Windows.Forms.TreeView> do svého formuláře ovládací prvek a potom přidat uzly do <xref:System.Windows.Forms.TreeView> podle potřeby. Další informace najdete v tématu [jak: Přidávání a odebírání uzlů s Windows Forms TreeView – ovládací prvek](../../../../docs/framework/winforms/controls/how-to-add-and-remove-nodes-with-the-windows-forms-treeview-control.md).  
