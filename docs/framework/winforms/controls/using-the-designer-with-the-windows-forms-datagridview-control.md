...
Visual Studio poskytuje podporu návrháře pro ovládací prvek `DataGridView`, který umožňuje provádět mnoho úloh nastavení bez psaní kódu. Tyto úlohy zahrnují vazbu ovládacího prvku na zdroj dat, úpravu sloupců používaných k zobrazení dat a úpravu vzhledu a základního chování ovládacího prvku.  
...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Popisuje, jak použít dialogová okna **Přidat sloupce** a **Upravit sloupce** k naplnění a úpravě kolekce sloupců.  
 ...
 Popisuje způsob použití možnosti **Zvolit zdroj dat** na inteligentní značce ovládacího prvku pro připojení k datům.  
 ...
 Popisuje, jak změnit uspořádání sloupců pomocí dialogového okna **Upravit sloupce** .  
 ...
 Popisuje, jak použít dialogové okno **Upravit sloupce** pro změnu typu sloupce.  
 ...
 Popisuje, jak používat inteligentní značku ovládacího prvku k tomu, aby uživatelé mohli změnit uspořádání sloupců.  
 ...
 Popisuje, jak pomocí dialogového okna **Upravit sloupce** zabránit posouvání konkrétních sloupců.  
 ...
 Popisuje, jak použít dialogové okno **Upravit sloupce** pro skrytí určitých sloupců.  
 ...
 Popisuje, jak používat dialogové okno **Upravit sloupce** k tomu, aby uživatelé nemohli upravovat hodnoty v konkrétních sloupcích.  
 ...
 Popisuje, jak používat inteligentní značku ovládacího prvku k zabránění uživatelům v přidávání a odstraňování řádků.  
 ...
 Popisuje, jak pomocí dialogového okna **Tvůrce CellStyle** vytvořit vzhled v rámci ovládacího prvku v podobě knihy.  
