...
## <a name="add-load-save-and-cancel-buttons-to-the-bindingnavigator-component"></a>Přidat načíst, uložit a stornovací tlačítka na komponentu BindingNavigator

1. V sadě Visual Studio, přidejte <xref:System.Windows.Forms.TextBox> ovládací prvek do formuláře.
