...
## <a name="reference"></a>Odkaz  
 ...
 Popisuje typ, který obsahuje data <xref:System.ComponentModel.BackgroundWorker.RunWorkerCompleted> událostí.  
  
 <xref:System.ComponentModel.ProgressChangedEventArgs>  
 Popisuje typ, který obsahuje data <xref:System.ComponentModel.BackgroundWorker.ProgressChanged> událostí.  
  
## <a name="related-sections"></a>Související oddíly  
 [Přehled asynchronních vzorů založených na událostech](../../../../docs/standard/asynchronous-programming-patterns/event-based-asynchronous-pattern-overview.md)  
 Popisuje, jak asynchronní vzor zpřístupní výhod vícevláknové aplikace při skrytí mnoho složitých problémů vyplývajících z více vláken návrhu.
