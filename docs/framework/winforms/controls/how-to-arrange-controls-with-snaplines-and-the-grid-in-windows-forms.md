...
-   Vyberte **SnapToGrid** režimu rozložení v Návrháři formulářů **možnosti** dialogové okno.  
     ...
     Další informace najdete v tématu [Návrhář formulářů Windows Obecné, dialogové okno Možnosti](http://msdn.microsoft.com/en-us/8dd170af-72f0-4212-b04b-034ceee92834). Všechny ovládací prvky vlastní teď vyrovnání podél body v mřížce.  
