...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Označuje základní prvky používání ovládacích prvků v aplikacích Windows Forms.  
 ...
 Ukazuje, jak zpracovat a definování události v ovládacích prvcích Windows Forms.  
...
## <a name="related-sections"></a>Související oddíly  
 ...
 [Postupy: licence komponenty a ovládací prvky](http://msdn.microsoft.com/library/8e66c1ed-a445-4b26-8185-990b6e2bbd57)  
 Popisuje, jak implementovat licencování v komponenta nebo ovládací prvek.  
  
 Viz také [vývoj ovládacích prvků Windows Forms v době návrhu](http://msdn.microsoft.com/library/w29y3h59\(v=vs.110\)).
