...
## <a name="working-with-the-label-control"></a>Práce s ovládacím prvku popisek  
 Vzhledem k tomu, <xref:System.Windows.Forms.Label> ovládací prvek nemůže přijmout zaměření, můžete použít také k vytváření přístupových klíčů pro ostatní ovládací prvky. Přístupový klíč umožňuje uživateli vybrat jiný ovládací prvek stisknutím klávesy ALT přístupovým klíčem. Další informace najdete v tématu [vytváření klíčů pro Windows Forms řízení přístupu](how-to-create-access-keys-for-windows-forms-controls.md) a [jak: Vytváření přístupových klíčů pomocí ovládacích prvků Windows Forms Label](how-to-create-access-keys-with-windows-forms-label-controls.md).  
