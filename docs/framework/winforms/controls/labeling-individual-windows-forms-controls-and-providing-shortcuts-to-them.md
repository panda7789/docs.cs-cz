...
Ovládací prvky přidané do model Windows Forms mají vlastnosti a metody, které se používají k dalšímu specializaci uživatelského prostředí. Přizpůsobení uživatelského rozhraní tak, aby vyhovovalo potřebám uživatele, je mimořádně důležité pro dobře navržené aplikace systému Windows.
...
Poskytuje informace o tom, jak ovládací prvky umožňují pracovat s pomůckami pro usnadnění práce.

## <a name="related-sections"></a>Související oddíly

[Ovládací prvky model Windows Forms](index.md)\
Odkazy na jiné základní věci, které můžete provádět s ovládacími prvky.
