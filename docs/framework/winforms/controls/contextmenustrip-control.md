...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Viz také [ContextMenuStrip – dialogové okno úlohy](https://msdn.microsoft.com/library/ms233646\(v=vs.110\)) nebo [ContextMenuStrip – Editor kolekce položek](https://msdn.microsoft.com/library/ms233641\(v=vs.110\)).  
