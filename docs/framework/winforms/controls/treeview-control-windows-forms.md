...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Poskytuje pokyny pro přidání a odebrání uzlů v zobrazení stromu.  
 ...
 Obsahují pokyny pro odvozování položku v zobrazení seznamu nebo uzel v zobrazení stromu k přidání všech polí, metody nebo konstruktory, které potřebujete.  
 ...
 Poskytuje pokyny pro určení kliknuli jste na uzel v zobrazení stromu, takže aplikace může reagovat správně.  
 ...
 Poskytuje pokyny pro zkoumání každý uzel ve stromové struktuře.  
 ...
 Poskytuje pokyny pro zobrazení ikon pro uzly v zobrazení stromu.  
 ...
 Ukazuje, jak přidat místní nabídky do zobrazení uzlu stromu.  
  
 Viz také [postupy: Přidání a odebrání uzlů s Windows Forms TreeView – ovládací prvek pomocí návrháře](http://msdn.microsoft.com/library/ms233651\(v=vs.110\)), [postupy: připojení místní nabídky k TreeNode pomocí návrháře](http://msdn.microsoft.com/library/ms171708\(v=vs.110\)).  
