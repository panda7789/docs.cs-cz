...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Viz také [jak: Definování ikony pro tlačítko ToolBar pomocí návrháře](how-to-define-an-icon-for-a-toolbar-button-using-the-designer.md), [jak: Přidání tlačítek do ovládacího prvku ToolBar pomocí návrháře](how-to-add-buttons-to-a-toolbar-control-using-the-designer.md).  
