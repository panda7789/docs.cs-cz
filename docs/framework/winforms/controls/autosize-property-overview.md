...
> [!NOTE]
> Maximalizovat produktivitu, Návrhář formulářů Windows ve Visual Studio stínů <xref:System.Windows.Forms.Control.AutoSize%2A> vlastnost <xref:System.Windows.Forms.Form> třídy. V době návrhu, se bude formulář chovat jako by <xref:System.Windows.Forms.Control.AutoSize%2A> je nastavena na `false`, bez ohledu na jeho skutečná nastavení. V době běhu je provedena žádné speciální ubytování a <xref:System.Windows.Forms.Control.AutoSize%2A> použita vlastnost podle nastavení vlastnosti.
