...
Následující příklad kódu ukazuje, jak použít sloupce <xref:System.Windows.Forms.DataGridView> obrázku v interaktivním uživatelském rozhraní (UI). Příklad také ukazuje možnosti pro nastavení velikosti obrázku a rozložení pomocí <xref:System.Windows.Forms.DataGridViewImageColumn>.  
