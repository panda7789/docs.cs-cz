...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 [Postupy: Přehrávání zvuku vestavěného v prostředku z formuláře Windows](how-to-play-a-sound-embedded-in-a-resource-from-a-windows-form.md)  
