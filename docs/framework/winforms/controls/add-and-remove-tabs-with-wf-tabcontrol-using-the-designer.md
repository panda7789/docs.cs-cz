...
- Na inteligentní značky ovládacího prvku, klikněte na tlačítko **přidat kartu** nebo **odebrat kartu**  
     ...
     V **vlastnosti** okna, klikněte na tlačítko **tlačítko se třemi tečkami** tlačítko (![The třemi tečkami (...) v okně Vlastnosti systému Visual Studio](./media/visual-studio-ellipsis-button.png)) vedle položky <xref:System.Windows.Forms.TabControl.TabPages%2A> vlastnost Chcete-li otevřít **TabPage – Editor kolekce**. Klikněte na tlačítko **přidat** nebo **odebrat** tlačítko.  
