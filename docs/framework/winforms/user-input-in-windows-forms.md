...
## <a name="in-this-section"></a>V tomto oddílu  
 [Uživatelský vstup ve Windows Forms aplikace](../../../docs/framework/winforms/user-input-in-a-windows-forms-application.md)  
 ...
 [Postupy: popisovač uživatelského vstupu událostí ve Windows Forms – ovládací prvky](../../../docs/framework/winforms/how-to-handle-user-input-events-in-windows-forms-controls.md)  
