...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 [Postupy: Zpracování události uživatelského vstupu v ovládacích prvcích Windows Forms](how-to-handle-user-input-events-in-windows-forms-controls.md)  
