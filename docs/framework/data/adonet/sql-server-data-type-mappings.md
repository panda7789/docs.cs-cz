...
## <a name="sql-server-books-online-reference"></a>Příruček SQL Server Books Online referencí  
 Další informace o typech dat systému SQL Server najdete v tématu [datové typy (databázový stroj)](http://go.microsoft.com/fwlink/?LinkID=107468).  
