...
|datetime2<br /><br /> (SQL Server 2008 a novější)|DateTime|<xref:System.Data.SqlDbType.DateTime2>|Žádná|<xref:System.Data.DbType.DateTime2>|<xref:System.Data.SqlClient.SqlDataReader.GetDateTime%2A>|  
...
|int|Datový typ Int32|<xref:System.Data.SqlDbType.Int>|<xref:System.Data.SqlClient.SqlDataReader.GetSqlInt32%2A>|<xref:System.Data.DbType.Int32>|<xref:System.Data.SqlClient.SqlDataReader.GetInt32%2A>|  
|peníze|Decimal|<xref:System.Data.SqlDbType.Money>|<xref:System.Data.SqlClient.SqlDataReader.GetSqlMoney%2A>|<xref:System.Data.DbType.Decimal>|<xref:System.Data.SqlClient.SqlDataReader.GetDecimal%2A>|  
...
|numerické|Decimal|<xref:System.Data.SqlDbType.Decimal>|<xref:System.Data.SqlClient.SqlDataReader.GetSqlDecimal%2A>|<xref:System.Data.DbType.Decimal>|<xref:System.Data.SqlClient.SqlDataReader.GetDecimal%2A>|  
...
|reálná|Jednoduchá|<xref:System.Data.SqlDbType.Real>|<xref:System.Data.SqlClient.SqlDataReader.GetSqlSingle%2A>|<xref:System.Data.DbType.Single>|<xref:System.Data.SqlClient.SqlDataReader.GetFloat%2A>|  
...
|čas<br /><br /> (SQL Server 2008 a novější)|Časový interval|<xref:System.Data.SqlDbType.Time>|žádná|<xref:System.Data.DbType.Time>|<xref:System.Data.SqlClient.SqlDataReader.GetDateTime%2A>|  
...
<sup>2</sup> použití konkrétního typu přístupového objektu, pokud znáte základní typ `sql_variant`.  
  
## <a name="sql-server-documentation"></a>Dokumentaci k SQL serveru

Další informace o datové typy serveru SQL Server najdete v tématu [datové typy (Transact-SQL)](/sql/t-sql/data-types/data-types-transact-sql).
