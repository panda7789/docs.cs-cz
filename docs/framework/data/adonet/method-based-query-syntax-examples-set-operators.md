...
### <a name="example"></a>Příklad  
 Tento příklad používá <xref:System.Linq.Enumerable.Distinct%2A> metodu odeberte duplicitní elementy v pořadí.  
...
### <a name="example"></a>Příklad  
 Tento příklad používá <xref:System.Linq.Enumerable.Except%2A> metoda vrátí kontakty, které se zobrazují v první tabulce, ale ne za sekundu.  
...
### <a name="example"></a>Příklad  
 Tento příklad používá <xref:System.Linq.Enumerable.Intersect%2A> metoda vrátí kontakty, které se zobrazují v obou tabulkách.  
...
### <a name="example"></a>Příklad  
 Tento příklad používá <xref:System.Linq.Enumerable.Union%2A> metoda vrátí jedinečný kontakty z kterékoli z obou tabulek.  
