...
ms.locfileid: "33353596"
---
# <a name="query-expression-syntax-examples-element-operators-linq-to-dataset"></a>Příklady syntaxe výrazu dotazu: Element operátory (LINQ na DataSet)
