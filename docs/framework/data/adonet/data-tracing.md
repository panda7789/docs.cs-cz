...
Funkce integrované data trasování funkce, které podporuje zprostředkovatele dat .NET pro technologii ADO.NET [!INCLUDE[ssNoVersion](../../../../includes/ssnoversion-md.md)], Oracle, technologie OLE DB a rozhraní ODBC, jakož i technologie ADO.NET <xref:System.Data.DataSet>a [!INCLUDE[ssNoVersion](../../../../includes/ssnoversion-md.md)] síťových protokolů.  
...
## <a name="accessing-diagnostic-information-in-the-extended-events-log"></a>Přístup k diagnostické informace v protokolu rozšířené události  
 V [!INCLUDE[dnprdnshort](../../../../includes/dnprdnshort-md.md)] zprostředkovatele dat pro [!INCLUDE[ssNoVersion](../../../../includes/ssnoversion-md.md)], data přístup trasování ([Data trasování přístup](http://msdn.microsoft.com/library/hh880086.aspx)) byl aktualizovaný, aby bylo snazší snazší ke korelaci událostí klienta s diagnostické informace, jako je například selhání připojení ze serveru připojení prstenec vyrovnávací paměti a aplikace informace o výkonu v rozšířené události protokolu. Informace o čtení protokolu rozšířených událostí najdete v tématu [Data relace události zobrazení](http://msdn.microsoft.com/library/hh710068\(SQL.110\).aspx).  
