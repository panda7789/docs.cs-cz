...
|adChapter|DBTYPE_HCHAPTER|Podporují `DataReader`. Zobrazit [načítání dat pomocí čtečky dat](../../../../docs/framework/data/adonet/retrieving-data-using-a-datareader.md).|Funkce GetValue()|  
...
|adError|DBTYPE_ERROR|ExternalException|Funkce GetValue()|  
|adFileTime|TYP DBTYPE_FILETIME|DateTime|GetDateTime()|  
|adGUID|DBTYPE_GUID|identifikátor GUID|GetGuid()|  
|adIDispatch|DBTYPE_IDISPATCH *|Objekt|Funkce GetValue()|  
|adInteger|DBTYPE_I4|Int32|GetInt32()|  
|adIUnknown|DBTYPE_IUNKNOWN *|Objekt|Funkce GetValue()|  
|adNumeric|DBTYPE_NUMERIC|Desetinné číslo|GetDecimal()|  
|adPropVariant|DBTYPE_PROPVARIANT|Objekt|Funkce GetValue()|  
|adSingle|DBTYPE_R4|Single|GetFloat()|  
|adSmallInt|DBTYPE_I2|Int16|GetInt16()|  
|adTinyInt|DBTYPE_I1|Byte|GetByte()|  
|adUnsignedBigInt|DBTYPE_UI8|UInt64|Funkce GetValue()|  
|adUnsignedInt|DBTYPE_UI4|UInt32|Funkce GetValue()|  
|adUnsignedSmallInt|DBTYPE_UI2|UInt16|Funkce GetValue()|  
|adUnsignedTinyInt|DBTYPE_UI1|Byte|GetByte()|  
|adVariant|DBTYPE_VARIANT|Objekt|Funkce GetValue()|  
