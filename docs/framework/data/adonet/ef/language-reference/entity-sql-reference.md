...
|[THEN](then-entity-sql.md)|Výsledek [při](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/bb387119(v=vs.100)) klauzuli, pokud je vyhodnocen jako true.|
