...
```  
 ...
 Následující příklad ukazuje, jak správně vnořovat výrazy v [!INCLUDE[esql](../../../../../../includes/esql-md.md)]: [postupy: řazení sjednocení z obou dotazů](https://msdn.microsoft.com/library/853c583a-eaba-4400-830d-be974e735313).  
