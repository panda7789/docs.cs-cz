...
## <a name="null-property-on-a-null-object"></a>Vlastnost null objektu s hodnotou null  
 V rozhraní [!INCLUDE[adonet_ef](../../../../../../includes/adonet-ef-md.md)]mají vlastnosti objektu null hodnotu null. Při pokusu o odkaz na vlastnost objektu s hodnotou null v modulu CLR se zobrazí <xref:System.NullReferenceException>. Když dotaz LINQ zahrnuje vlastnost objektu s hodnotou null, může to mít za následek nekonzistentní chování.  
