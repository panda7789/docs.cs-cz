...
|`/SuppressForeignKeyProperties or /nofk`|Zabraňuje vystavení jako skalární vlastnosti na typy entit v konceptuálním modelu sloupce cizích klíčů.|
