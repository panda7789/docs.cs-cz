...
3. Zadejte připojovací řetězec.  
     ...
     Entity Framework používá speciálně formátovaný připojovací řetězec při provádění dotazů na koncepční model. Tento připojovací řetězec zapouzdřuje informace o modelu a mapování souborů a připojení ke zdroji dat. Další informace najdete v tématu [jak: Zadejte připojovací řetězec](how-to-define-the-connection-string.md).  
