...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Popisuje [!INCLUDE[dnprdnshort](../../../../../includes/dnprdnshort-md.md)] zprostředkovatele dat, která podporuje [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] pro použití s databází systému SQL Server.  
  
## <a name="related-sections"></a>Související oddíly  
 [Rozhraní Entity Framework (SQL Server Compact)](http://go.microsoft.com/fwlink/?LinkId=135638)  
 Popisuje zprostředkovatele omezení a způsob použití [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] s databází systému SQL Server Compact.  
  
 [Poskytovatelů třetích stran pro rozhraní Entity Framework](http://go.microsoft.com/fwlink/?LinkId=143699)  
