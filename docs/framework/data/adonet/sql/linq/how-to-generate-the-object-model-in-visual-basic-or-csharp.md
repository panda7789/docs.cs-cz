...
## <a name="example"></a>Příklad  
 Příkazový řádek SQLMetal vidět v následujícím příkladu vytvoří jako model na základě atributů objektu ukázková databáze Northwind kód jazyka Visual Basic. Uložené procedury a funkce jsou také vykreslen.  
