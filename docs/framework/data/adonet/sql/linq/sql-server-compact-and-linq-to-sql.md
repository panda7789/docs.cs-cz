...
SQL Server Compact je výchozí databáze nainstalován se sadou Visual Studio. Další informace najdete v tématu [PAVE přes pomocí SQL Server Compact (Visual Studio)](https://msdn.microsoft.com/library/13320dd1-94e5-4077-bf76-8df253695ccc).  
