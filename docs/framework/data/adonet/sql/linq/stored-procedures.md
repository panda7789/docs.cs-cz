...
[!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] metody v objektovém modelu používá k reprezentaci uložené procedury v databázi. Určíte jako uložené procedury pro metody s použitím <xref:System.Data.Linq.Mapping.FunctionAttribute> atribut a v případě potřeby <xref:System.Data.Linq.Mapping.ParameterAttribute> atribut. Další informace najdete v tématu [The LINQ to SQL objektový Model](../../../../../../docs/framework/data/adonet/sql/linq/the-linq-to-sql-object-model.md).  
  
 Obvykle byste použili vývojářům používajícím Visual Studio [!INCLUDE[vs_ordesigner_long](../../../../../../includes/vs-ordesigner-long-md.md)] mapě uložených procedur. Témata v této části ukazují, jak formulář a volat tyto metody ve své aplikaci psát kód sami.  
  
## <a name="in-this-section"></a>V tomto oddílu  
 [Postupy: Vrácení sad řádků](../../../../../../docs/framework/data/adonet/sql/linq/how-to-return-rowsets.md)  
 Popisuje, jak vrátit řádky dat a ukazuje způsob použití jako vstupní parametr.  
  
 [Postupy: Použití uložených procedur, které přijímají parametry](../../../../../../docs/framework/data/adonet/sql/linq/how-to-use-stored-procedures-that-take-parameters.md)  
 Popisuje způsob použití vstupní a výstupní parametry.  
 ...
 Popisuje, jak stanovit vrátí více obrazců ve stejném uloženou proceduru.  
 ...
 Popisuje, jak poskytnout více tvarů, kde se označuje návratovou sekvenci.  
 ...
 Popisuje způsob použití uložené procedury pro implementace insert, update a operace odstranění.  
...
## <a name="related-sections"></a>Související oddíly  
 ...
 Obsahuje postupy, které ukazují, jak pomocí uložených procedur v C#.
