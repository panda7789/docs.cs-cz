...
> [!NOTE]
>  Většina metod a operátory pro předdefinované typy rozhraní .NET Framework mají přímé překlady SQL. Ty, které [!INCLUDE[vbteclinq](../../../../../../includes/vbteclinq-md.md)] nemůže překládat generovat výjimky za běhu. Další informace najdete v tématu [mapování typů SQL a CLR](../../../../../../docs/framework/data/adonet/sql/linq/sql-clr-type-mapping.md).  
