...
-   Trvat lambda s parametrem index.  
  
-   Spoléhají na vlastnosti po sobě jdoucích řádků, jako je třeba <xref:System.Linq.Queryable.TakeWhile%2A>.  
  
-   Spoléhají na libovolný implementace CLR, jako je třeba <xref:System.Collections.Generic.IComparer%601>.  
