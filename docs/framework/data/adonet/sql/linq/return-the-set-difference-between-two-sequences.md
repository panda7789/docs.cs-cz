...
## <a name="example"></a>Příklad  
 Tento příklad používá <xref:System.Linq.Queryable.Except%2A> k vrácení sekvence všech zemí/oblastí, ve kterém `Customers` provozu, ale v které ne `Employees` live.  
