...
---
# <a name="how-to-display-linq-to-sql-commands"></a>Postupy: zobrazení LINQ to SQLch příkazů
Pomocí <xref:System.Data.Linq.DataContext.GetCommand%2A> můžete zobrazit příkazy SQL a další informace.  
