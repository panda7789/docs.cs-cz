...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Popisuje, `Commands` `DataReaders` jak se připojit ke zdroji dat a jak načítat a upravovat data pomocí a `DataAdapters`.  
...
## <a name="related-sections"></a>Související oddíly  
 ...
 Popisuje, jak používat [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] nástroj k nasazení datových služeb na webu nebo v intranetu, který implementuje protokol OData (Open Data Protocol).  
