...
## <a name="what-you-will-learn"></a>Co se dozvíte  
 První úlohou tento rychlý start ukazuje, jak vytvořit službu data ke zveřejnění [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] kanálu z ukázková databáze Northwind. V následujících tématech, bude přístup [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] kanálu pomocí webového prohlížeče a také vytvořit [!INCLUDE[avalon1](../../../../includes/avalon1-md.md)] klientskou aplikaci, která využívá [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] kanálu pomocí knihovny klienta.  
...
-   Instance [!INCLUDE[msCoName](../../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../../includes/ssnoversion-md.md)]. To zahrnuje SQL Server Express, který je zahrnutý ve výchozí instalaci [!INCLUDE[vs_current_short](../../../../includes/vs-current-short-md.md)].  
