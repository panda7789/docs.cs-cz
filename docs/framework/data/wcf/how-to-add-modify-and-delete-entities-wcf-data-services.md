...
## <a name="see-also"></a>Viz také  
 ...
 [Postupy: přiřadit stávající entitu DataServiceContext](../../../../docs/framework/data/wcf/attach-an-existing-entity-to-dc-wcf-data.md)  
 [Postupy: definování relací mezi Entity](../../../../docs/framework/data/wcf/how-to-define-entity-relationships-wcf-data-services.md)  
