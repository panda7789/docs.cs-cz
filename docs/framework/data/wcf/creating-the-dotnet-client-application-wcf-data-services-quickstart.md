...
## <a name="next-steps"></a>Další kroky  
 Úspěšně jste vytvořili aplikace klienta, která přistupuje k ukázce Northwind [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] informačního kanálu. Když jste dokončili [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] rychlý start. Další informace o přístupu k [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] z informačního kanálu [!INCLUDE[dnprdnshort](../../../../includes/dnprdnshort-md.md)] aplikace, najdete v části [WCF Data Services klientské knihovny](../../../../docs/framework/data/wcf/wcf-data-services-client-library.md).  
