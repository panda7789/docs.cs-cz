...
|<xref:System.DateTime.Year>|`int year(DateTime p0)`|  
 ...
 <sup>1</sup> Jsou podporovány také ekvivalentní vlastnosti data a času <xref:Microsoft.VisualBasic.DateAndTime?displayProperty=nameWithType> a metoda <xref:Microsoft.VisualBasic.DateAndTime.DatePart%2A> v Visual Basic.  
