---
title: 'Postupy: zadání přihlašovacích údajů klienta žádosti do datové služby (WCF Data Services)'
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
ms.locfileid: "43402518"
---
# <a name="how-to-specify-client-credentials-for-a-data-service-request-wcf-data-services"></a>Postupy: zadání přihlašovacích údajů klienta žádosti do datové služby (WCF Data Services)
