...
## <a name="binding-data-to-windows-presentation-foundation-elements"></a>Vázání dat na prvky Windows Presentation Foundation  
 ...
 Další informace najdete v tématu [jak: Navažte data na prvky](../../../../docs/framework/data/wcf/bind-data-to-wpf-elements-wcf-data-services.md)Windows Presentation Foundation.  
...
## <a name="binding-paged-data"></a>Vázání stránkovaných dat  
 ...
 Související objekty jsou načteny podobným způsobem. Další informace najdete v tématu [jak: Navažte data na prvky](../../../../docs/framework/data/wcf/bind-data-to-wpf-elements-wcf-data-services.md)Windows Presentation Foundation.  
...
> [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)]neprovede žádné ověření vlastního chování, které implementujete v těchto delegátech.  
 ...
 Další informace najdete v tématu [jak: Přizpůsobení chování](../../../../docs/framework/data/wcf/how-to-customize-data-binding-behaviors-wcf-data-services.md)datových vazeb.  
...
- [Postupy: Ruční generování tříd klientských datových služeb](../../../../docs/framework/data/wcf/how-to-manually-generate-client-data-service-classes-wcf-data-services.md)
