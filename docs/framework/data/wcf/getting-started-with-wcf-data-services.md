...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Ukazuje, jak vytvořit a přístup k jednoduchou [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)]– na základě služby, která zveřejňuje podle ukázková databáze Northwind informačního kanálu.  
  
 [Scénáře aplikací](../../../../docs/framework/data/wcf/application-scenarios-wcf-data-services.md)  
 Označuje základní sady [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] scénáře, které jsou podporovány [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)].  
