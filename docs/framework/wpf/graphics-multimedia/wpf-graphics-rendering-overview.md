...
## <a name="how-visual-objects-are-used-to-build-controls"></a>Jak vizuálních objektů se používají k vytvoření ovládacích prvků  
 ...
 ![Diagram hierarchie vizuální strom](../../../../docs/framework/wpf/graphics-multimedia/media/visuallayeroverview03.gif "VisualLayerOverview03")  
...
### <a name="control-templates"></a>Šablony ovládacích prvků  
 ...
 ![Diagram vizuální strom a datech pro vykreslení](../../../../docs/framework/wpf/graphics-multimedia/media/visuallayeroverview04.png "VisualLayerOverview04")  
...
## <a name="visual-tree"></a>Vizuální strom  
 ...
 ![Diagram hierarchie vizuální strom](../../../../docs/framework/wpf/graphics-multimedia/media/visuallayeroverview05.gif "VisualLayerOverview05")  
Diagram hierarchie vizuální strom  
...
### <a name="rendering-order"></a>Pořadí vykreslování  
 ...
 ![Diagram vizuální strom pořadí vykreslování](../../../../docs/framework/wpf/graphics-multimedia/media/visuallayeroverview06.gif "VisualLayerOverview06")  
...
### <a name="relationship-to-the-logical-tree"></a>Relaci logického stromu  
 ...
 ![Diagram stromu](../../../../docs/framework/wpf/graphics-multimedia/media/tree1-wcp.gif "Tree1_wcp")  
...
### <a name="viewing-the-visual-tree-with-xamlpad"></a>Zobrazení s nástroj XamlPad vizuální strom  
 ...
 ![Panel Průzkumníka vizuálního stromu v nástroj XamlPad](../../../../docs/framework/wpf/graphics-multimedia/media/visuallayeroverview08.png "VisualLayerOverview08")  
...
### <a name="profiling-visual-performance"></a>Profilace výkonu Visual  
 ...
 ![Zobrazení výstupu Visual Profiler](../../../../docs/framework/wpf/graphics-multimedia/media/wpfperf-visualprofiler-04.png "WPFPerf_VisualProfiler_04")  
...
### <a name="vector-graphics"></a>Vektorová grafika  
 ...
 ![Rozdíly mezi rastrové a vektorové grafiky](../../../../docs/framework/wpf/graphics-multimedia/media/vectorgraphics01.png "VectorGraphics01")  
...
### <a name="about-resolution-and-device-independent-graphics"></a>Informace o řešení a nezávislé na zařízení grafiky  
 ...
 ![Grafika a textu v jiné nastavení DPI](../../../../docs/framework/wpf/graphics-multimedia/media/graphicsmm-dpi-setting-examples.png "graphicsmm_dpi_setting_examples")  
...
### <a name="hit-testing"></a>Testování průchodu  
 ...
 Další informace o volání testování, najdete v části [spuštění testování ve vizuální vrstvě](../../../../docs/framework/wpf/graphics-multimedia/hit-testing-in-the-visual-layer.md).  
...
### <a name="enumerating-the-visual-tree"></a>Vytváření výčtu vizuální strom  
 ...
 Ve většině případů je logická stromová struktura užitečnější reprezentace prvky v [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] aplikace. I když Logická stromová struktura neprovádějte žádné změny přímo, je důležité pochopit vlastnosti a směrování událostí toto zobrazení aplikace. Na rozdíl od vizuálního stromu, Logická stromová struktura představují nevizuálních datové objekty, jako například <xref:System.Windows.Documents.ListItem>. Další informace o logickém stromu, naleznete v tématu [stromy v subsystému WPF](../../../../docs/framework/wpf/advanced/trees-in-wpf.md).  
