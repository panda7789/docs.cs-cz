...
---
# <a name="how-to-apply-a-transform-to-a-bitmapimage"></a>Postupy: Použití transformace na BitmapImage
Tento příklad ukazuje, jak používat <xref:System.Windows.Media.Transform> k <xref:System.Windows.Media.Imaging.BitmapImage>.  
...
- [Otočení obrázku](../controls/how-to-rotate-an-image.md)
