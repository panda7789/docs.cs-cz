...
Tento příklad ukazuje, jak používat <xref:System.Windows.Media.Imaging.BitmapSource.Create%2A> metoda <xref:System.Windows.Media.Imaging.BitmapSource> k vytvoření nového <xref:System.Windows.Media.Imaging.BitmapSource> objektu.  
