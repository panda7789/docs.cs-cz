...
---
# <a name="how-to-create-a-new-bitmapsource"></a>Postupy: Vytvoření nového objektu BitmapSource
Tento příklad ukazuje, jak používat <xref:System.Windows.Media.Imaging.BitmapSource.Create%2A> metodu <xref:System.Windows.Media.Imaging.BitmapSource> pro vytvoření nového <xref:System.Windows.Media.Imaging.BitmapSource> objektu.  
