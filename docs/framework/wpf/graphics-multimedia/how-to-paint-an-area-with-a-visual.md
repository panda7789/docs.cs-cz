...
Tento příklad ukazuje způsob použití <xref:System.Windows.Media.VisualBrush> třídy Malování oblast s <xref:System.Windows.Media.Visual>.  
 ...
 V následujícím příkladu několik ovládacích prvků a panelu se používají jako pozadí obdélník.  
...
## <a name="example"></a>Příklad  
 ...
 Další informace o <xref:System.Windows.Media.VisualBrush> a další příklady najdete v článku [vykreslování s obrázky, kresby a vizuální prvky](../../../../docs/framework/wpf/graphics-multimedia/painting-with-images-drawings-and-visuals.md) Přehled.  
