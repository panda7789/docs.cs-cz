...
ms.locfileid: "61797160"
---
# <a name="how-to-transform-points-and-vectors"></a>Postupy: Body a vektory transformace
Tento příklad ukazuje způsob použití <xref:System.Windows.Media.Matrix> k transformaci <xref:System.Windows.Point> a <xref:System.Windows.Vector> objekty.  
