...
## <a name="prerequisites"></a>Požadavky  
 V tomto tématu informace o tom, byste měli znát základní animace funkce. Další informace najdete v tématu [přehled animace](../../../../docs/framework/wpf/graphics-multimedia/animation-overview.md).  
...
### <a name="the-repeatbehavior-property"></a>Vlastnost RepeatBehavior  
 ...
 Další příklad naleznete v tématu [opakování animace](../../../../docs/framework/wpf/graphics-multimedia/how-to-repeat-an-animation.md).  
...
### <a name="the-autoreverse-property"></a>Autoreverse – vlastnost  
 ...
 Pokud se časové osy kontejner má podřízený <xref:System.Windows.Media.Animation.Timeline> objektů, se obrátí na časové ose kontejneru provede. Další příklady najdete v tématu [zadejte časové ose automatické rezervace](../../../../docs/framework/wpf/graphics-multimedia/how-to-specify-whether-a-timeline-automatically-reverses.md).  
