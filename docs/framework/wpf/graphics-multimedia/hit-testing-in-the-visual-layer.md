...
## <a name="hit-testing-and-z-order"></a>Přístupů testování a pořadí Z-Order  
 ...
 ![Diagram vykreslování&#45;pořadí vizuální strom](./media/wcpsdk-mmgraphics-visuals-hittest-2.png "wcpsdk_mmgraphics_visuals_hittest_2")  
...
### <a name="how-the-visual-tree-affects-hit-testing"></a>Jak ovlivňuje vizuálního stromu testování průchodu  
 ...
 ![Diagram hierarchie vizuální strom](./media/wcpsdk-mmgraphics-visuals-overview-01.gif "wcpsdk_mmgraphics_visuals_overview_01")  
...
## <a name="using-a-hit-test-filter-callback"></a>Pomocí filtru zpětného volání ověření pozice  
 ...
 ![Vyřazování vizuálního stromu pomocí filtru ověření pozice](./media/filteredvisualtree-01.png "FilteredVisualTree_01")  
