...
## <a name="example"></a>Příklad  
 Následující příklad vytvoří <xref:System.Windows.Media.ArcSegment> , který animuje jeho <xref:System.Windows.Media.ArcSegment.Size%2A> načtení na obrazovce.  
 ...
 Další geometrie a animace ukázky najdete v tématu [geometrie ukázka](http://go.microsoft.com/fwlink/?LinkID=159989).  
