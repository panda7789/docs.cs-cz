...
- <span data-ttu-id="01a5d-187">Okno je aktivováno.</span><span class="sxs-lookup"><span data-stu-id="01a5d-187">The window is activated.</span></span>  
...
## <a name="other-types-of-windows"></a><span data-ttu-id="01a5d-340">Jiné typy Windows</span><span class="sxs-lookup"><span data-stu-id="01a5d-340">Other Types of Windows</span></span>  
 ...
 <span data-ttu-id="01a5d-343">Dialogová okna jsou okna, která se často používají k získání informací z uživatele k dokončení funkce.</span><span class="sxs-lookup"><span data-stu-id="01a5d-343">Dialog boxes are windows that are often used to gather information from a user to complete a function.</span></span> <span data-ttu-id="01a5d-344">Například když chce uživatel otevřít soubor, dialogové okno **otevřít soubor** se obvykle zobrazí v aplikaci k získání názvu souboru od uživatele.</span><span class="sxs-lookup"><span data-stu-id="01a5d-344">For example, when a user wants to open a file, the **Open File** dialog box is usually displayed by an application to get the file name from the user.</span></span> <span data-ttu-id="01a5d-345">Další informace najdete v tématu [Přehled dialogových oken](dialog-boxes-overview.md).</span><span class="sxs-lookup"><span data-stu-id="01a5d-345">For more information, see [Dialog Boxes Overview](dialog-boxes-overview.md).</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="01a5d-346">Viz také:</span><span class="sxs-lookup"><span data-stu-id="01a5d-346">See also</span></span>

- <xref:System.Windows.Window>
- <xref:System.Windows.MessageBox>
- <xref:System.Windows.Navigation.NavigationWindow>
- <xref:System.Windows.Application>
- [<span data-ttu-id="01a5d-347">Přehled dialogových oken</span><span class="sxs-lookup"><span data-stu-id="01a5d-347">Dialog Boxes Overview</span></span>](dialog-boxes-overview.md)
- [<span data-ttu-id="01a5d-348">Sestavení aplikace WPF</span><span class="sxs-lookup"><span data-stu-id="01a5d-348">Building a WPF Application</span></span>](building-a-wpf-application-wpf.md)
