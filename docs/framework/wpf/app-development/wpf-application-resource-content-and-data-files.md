...
> [!NOTE]
> Lokalita se zdrojovými soubory není v mezipaměti [!INCLUDE[TLA#tla_xbap](../../../../includes/tlasharptla-xbap-md.md)] v klientském počítači, zatímco soubory obsahu jsou. V důsledku toho se stáhnou jenom v případě, že je to výslovně požadováno. Pokud má aplikace [!INCLUDE[TLA#tla_xbap](../../../../includes/tlasharptla-xbap-md.md)] velké mediální soubory, nakonfigurujete je jako lokalita původních souborů znamená, že počáteční spuštění aplikace je mnohem rychlejší a soubory se stáhnou jenom na vyžádání.  
