...
## <a name="see-also"></a><span data-ttu-id="f45a0-106">Viz také:</span><span class="sxs-lookup"><span data-stu-id="f45a0-106">See also</span></span>

- [<span data-ttu-id="f45a0-107">Sbalení URI v technologii WPF</span><span class="sxs-lookup"><span data-stu-id="f45a0-107">Pack URIs in WPF</span></span>](pack-uris-in-wpf.md)
