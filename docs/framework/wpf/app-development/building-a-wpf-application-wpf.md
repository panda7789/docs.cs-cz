...
-   Visual Studio. Visual Studio se integrované vývojové prostředí, které zkompiluje grafického subsystému WPF aplikace pomocí nástroje MSBuild a zahrnuje vizuálního návrháře pro vytvoření uživatelského rozhraní. Další informace najdete v tématu [vývoj aplikací v sadě Visual Studio](http://msdn.microsoft.com/en-us/97490c1b-a247-41fb-8f2c-bc4c201eff68) a [WPF Designer](http://msdn.microsoft.com/en-us/c6c65214-8411-4e16-b254-163ed4099c26).  
