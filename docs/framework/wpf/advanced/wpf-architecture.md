...
Toto téma obsahuje průvodce z [!INCLUDE[TLA#tla_wpf](../../../../includes/tlasharptla-wpf-md.md)] třídy hierarchie. Pokrývá většinu hlavní dílčích systémů [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)]a popisuje způsob, jakým interagují. Také podrobnosti některé z těchto možností provedené architekty z [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)].  
