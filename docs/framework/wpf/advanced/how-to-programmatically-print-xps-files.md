...
> [!NOTE]
> V případě jednoduchosti výše uvedený příklad používá jako svůj test \*přítomnost rozšíření. XPS, že se jedná o soubor XPS. Soubory XPS ale nemusí mít toto rozšíření. [IsXPS. exe (Nástroj pro dodržování isXPS)](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/aa348104(v=vs.100)) je jedním ze způsobů, jak otestovat soubor pro dobu platnosti XPS.
