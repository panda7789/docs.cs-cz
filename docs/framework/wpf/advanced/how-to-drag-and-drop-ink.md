...
---
# <a name="how-to-drag-and-drop-ink"></a><span data-ttu-id="c321d-102">Postupy: Přetažení inkoustu</span><span class="sxs-lookup"><span data-stu-id="c321d-102">How to: Drag and Drop Ink</span></span>
## <a name="example"></a><span data-ttu-id="c321d-103">Příklad</span><span class="sxs-lookup"><span data-stu-id="c321d-103">Example</span></span>  
 <span data-ttu-id="c321d-104">Následující příklad vytvoří aplikaci, která umožňuje uživatelům přetáhněte vybrané tahy z jednoho <xref:System.Windows.Controls.InkCanvas> na druhý.</span><span class="sxs-lookup"><span data-stu-id="c321d-104">The following example creates an application that enables the user to drag selected strokes from one <xref:System.Windows.Controls.InkCanvas> to the other.</span></span>  
