...
Knihovny Windows Presentation Foundation (WPF) zveřejňují množství nespravovaných funkcí, které jsou určeny pouze pro interní použití. Neměly by být volány z uživatelského kódu.  
