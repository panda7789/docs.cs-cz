...
> [!NOTE]
> <xref:System.Windows.Documents.Glyphs> a <xref:System.Windows.Media.GlyphRun> jsou navržené pro scénáře pro prezentaci a tisk v dokumentu s pevným formátováním. [!INCLUDE[TLA#tla_winclient](../../../../includes/tlasharptla-winclient-md.md)] poskytuje několik prvků pro obecné rozložení a scénáře [!INCLUDE[TLA#tla_ui](../../../../includes/tlasharptla-ui-md.md)], například <xref:System.Windows.Controls.Label> a <xref:System.Windows.Controls.TextBlock>. Další informace o různých scénářích rozložení a @no__t 0 najdete v tématu věnovaném [typografii v](typography-in-wpf.md)subsystému WPF.  
...
## <a name="the-glyphrun-object"></a>Objekt GlyphRun  
 ...
 <xref:System.Windows.Media.GlyphRun> zahrnuje jak podrobnosti o písmu, například glyf <xref:System.Windows.Documents.Glyphs.Indices%2A> a jednotlivé pozice glyfů. Zahrnuje také původní body kódování Unicode, ke kterým byl vygenerován běh, informace o mapování vyrovnávací paměti znaků na glyfy a příznaky pro jednotlivé znaky a pro piktogramy.  
  
 <xref:System.Windows.Media.GlyphRun> má odpovídající <xref:System.Windows.FrameworkElement> na nejvyšší úrovni <xref:System.Windows.Documents.Glyphs>. <xref:System.Windows.Documents.Glyphs> lze použít ve stromové struktuře elementu a v kódu [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)] k reprezentaci výstupu <xref:System.Windows.Media.GlyphRun>.  
