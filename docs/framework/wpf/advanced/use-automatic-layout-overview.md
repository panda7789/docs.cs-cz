...
-   <span data-ttu-id="6f3d7-111">Uživatelské rozhraní zobrazí také v jakémkoli jazyce.</span><span class="sxs-lookup"><span data-stu-id="6f3d7-111">UI displays well  in any language.</span></span>  
