...
[!INCLUDE[TLA#tla_winclient](../../../../includes/tlasharptla-winclient-md.md)] zahrnuje celou řadu běžných komponenty uživatelského rozhraní (UI), které se používají ve většině aplikací Windows. Toto téma obsahuje postupy pro zlepšení výkonu uživatelského rozhraní.  
...
> [!NOTE]
>  Příklad toho, jak povolit virtualizaci a recyklace v kontejneru <xref:System.Windows.Controls.TreeView>, naleznete v tématu [zvýšení výkonu TreeView](../../../../docs/framework/wpf/controls/how-to-improve-the-performance-of-a-treeview.md).  
