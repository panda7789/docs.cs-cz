...
```  
 ...
 Obě služby EAPOL obsahovaly stejná data, ale v některých případech je snazší pracovat s nespravované definice, aby v této ukázce můžete definovat rutinu zřejmé převodu:  
