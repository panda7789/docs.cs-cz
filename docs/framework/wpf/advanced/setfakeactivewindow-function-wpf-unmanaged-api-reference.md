...
---
# <a name="setfakeactivewindow-function-wpf-unmanaged-api-reference"></a>Funkce SetFakeActiveWindow (WPF nespravované rozhraní API)
 ...
 **Knihovny DLL:** PresentationHost_v0400.dll  
