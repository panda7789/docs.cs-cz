...
---
# <a name="setfakeactivewindow-function-wpf-unmanaged-api-reference"></a>SetFakeActiveWindow – funkce (Referenční dokumentace rozhraní API nespravovaného subsystému WPF)
 ...
 **Knihovna DLL:** PresentationHost_v0400. dll  
