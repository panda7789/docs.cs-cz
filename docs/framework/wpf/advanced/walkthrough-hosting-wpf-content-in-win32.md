...
### <a name="the-basic-application"></a>Základní aplikace  
 Výchozí bod pro hostitelskou aplikaci došlo k vytvoření [!INCLUDE[TLA#tla_visualstu2005](../../../../includes/tlasharptla-visualstu2005-md.md)] šablony.  
  
1.  Otevřít [!INCLUDE[TLA2#tla_visualstu2005](../../../../includes/tla2sharptla-visualstu2005-md.md)]a vyberte **nový projekt** z **souboru** nabídky.  
