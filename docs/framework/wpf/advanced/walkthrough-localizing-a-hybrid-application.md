...
Kompletní výpis kódu úloh v tomto návodu, naleznete v tématu [lokalizace ukázkové aplikace hybridní](http://go.microsoft.com/fwlink/?LinkID=160015).
...
1.  Vytvoření **aplikace WPF** projekt s názvem `LocalizingWpfInWf`. Další informace najdete v tématu [postupy: vytvoření projektu aplikace Windows](http://msdn.microsoft.com/library/b2f93fed-c635-4705-8d0e-cf079a264efa).
