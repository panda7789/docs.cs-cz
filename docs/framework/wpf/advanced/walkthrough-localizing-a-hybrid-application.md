...
1. V **Průzkumník řešení**dvakrát klikněte na **SimpleControl. XAML** a otevřete ho v [!INCLUDE[wpfdesigner_current_short](../../../../includes/wpfdesigner-current-short-md.md)].
