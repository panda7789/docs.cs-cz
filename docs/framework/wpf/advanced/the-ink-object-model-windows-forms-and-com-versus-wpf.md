...
|-----------------|--------------------------|------------------------------------------|  
|Přidat do aplikace ovládací prvek inkoustu|Zobrazit [Začínáme s rukopisem](getting-started-with-ink.md).|Zobrazit [deklarací identity pro automatické vytvoření vzorku](/windows/desktop/tablet/auto-claims-form-sample)|  
|Povolení inkoustu na vlastním ovládacím prvku|Zobrazit [vytváření rukou vstupní ovládací prvek](creating-an-ink-input-control.md).|Zobrazit [inkoustu schránky ukázka](/windows/desktop/tablet/ink-clipboard-sample).|  
...
## <a name="ink-data"></a>Data inkoustu  
 ...
 ![Diagram Model inkoustových objektů modelu COM&#47;Winforms. ](./media/ink-inkownsstrokes.png "Ink_InkOwnsStrokes")  
 ...
 ![Diagram Model inkoustových objektů pro WPF. ](./media/ink-wpfinkobjectmodel.png "Ink_WPFInkObjectModel")  
...
## <a name="events-from-the-tablet-pen"></a>Události z pera  
 ...
 Na platformě Windows Presentation Foundation <xref:System.Windows.UIElement> třída obsahuje události pro vstup pomocí pera. To znamená, že každý ovládací prvek poskytuje úplnou sadu událostí pera.  Události stylus mají šíření a tunelové propojení událostí dvojice a vždy odehrávat na vlákna aplikace.  Další informace najdete v tématu [směrovat Přehled událostí](routed-events-overview.md).  
 ...
 ![Diagram Stylus událostí v subsystému WPF a Winforms. ](./media/ink-stylusevents.png "Ink_StylusEvents")  
