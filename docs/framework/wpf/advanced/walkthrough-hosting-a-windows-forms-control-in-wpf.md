...
## <a name="see-also"></a>Viz také  
 ...
 [Postupy: Hostování ovládacího prvku Windows Forms v grafickém subsystému WPF pomocí jazyka XAML](../../../../docs/framework/wpf/advanced/walkthrough-hosting-a-windows-forms-control-in-wpf-by-using-xaml.md)  
 ...
 [Windows Forms a ovládacích prvků ekvivalentní WPF](../../../../docs/framework/wpf/advanced/windows-forms-controls-and-equivalent-wpf-controls.md)  
