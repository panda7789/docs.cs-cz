...
Následující příklad ukazuje, že <xref:System.Windows.Controls.Image> <xref:System.Windows.FlowDirection> nedědí z rozhraní <xref:System.Windows.Controls.StackPanel> , které ho obsahuje.
