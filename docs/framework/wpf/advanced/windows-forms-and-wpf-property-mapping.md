...
## <a name="see-also"></a>Viz také  
 ...
 [Návod: Mapování vlastností pomocí ovládacího prvku ElementHost](../../../../docs/framework/wpf/advanced/walkthrough-mapping-properties-using-the-elementhost-control.md)
