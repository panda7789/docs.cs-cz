...
-   Implementace hostitele aplikace Windows Forms.  
 ...
 Kompletní výpis kódu úloh v tomto návodu, naleznete v tématu [hostování složeného ovládacího prvku WPF ve Windows Forms vzorku](http://go.microsoft.com/fwlink/?LinkID=159996).  
