...
## <a name="example"></a>Příklad  
 ...
 ![Text otočen pomocí RotateTransform](./media/transformedtext01.jpg "TransformedText01")  
...
Příklad zkreslený text  
 ...
 ![Text odsazení pomocí TranslateTransform](./media/transformedtext04.jpg "TransformedText04")  
