...
### <a name="markup"></a><span data-ttu-id="5919d-120">Revize</span><span class="sxs-lookup"><span data-stu-id="5919d-120">Markup</span></span>
...
### <a name="code-behind"></a><span data-ttu-id="5919d-132">Kód na pozadí</span><span class="sxs-lookup"><span data-stu-id="5919d-132">Code-behind</span></span>
...
<span data-ttu-id="5919d-143">Následující obrázek ukazuje výsledek při kliknutí na tlačítko:</span><span class="sxs-lookup"><span data-stu-id="5919d-143">The following figure shows the result when the button is clicked:</span></span>
...
<span data-ttu-id="5919d-209">Další informace najdete v tématu [Přehled datových vazeb](../../desktop-wpf/data/data-binding-overview.md).</span><span class="sxs-lookup"><span data-stu-id="5919d-209">For more information, see [Data binding overview](../../desktop-wpf/data/data-binding-overview.md).</span></span>
...
### <a name="2d-shapes"></a><span data-ttu-id="5919d-224">2D obrazce</span><span class="sxs-lookup"><span data-stu-id="5919d-224">2D shapes</span></span>
...
## <a name="animation"></a><span data-ttu-id="5919d-251">Animace</span><span class="sxs-lookup"><span data-stu-id="5919d-251">Animation</span></span>
...
<span data-ttu-id="5919d-281">Další informace najdete v tématu [Typografie v Windows Presentation Foundation](advanced/typography-in-wpf.md).</span><span class="sxs-lookup"><span data-stu-id="5919d-281">For more information, see [Typography in Windows Presentation Foundation](advanced/typography-in-wpf.md).</span></span>
...
### <a name="content-model"></a><span data-ttu-id="5919d-294">Model obsahu</span><span class="sxs-lookup"><span data-stu-id="5919d-294">Content model</span></span>
...
<span data-ttu-id="5919d-356">Prostředky a slovníky prostředků jsou základem podpory WPF pro motivy a vzhledy.</span><span class="sxs-lookup"><span data-stu-id="5919d-356">Resources and resource dictionaries are the foundation of WPF support for themes and skins.</span></span>
...
## <a name="wpf-best-practices"></a><span data-ttu-id="5919d-378">Osvědčené postupy pro WPF</span><span class="sxs-lookup"><span data-stu-id="5919d-378">WPF best practices</span></span>

<span data-ttu-id="5919d-379">Stejně jako u jakékoli vývojové platformy je možné WPF použít různými způsoby, abyste dosáhli požadovaného výsledku.</span><span class="sxs-lookup"><span data-stu-id="5919d-379">As with any development platform, WPF can be used in a variety of ways to achieve the desired result.</span></span> <span data-ttu-id="5919d-380">Jako způsob, jak zajistit, aby vaše aplikace WPF poskytovaly požadované uživatelské prostředí a splňovaly požadavky cílové skupiny obecně, existují Doporučené osvědčené postupy pro přístupnost, globalizaci a lokalizaci a výkon.</span><span class="sxs-lookup"><span data-stu-id="5919d-380">As a way of ensuring that your WPF applications provide the required user experience and meet the demands of the audience in general, there are recommended best practices for accessibility, globalization and localization, and performance.</span></span> <span data-ttu-id="5919d-381">Další informace naleznete v tématu:</span><span class="sxs-lookup"><span data-stu-id="5919d-381">For more information, see:</span></span>

- [<span data-ttu-id="5919d-382">Usnadnění</span><span class="sxs-lookup"><span data-stu-id="5919d-382">Accessibility</span></span>](../ui-automation/accessibility-best-practices.md)
- [<span data-ttu-id="5919d-383">Globalizace a lokalizace WPF</span><span class="sxs-lookup"><span data-stu-id="5919d-383">WPF globalization and localization</span></span>](advanced/wpf-globalization-and-localization-overview.md)
- [<span data-ttu-id="5919d-384">Výkon aplikace WPF</span><span class="sxs-lookup"><span data-stu-id="5919d-384">WPF app performance</span></span>](advanced/optimizing-wpf-application-performance.md)
- [<span data-ttu-id="5919d-385">Zabezpečení WPF</span><span class="sxs-lookup"><span data-stu-id="5919d-385">WPF security</span></span>](security-wpf.md)

## <a name="next-steps"></a><span data-ttu-id="5919d-386">Další kroky</span><span class="sxs-lookup"><span data-stu-id="5919d-386">Next steps</span></span>

<span data-ttu-id="5919d-387">Prohlédli jsme si klíčové funkce WPF.</span><span class="sxs-lookup"><span data-stu-id="5919d-387">We've looked at the key features of WPF.</span></span> <span data-ttu-id="5919d-388">Nyní je čas vytvořit svou první aplikaci WPF.</span><span class="sxs-lookup"><span data-stu-id="5919d-388">Now it's time to build your first WPF app.</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="5919d-389">Návod: Moje první desktopová aplikace WPF</span><span class="sxs-lookup"><span data-stu-id="5919d-389">Walkthrough: My first WPF desktop app</span></span>](getting-started/walkthrough-my-first-wpf-desktop-application.md)

## <a name="see-also"></a><span data-ttu-id="5919d-390">Viz také:</span><span class="sxs-lookup"><span data-stu-id="5919d-390">See also</span></span>

- [<span data-ttu-id="5919d-391">Začínáme s WPF (Windows Presentation Foundation)</span><span class="sxs-lookup"><span data-stu-id="5919d-391">Get started with WPF</span></span>](getting-started/index.md)
- [<span data-ttu-id="5919d-392">Windows Presentation Foundation</span><span class="sxs-lookup"><span data-stu-id="5919d-392">Windows Presentation Foundation</span></span>](index.md)
- [<span data-ttu-id="5919d-393">Komunitní materiály pro WPF</span><span class="sxs-lookup"><span data-stu-id="5919d-393">WPF community resources</span></span>](getting-started/community-feedback.md)
