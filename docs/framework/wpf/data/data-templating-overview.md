...
## <a name="prerequisites"></a>Požadavky  
 Toto téma se zaměřuje na funkce šablon dat a není Úvod koncepty vazeb data. Informace o základní datové vazby koncepty, najdete v článku [Data Binding Overview](data-binding-overview.md).  
  
 <xref:System.Windows.DataTemplate> spočívá v prezentaci dat a je jedním z mnoha funkcím, které poskytuje model WPF styly a šablony. Úvod WPF styly a šablony modelu, jako je například použití <xref:System.Windows.Style> nastavit vlastnosti v ovládacích prvcích, najdete v článku [styly a šablony](../controls/styling-and-templating.md) tématu.  
  
 Kromě toho je důležité pochopit `Resources`, které jsou v podstatě co povolit objektů, jako <xref:System.Windows.Style> a <xref:System.Windows.DataTemplate> bude opakovaně použitelné. Další informace o prostředcích naleznete v tématu [prostředky XAML](../advanced/xaml-resources.md).  
...
### <a name="without-a-datatemplate"></a>Bez šablonu DataTemplate  
 ...
 ![Snímek obrazovky ukázky šablon dat](./media/datatemplatingintro-fig1.png "DataTemplatingIntro_fig1")  
 ...
 ![Snímek obrazovky ukázky šablon dat](./media/datatemplatingintro-fig2.png "DataTemplatingIntro_fig2")  
...
### <a name="defining-a-simple-datatemplate"></a>Definování jednoduchý DataTemplate  
 ...
 ![Snímek obrazovky ukázky šablon dat](./media/datatemplatingintro-fig3.png "DataTemplatingIntro_fig3")  
...
### <a name="the-datatype-property"></a>Vlastnost DataType objektu  
 ...
 <xref:System.Windows.DataTemplate.DataType%2A> Vlastnost je zvláště užitečná v případě, že máte <xref:System.Windows.Data.CompositeCollection> různé typy datových objektů. Příklad najdete v tématu [implementace CompositeCollection](how-to-implement-a-compositecollection.md).  
...
[!code-xaml[DataTemplatingIntro#AddingMore2](~/samples/snippets/xaml/VS_Snippets_Wpf/DataTemplatingIntro/xaml/window1.xaml#addingmore2)]  
 ...
 ![Snímek obrazovky ukázky šablon dat](./media/datatemplatingintro-fig4.png "DataTemplatingIntro_fig4")  
 ...
 ![Snímek obrazovky ukázky šablon dat](./media/datatemplatingintro-fig5.png "DataTemplatingIntro_fig5")  
...
[!code-xaml[DataTemplatingIntro#AddingMore2](~/samples/snippets/xaml/VS_Snippets_Wpf/DataTemplatingIntro/xaml/window1.xaml#addingmore2)]  
 ...
 ![Snímek obrazovky ukázky šablon dat](./media/datatemplatingintro-fig6.png "DataTemplatingIntro_fig6")  
...
[!code-xaml[DataTemplatingIntro_snip#R2](~/samples/snippets/csharp/VS_Snippets_Wpf/DataTemplatingIntro_snip/CSharp/Window1.xaml#r2)]  
 ...
 ![Snímek obrazovky ukázky šablon dat](./media/datatemplatingintro-fig7.png "DataTemplatingIntro_fig7")  
...
## <a name="styling-and-templating-an-itemscontrol"></a>Styly a šablony prvku ItemsControl  
 ...
 ![Ukázkový snímek ItemsControl](./media/databinding-itemscontrolproperties.png "DataBinding_ItemsControlProperties")  
