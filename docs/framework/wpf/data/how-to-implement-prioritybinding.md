...
> [!NOTE]
>  V tomto příkladu je pouze pro demonstrační účely. [!INCLUDE[TLA#tla_net](../../../../includes/tlasharptla-net-md.md)] Pokyny nedoporučujeme definování vlastností, které jsou pořadí podle velikosti pomalejší, než by bylo pole sady. Další informace najdete v tématu [NIB: výběr mezi vlastnosti a metody](http://msdn.microsoft.com/en-us/55825e8f-7e2e-448a-9505-7217cc91b1af).  
