...
|Rozhraní .NET začínáte?|[Přehled rozhraní .NET Framework](https://msdn.microsoft.com/library/zw4w595w\(v=vs.140\).aspx)<br /><br /> [Základy vytváření aplikací .NET framework](../../../../docs/standard/application-essentials.md)<br /><br /> [Začínáme s jazykem Visual C# a Visual Basic](/visualstudio/ide/getting-started-with-visual-csharp-and-visual-basic)|  
