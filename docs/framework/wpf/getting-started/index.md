...
|||  
|-|-|  
|Chci pustit do práce …|[Návod: Moje první desktopová aplikace WPF](../../../../docs/framework/wpf/getting-started/walkthrough-my-first-wpf-desktop-application.md)|  
...
|Rozhraní .NET začínáte?|[Přehled rozhraní .NET Framework](../../get-started/overview.md)<br /><br /> [Základy vytváření aplikací .NET framework](../../../../docs/standard/application-essentials.md)<br /><br /> [Začínáme s jazykem Visual C# a Visual Basic](/visualstudio/ide/getting-started-with-visual-csharp-and-visual-basic)|  
