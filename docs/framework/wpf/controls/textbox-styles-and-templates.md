...
## <a name="textbox-parts"></a>Části textového pole  
 V následující tabulce jsou uvedené části s názvem pro <xref:System.Windows.Controls.TextBox> ovládacího prvku.  
...
## <a name="textbox-states"></a>Stavy TextBox  
 Následující tabulka uvádí visual stavy pro <xref:System.Windows.Controls.TextBox> ovládacího prvku.  
...
## <a name="textbox-controltemplate-example"></a>Element ControlTemplate příklad textového pole  
