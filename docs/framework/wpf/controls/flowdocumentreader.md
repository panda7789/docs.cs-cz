...
<xref:System.Windows.Controls.FlowDocumentReader> Řízení se používá k zobrazení <xref:System.Windows.Documents.FlowDocument> obsahu. Podporuje více režimů zobrazení.  
