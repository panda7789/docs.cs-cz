...
## <a name="panel-common-members"></a>Panel společné členy  
 Všechny <xref:System.Windows.Controls.Panel> prvky podporují základní změny velikosti a polohování vlastnosti určené <xref:System.Windows.FrameworkElement>, včetně <xref:System.Windows.FrameworkElement.Height%2A>, <xref:System.Windows.FrameworkElement.Width%2A>, <xref:System.Windows.FrameworkElement.HorizontalAlignment%2A>, <xref:System.Windows.FrameworkElement.VerticalAlignment%2A>, <xref:System.Windows.FrameworkElement.Margin%2A>, a <xref:System.Windows.FrameworkElement.LayoutTransform%2A>. Další informace o vlastnosti určené umístění <xref:System.Windows.FrameworkElement>, naleznete v tématu [zarovnání, okrajů a odsazení přehled](../../../../docs/framework/wpf/advanced/alignment-margins-and-padding-overview.md).  
...
#### <a name="defining-and-using-a-grid"></a>Definování a použití mřížky  
 ...
 ![Typické elementu mřížky. ](../../../../docs/framework/wpf/controls/media/avalon-run-dialog.PNG "avalon_run_dialog")  
...
#### <a name="defining-and-using-a-stackpanel"></a>Definování a použití objektu StackPanel  
 ...
 ![Typické elementu StackPanel. ](../../../../docs/framework/wpf/controls/media/panel-intro-stackpanel.PNG "panel_intro_stackpanel")  
...
### <a name="wrappanel"></a>WrapPanel  
 ...
 ![Prvek typické WrapPanel. ](../../../../docs/framework/wpf/controls/media/wrappanel-element.PNG "WrapPanel_Element")  
...
## <a name="nested-panel-elements"></a>Panel vnořené elementy  
 ...
 ![Uživatelské rozhraní, který využívá vnořené panely. ](../../../../docs/framework/wpf/controls/media/nested-panels.PNG "nested_panels")  
