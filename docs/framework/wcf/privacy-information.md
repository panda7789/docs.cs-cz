...
## <a name="auditing"></a>Auditování  
 ...
 Auditování také zaznamenává, když správce změní konfiguraci protokolování zpráv (zapnutí nebo vypnutí), protože protokolování zpráv může protokolovat data specifická pro aplikaci v záhlavích a subjektech. V systému Windows XP se záznam zaznamená do protokolu událostí aplikace. V případě systémů Windows Vista a Windows Server 2003 se záznam zaznamená do protokolu událostí zabezpečení.  
