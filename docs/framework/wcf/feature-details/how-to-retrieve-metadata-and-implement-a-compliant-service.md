...
4. Toto rozhraní implementovat třídy a hostitelem služby. Příklad najdete v tématu [jak: Implementace kontraktu služby](../../../../docs/framework/wcf/how-to-implement-a-wcf-contract.md), nebo se podívejte na jednoduché implementace níže v části příklad.  
