...
- [název oboru názvů] nemá žádnou hodnotu.
- [prefix] nemá žádnou hodnotu.
- [místní název] "\_\_typu" (dvě podtržítka a potom "typ").
...
|[Normalizovaná hodnota] z AII atribut typu JSON|Povolené [podřízené] odpovídající EII|Mapování do formátu JSON|
|---------------------------------------------------------|---------------------------------------------------|---------------------|
