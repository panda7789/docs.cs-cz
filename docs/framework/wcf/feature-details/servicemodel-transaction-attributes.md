...
ms.locfileid: "33500828"
---
# <a name="servicemodel-transaction-attributes"></a>Atributy transakce ServiceModel
Windows Communication Foundation (WCF) poskytuje vlastnosti na tři standard <xref:System.ServiceModel> atributy, které vám umožní nakonfigurovat chování transakce služby WCF:  
...
## <a name="operationbehaviorattribute"></a>OperationBehaviorAttribute  
 <xref:System.ServiceModel.OperationBehaviorAttribute> Atribut určuje chování metody k implementaci služby. Můžete se k označení chování při spuštění konkrétní operace. Vlastnosti tohoto atributu neovlivní popis webové služby popis Language (WSDL) kontrakt služby a jsou čistě elementy programovacího modelu WCF, které povolit společné funkce, vývojáři jinak jsou potřeba k implementaci sami.  
