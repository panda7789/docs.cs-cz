...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Obsahuje přehled podpory WS-Discovery poskytuje WCF.  
 ...
 Ukazuje, jak zjistitelnost služby Windows Communication Foundation (WCF).  
 ...
 Ukazuje, jak k použití kanálu klienta zjišťování při zápisu WCF klientské aplikace.
