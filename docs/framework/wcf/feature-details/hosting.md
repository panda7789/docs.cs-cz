...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Popisuje, jak je v Internetové informační službě hostované služby Windows Communication Foundation (WCF) nebo [Windows Server AppFabric](http://go.microsoft.com/fwlink/?LinkId=196496).  
 ...
 Popisuje, jak je služba WCF hostovaná služba aktivace procesů systému Windows.  
  
 [Hostování v aplikaci služby pro Windows](../../../../docs/framework/wcf/feature-details/hosting-in-a-windows-service-application.md)  
 Popisuje, jak je služba WCF hostovaná služba systému Windows.  
 ...
 Popisuje, jak je služby WCF hostované na IIS nebo WAS bez použití souboru .svc.  
