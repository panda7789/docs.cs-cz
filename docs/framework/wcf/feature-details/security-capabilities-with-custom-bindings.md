...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Popisuje základní kroky pro vytvoření vlastní vazby pomocí elementu zabezpečení.  
 ...
 Popisuje, jak zjistit, když dojde k opakování útoku.  
  
 [Postupy: Vytvoření podpůrného pověření](../../../../docs/framework/wcf/feature-details/how-to-create-a-supporting-credential.md)  
 Popisuje, jak zadat podpůrných přihlašovacích údajů ke službě, pokud služba vyžaduje, aby ho.  
  
 [Postupy: Nastavení potvrzení podpisu](../../../../docs/framework/wcf/feature-details/how-to-set-up-a-signature-confirmation.md)  
 Popisuje postup při digitální podpis zprávy potvrzení podpisů.  
 ...
 Popisuje, jak zákaz šifrování digitálních podpisů může mít zvýšení výkonu.  
