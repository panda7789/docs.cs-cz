...
ms.locfileid: "33498167"
---
# <a name="transactions-in-wcf"></a>Transakce ve WCF
Transakce funkce Windows Communication Foundation (WCF) umožňuje několik komponent souběžně zapojit se do operace dat. Témata v této části Zkontrolujte funkci podrobně.  
  
## <a name="in-this-section"></a>V tomto oddílu  
 [Přehled transakcí ve Windows Communication Foundation](../../../../docs/framework/wcf/feature-details/transactions-overview.md)  
 Přehled funkce transakce poskytované WCF.  
 ...
 Popisuje WS-AtomicTransaction (WS-AT), protokol šíření umožňuje vzájemnou spolupráci transakce, který je implementována ve WCF.  
