...
Následující scénář ukazuje [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] zabezpečené režim zabezpečení zprávy pomocí klienta a služby. Klienta a služby se ověřují pomocí certifikátů.  
