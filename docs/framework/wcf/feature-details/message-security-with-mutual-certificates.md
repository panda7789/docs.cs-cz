...
> Tento scénář neprovádí vyjednávání certifikátu služby. Certifikát služby je nutné poskytnout klientovi předem v jakékoli komunikaci. Certifikát serveru se dá distribuovat s aplikací nebo se poskytuje při komunikaci mimo IP síť.  
 ...
 ![Zabezpečení zpráv pomocí vzájemně vydaných certifikátů](media/f4157312-b17c-416c-a5ee-fa7b54db211b.gif "f4157312-b17c-416c-a5ee-fa7b54db211b")  
...
### <a name="configuration"></a>Konfigurace  
 Následující nakonfiguruje klienta. Certifikát klienta musí být zadaný pomocí [\<clientCertificate>](../../configure-apps/file-schema/wcf/clientcertificate-of-clientcredentials-element.md) . Certifikát služby je také určen pomocí [\<defaultCertificate>](../../configure-apps/file-schema/wcf/defaultcertificate-element.md) .  
