...
Tento scénář popisuje Windows Communication Foundation (WCF) klient a server zabezpečeny režim zabezpečení zprávy. Klient a služba, se ověřují pomocí pověření systému Windows.  
