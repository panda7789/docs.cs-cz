...
2. V systému Windows Server 2003 nebo Windows XP použijte nástroj HttpCfg. exe s klíčovými slovy **Delete** a **SSL** . Pomocí přepínače **-i** zadejte `IP`:`port` číslo a přepínač **-h** k určení kryptografického otisku.  
