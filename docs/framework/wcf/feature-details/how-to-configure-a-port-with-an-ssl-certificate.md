...
1. V systému Windows Server 2003 nebo [!INCLUDE[wxp](../../../../includes/wxp-md.md)]použijte nástroj HttpCfg. exe k zobrazení aktuální konfigurace portu pomocí přepínačů **dotaz** a **SSL** , jak je znázorněno v následujícím příkladu.  
...
1. V systému Windows Server 2003 nebo [!INCLUDE[wxp](../../../../includes/wxp-md.md)]pomocí nástroje HttpCfg. exe v režimu "Set" v úložišti SSL (Secure Sockets Layer) (SSL) navažte certifikát k číslu portu. Nástroj používá kryptografický otisk k identifikaci certifikátu, jak je znázorněno v následujícím příkladu.  
...
1. V systému Windows Server 2003 nebo [!INCLUDE[wxp](../../../../includes/wxp-md.md)]pro podporu klientů, kteří se ověřují pomocí certifikátů X. 509 na transportní vrstvě, postupujte podle předchozího postupu, ale předejte další parametr příkazového řádku HttpCfg. exe, jak je znázorněno v následujícím příkladu.  
...
2. V systému Windows Server 2003 nebo [!INCLUDE[wxp](../../../../includes/wxp-md.md)]použijte nástroj HttpCfg. exe s klíčovými slovy **Delete** a **SSL** . Pomocí přepínače **-i** zadejte `IP`:`port` číslo a přepínač **-h** k určení kryptografického otisku.  
