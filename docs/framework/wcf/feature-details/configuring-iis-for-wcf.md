...
## <a name="iis-70-installation-with-aspnet-support"></a>IIS 7.0: Instalace s podporou technologie ASP.NET
...
## <a name="iis-70-installation-with-iis-60-compatibility-components"></a>IIS 7.0: Instalace součásti služby IIS 6.0 kompatibility
