...
1.  Použijte nástroj HttpCfg.exe k vytvoření vazby certifikátu SSL port na počítači. [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)][Postup: Nakonfigurujte certifikát protokolu SSL Port](../../../../docs/framework/wcf/feature-details/how-to-configure-a-port-with-an-ssl-certificate.md).  
...
3.  Nastavte <xref:System.ServiceModel.HttpTransportSecurity.ClientCredentialType%2A> vlastnost na odpovídající hodnotu. ([!INCLUDE[crdefault](../../../../includes/crdefault-md.md)] [Výběr typu pověření](../../../../docs/framework/wcf/feature-details/selecting-a-credential-type.md).) Následující kód používá <xref:System.ServiceModel.MessageCredentialType.Certificate> hodnotu.  
...
1.  Nakonfigurujte počítač certifikátem SSL vázány na port. ([!INCLUDE[crdefault](../../../../includes/crdefault-md.md)] [Postup: Nakonfigurujte certifikát protokolu SSL Port](../../../../docs/framework/wcf/feature-details/how-to-configure-a-port-with-an-ssl-certificate.md)). Není nutné nastavovat <`transport`> Hodnota elementu s touto konfigurací.  
