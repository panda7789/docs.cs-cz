...
|-----------------------------------|--------------|-----------|  
|SLUŽBU|HTTP|Společná součást, která poskytuje aktivaci protokolem HTTP pro IIS 7,0 a WCF.|  
|Službu NetTcpActivator|net.tcp|Závisí na službě NetTcpPortSharing.|  
