...
ms.locfileid: "33497396"
---
# <a name="security-concepts"></a>Koncepty zabezpečení
Tato část vysvětluje stručně koncepce aplikace zabezpečení Windows Communication Foundation (WCF).  
...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Přehled o tom, jak WCF poskytuje zabezpečení v topografie distribuované aplikace.  
  
 [Terminologie zabezpečení](../../../../docs/framework/wcf/feature-details/wcf-security-terminology.md)  
 Glosář termínů používaných když hovoříte o zabezpečení WCF.  
