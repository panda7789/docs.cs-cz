...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Demonstruje postup vytvoření transakční služby ve službě WCF.  
  
 [Diagnostikování transakčních aplikací](../../../../docs/framework/wcf/feature-details/diagnosing-transactional-applications.md)  
 Popisuje, jak používat funkci diagnostiky a správy ve službě WCF řešení aplikace transakcí.  
 ...
 Popisuje postup pro integraci služby WCF kód, který používá služba enterprise.
