...
- wsdlImporters  
 ...
 Na Windows serveru 2003 a [!INCLUDE[wxp](../../../includes/wxp-md.md)]ch počítačích (IIS 5,1 a IIS 6,0) se registruje jedna sada map. XOML a. Rules.  
...
### <a name="installing-iis-after-net-framework-35-is-installed"></a>Instalace služby IIS po instalaci .NET Framework 3,5  
 V počítači se systémem Windows Server 2003 je před instalací služby IIS nainstalován .NET Framework 3,5. Z důvodu nedostupnosti metabáze služby IIS je instalace .NET Framework 3,5 úspěšná, aniž by bylo potřeba instalovat. XOML a. Rules mapy skriptů.  
...
#### <a name="scriptmap-deleted-under-web-sites-node"></a>V uzlu weby byly odstraněny mapy skriptů.  
 Na počítači s Windows serverem 2003 je. XOML nebo. Rules omylem odstraněn z uzlu weby. To lze opravit spuštěním nástroje WFServicesReg. exe s přepínačem `/c`.  
  
#### <a name="scriptmap-deleted-under-a-particular-web-site"></a>Mapování skriptů se odstranilo v rámci určitého webu.  
 V počítači se systémem Windows Server 2003 se nechtěně odstraní z konkrétního webu (například výchozího webu), nikoli z uzlu weby.  
