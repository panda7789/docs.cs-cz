...
Tato ukázka předvádí, jak implementovat kontrakt dat. Kontrakty dat umožňují předat strukturovaná data službám a ze služeb. Tato ukázka je založena na [Začínáme](getting-started-sample.md) , ale používá složitá čísla namísto základních číselných typů.
...
Implementace klienta také používá složitá čísla. Kontrakt služby i kontrakt dat jsou definované ve zdrojovém souboru generatedClient.cs, který je generovaný nástrojem pro dodávání [metadat ServiceModel (Svcutil. exe)](../servicemodel-metadata-utility-tool-svcutil-exe.md) z metadat služby.
