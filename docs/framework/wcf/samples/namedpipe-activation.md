...
Tato ukázka demonstruje hostování služby, která používá aktivační službu procesů systému Windows (WAS) k aktivaci služby, která komunikuje s kanály názvů. Tato ukázka je založená na [Začínáme](../../../../docs/framework/wcf/samples/getting-started-sample.md) a vyžaduje spuštění [!INCLUDE[wv](../../../../includes/wv-md.md)].
