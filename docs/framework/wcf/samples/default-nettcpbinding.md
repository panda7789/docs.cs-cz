...
Tato ukázka demonstruje použití <xref:System.ServiceModel.NetTcpBinding> vazby. Tato ukázka je založená na [Začínáme](getting-started-sample.md) , která implementuje službu kalkulačky. V této ukázce je služba hostovaná v místním prostředí. Klient i služba jsou konzolové aplikace.  
...
> `<InstallDrive>:\WF_WCF_Samples\WCF\Basic\Binding\Net\TCP\Default`  
 ...
 Vazba je určena v konfiguračních souborech pro klienta a službu. Typ vazby je určen v `binding` atributu [\<endpoint>](../../configure-apps/file-schema/wcf/endpoint-element.md) prvku, jak je znázorněno v následující ukázkové konfiguraci.  
