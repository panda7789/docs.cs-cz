...
Tato ukázka předvádí, jak definovat <xref:System.ServiceModel.WSHttpBinding> pro službu pomocí kódu namísto definování `wsHttpBinding` vazby v konfiguraci. Tato ukázka je založená na [Začínáme](getting-started-sample.md) , která implementuje službu kalkulačky.

> [!NOTE]
> Postup nastavení a pokyny pro sestavení pro tuto ukázku najdete na konci tohoto tématu.

Následující kód ukazuje, jak definovat závazné vazby v kódu.
