...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Ukazuje, jak napsat kód imperativní pro definice a používání vlastních vazeb bez použití konfiguračního souboru nebo klienta WCF vygenerovat.  
 ...
 Demonstruje použití protokolu SSL zabezpečení přenosu s spolehlivé relace.
