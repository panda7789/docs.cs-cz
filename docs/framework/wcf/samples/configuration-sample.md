...
```  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)]obory, najdete v části [najít zjišťování a kritéria hledání](../../../../docs/framework/wcf/feature-details/discovery-find-and-findcriteria.md).  
