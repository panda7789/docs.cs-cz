...
Tato ukázka demonstruje použití zabezpečení přenosu SSL se základní vazbou. Tato ukázka je založená na [Začínáme](getting-started-sample.md) , která implementuje službu kalkulačky.
...
Kód programu v ukázce je stejný jako u služby [Začínáme](getting-started-sample.md) . Definice koncového bodu a definice vazby v nastavení konfiguračního souboru jsou upraveny tak, aby umožňovaly zabezpečenou komunikaci, jak je znázorněno v následující ukázkové konfiguraci.
