...
Tato část obsahuje příklady vysvětlující vazby zabezpečení zpráv ve službách systému Windows ve službě WCF.  
  
## <a name="in-this-section"></a>V tomto oddílu  
 [Zabezpečení zpráv s anonymní metodou](../../../../docs/framework/wcf/samples/message-security-anonymous.md)  
 Tento příklad znázorňuje, jak implementovat aplikace Windows Communication Foundation (WCF), který používá zabezpečení na úrovni zpráv bez jakéhokoli ověřování klienta, ale která vyžaduje server ověřování pomocí certifikátu X.509 serveru.  
