...
Toto je třetí webinář z šesti úkolů potřebný k vytvoření aplikace Windows Communication Foundation (WCF). Přehled všech šesti úkoly, naleznete v tématu [kurz Začínáme](getting-started-tutorial.md) tématu.
...
> [Postupy: Vytvořte klienta WCF](how-to-create-a-wcf-client.md)

Informace o odstraňování potíží naleznete v tématu [řešení potíží s kurzu Začínáme](troubleshooting-the-getting-started-tutorial.md).
