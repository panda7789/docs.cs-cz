...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Seznam vazeb součástí [!INCLUDE[indigo2](../../../includes/indigo2-md.md)]. Tyto vazby zahrnují většina zpráva vzor požadavky na zabezpečení a.  
  
 [Používání vazeb ke konfiguraci služeb a klientů](../../../docs/framework/wcf/using-bindings-to-configure-services-and-clients.md)  
 A [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] vazba obsahuje důležité informace, které musí klienti používat pro připojení ke koncovým bodům služby.  
