...
## <a name="in-this-section"></a>V tomto oddílu  
 [Analytické trasování – přehled](../../../../../docs/framework/wcf/diagnostics/etw/analytic-tracing-overview.md)  
 ...
 [Analytické trasování událostí odkaz](../../../../../docs/framework/wcf/diagnostics/etw/analytic-trace-event-reference.md)  
...
## <a name="see-also"></a>Viz také  
 ...
 [Sledování událostí do událostí trasování v systému Windows](../../../../../docs/framework/windows-workflow-foundation/samples/tracking-events-into-event-tracing-in-windows.md)
