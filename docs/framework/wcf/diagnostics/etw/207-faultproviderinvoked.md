...
## <a name="description"></a>Popis  
 Tato událost je vygenerován po `FaultProvider` zavolání.  
  
## <a name="message"></a>Zpráva  
 Dispečer vyvolal třídu FaultProvider typu '%1' se výjimka typu '%2'.  
  
## <a name="details"></a>Podrobnosti  
  
|Název položky dat|Datový typ položky|Popis|  
|--------------------|--------------------|-----------------|  
|TypeName|`xs:string`|Celý název CLR typu vyvolanou `FaultProvider`.|  
|ExceptionTypeName|`xs:string`|Celý název CLR výjimky, která `FaultProvider` má zpracovat.|  
