...
## <a name="description"></a>Popis  
 Tato událost je vygenerován po má Model služby `AfterReceive` metodu na zpráva inspector.  
  
## <a name="message"></a>Zpráva  
 Dispečer vyvolal metodu 'AfterReceiveReply"na třídě MessageInspector typu '%1'.  
