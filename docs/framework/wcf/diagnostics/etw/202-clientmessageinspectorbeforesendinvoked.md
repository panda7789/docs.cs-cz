...
## <a name="description"></a>Popis  
 Tato událost je vygenerován po má Model služby `BeforeSendRequest` metodu na inspektoru zprávy klienta.  
  
## <a name="message"></a>Zpráva  
 Dispečer vyvolal metodu 'BeforeSendRequest"na třídě ClientMessageInspector typu '%1'.  
