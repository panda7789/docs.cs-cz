...
Tato část uvádí všechny výjimky v těchto oblastech generované Windows Communication Foundation (WCF):  
 ...
 [Základní komunikace: Architektura kanálů](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/core-communications-channel-framework.md)  
 ...
 [Transakce](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/transaction-exceptions.md)  
 ...
 [Spolehlivé zasílání zpráv](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/reliable-messaging.md)  
  
 [Výjimky zabezpečení](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/security-exceptions.md)  
  
 [Architektura služby](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/service-framework.md)  
  
 [Data architektury služby](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/service-framework-data.md)  
  
 [Formátování transakcí](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/transaction-formatter.md)  
