# [Diagnostika prostřednictvím rozhraní WMI (Windows Management Instrumentation)](index.md)
## [WMI – přehled tříd](wmi-class-reference.md)
...
### [Behavior – třída](behavior-class.md)
...
### [Operation – třída](operation-class.md)
