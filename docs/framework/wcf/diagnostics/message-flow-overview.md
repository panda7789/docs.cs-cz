...
-   Začátku do konce aktivity modelu pro služby WCF/WF: korelační trasování vygenerovaná podporuje tuto funkci <xref:System.ServiceModel> a <xref:System.Workflow.ComponentModel> obory názvů.

-   Sledování WF trasování událostí pro Windows: Tato funkce používá sledování záznamů vygenerovaných službami WF poskytnout přehled o aktuálním stavu a průběhu pracovního postupu.
