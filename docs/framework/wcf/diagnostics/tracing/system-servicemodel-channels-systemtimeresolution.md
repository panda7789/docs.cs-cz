...
## <a name="description"></a>Popis  
 Rozlišení časovače operačního systému byla detekována jako *n* rysky, které je přibližně *m* milisekundách. Kde *n* a *m* jsou číselné hodnoty.  
