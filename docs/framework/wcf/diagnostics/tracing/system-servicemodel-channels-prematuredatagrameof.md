...
## <a name="description"></a>Popis  
 Z kanálu datagramu byla přijata zpráva null (signalizační konci kanálu), ale kanál je stále ve stavu otevřeno. To znamená chybu v kanálu datagramu a deaktivace multiplexer přijímat smyčky byla předčasně ukončena.  
