...
Překladač Pnrp dokončit operace řešení.  
  
## <a name="description"></a>Popis  
 Trasování upozornění označuje, že překladač Pnrp nelze najít žádné adresy. Trasování nastane během operace vyřešit pomocí překladače PNRP.  
