...
## <a name="description"></a>Popis  
 Operace požadavku nebo odpovědi nemá žádnou zprávu s odpovědí.  
  
 Toto je obousměrná operace; není však k dispozici žádná odpověď pro odeslání klientovi. Toto trasování můžete použít pro ladění během vývoje.  
