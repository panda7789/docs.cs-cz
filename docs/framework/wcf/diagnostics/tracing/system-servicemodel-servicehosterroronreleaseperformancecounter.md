...
## <a name="description"></a>Popis  
 V hostiteli ServiceHost došlo k chybám při volání ReleasePerformanceCounters. Trasování je možné určit chyby při uvolnění čítačů výkonu.  
