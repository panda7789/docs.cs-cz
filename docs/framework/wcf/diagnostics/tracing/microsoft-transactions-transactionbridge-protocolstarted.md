...
ms.locfileid: "33473685"
---
# <a name="microsofttransactionstransactionbridgeprotocolstarted"></a>Microsoft.Transactions.TransactionBridge.ProtocolStarted
Protokol WS-Atomic Transactions byla spuštěna.  
  
## <a name="description"></a>Popis  
 Trasovat během spouštění Správce transakcí k označení, který protokol byla úspěšně spuštěna.  
