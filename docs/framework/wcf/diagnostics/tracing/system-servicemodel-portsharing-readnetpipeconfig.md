...
## <a name="description"></a>Popis  
 Konfigurační data pro NetPipeSection byl načten se zadanými daty: se zadanými daty: maxConnectionsPendingDispatch, maxPendingAccepts a receiveTimeout.  
