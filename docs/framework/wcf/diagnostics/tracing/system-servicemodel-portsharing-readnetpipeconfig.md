...
## <a name="description"></a>Popis  
 Konfigurační data pro třídu NetPipeSection byla načtena se zadanými daty: se zadanými daty: maxConnectionsPendingDispatch, maxPendingAccepts a receiveTimeout.  
