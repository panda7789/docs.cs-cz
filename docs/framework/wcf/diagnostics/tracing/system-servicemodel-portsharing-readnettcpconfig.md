...
## <a name="description"></a>Popis  
 Konfigurační data pro NetTcpSection byl načten se zadanými daty: listenBacklog, maxConnectionsPendingDispatch, maxPendingAccepts, receiveTimeout a teredoEnabled.  
