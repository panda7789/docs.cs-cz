...
## <a name="description"></a>Popis  
 Konfigurační data pro třídu NetTcpSection byla načtena se zadanými daty: listenBacklog, maxConnectionsPendingDispatch, maxPendingAccepts, receiveTimeout a teredoEnabled.  
