...
## <a name="description"></a>Popis  
 Trasování jsou vydávány při vytváření kanálu na úrovni informace. Poskytuje popis koncovým bodem, který je rozhovoru klienta (například vzdálené adresy, vazby, název kontraktu).  
