...
### [Aktivita](activity.md)
### [Přenos](transfer.md)
### [Šíření](propagation.md)
### [Souhrn typů trasování](trace-type-summary.md)
## [Řešení problémů s aplikací pomocí trasování](using-tracing-to-troubleshoot-your-application.md)
...
#### [Seznam aktivit](activity-list.md)
#### [Šíření ID aktivity](activity-id-propagation.md)
#### [Synchronní scénáře využívající HTTP, TCP nebo pojmenované kanály](synchronous-scenarios-using-http-tcp-or-named-pipe.md)
#### [Asynchronní scénáře využívající HTTP, TCP nebo pojmenované kanály](asynchronous-scenarios-using-http-tcp-or-named-pipe.md)
#### [Trasování aktivit v zabezpečení zpráv](activity-tracing-in-message-security.md)
#### [Služba MSMQ](msmq.md)
#### [Model COM+](com.md)
### [Významná trasování](significant-traces.md)
### [Ladění na klientovi](debugging-on-the-client.md)
### [Generování trasování v uživatelském kódu](emitting-user-code-traces.md)
## [Doporučené nastavení pro trasování a protokolování zpráv](recommended-settings-for-tracing-and-message-logging.md)
