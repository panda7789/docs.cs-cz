...
Protokol je nesprávně nakonfigurován v proces aktivace služby WAS (Windows).  
  
## <a name="description"></a>Popis  
 K této chybě dojde, když přenosový protokol není správně nakonfigurována.  
  
## <a name="troubleshooting"></a>Poradce při potížích  
 Kontrola a oprava přenos konfigurační parametry v souboru web.config.  
