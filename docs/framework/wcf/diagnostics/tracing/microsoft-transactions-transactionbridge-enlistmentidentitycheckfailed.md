...
Identita odesílatele příchozí zprávy neodpovídá identitě odvozené z reference koncového bodu.  
  
## <a name="description"></a>Popis  
 Trasovat, pokud zpráva zabezpečení ověření se nezdařilo.  
  
## <a name="troubleshooting"></a>Poradce při potížích  
 Zkontrolujte, že zabezpečení transakcí správně nakonfigurovaný pro všechny počítače, které se účastní transakce.  
