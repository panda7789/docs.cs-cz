...
## <a name="description"></a>Popis  
 ...
 Trasování jsou vydávány, když je odeslána zpráva WCF, pokud `System.ServiceModel` zdroj trasování je povoleno na podrobné úrovni nebo informace. Trasování je nutné zobrazíte šipka korelace zprávy v zobrazení grafu aktivity.  
