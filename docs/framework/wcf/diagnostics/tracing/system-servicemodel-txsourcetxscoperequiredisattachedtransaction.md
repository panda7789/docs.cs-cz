...
Zadanou transakci byla přijata pro danou operaci od transakce InstanceContext.  
  
## <a name="description"></a>Popis  
 Trasovat, pokud byla transakce zpřístupněn pro uživatelský kód zbylá po automatického dokončování = false metodu s názvem před toto volání.  
