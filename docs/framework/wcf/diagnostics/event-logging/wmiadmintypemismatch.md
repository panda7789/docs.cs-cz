...
## <a name="description"></a>Popis  
 Tato událost ukazuje na to, že došlo k neshodě typů. Zadaná vlastnost třídy CIM nemůže přijmout hodnotu konkrétního typu. Události jsou uvedeny, název procesu a ID procesu.  
