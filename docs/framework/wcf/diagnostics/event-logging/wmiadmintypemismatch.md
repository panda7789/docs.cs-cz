...
## <a name="description"></a>Popis  
 Tato událost označuje, že došlo k neshodě typů. Zadaná vlastnost třídy CIM nemůže přijmout hodnotu konkrétního typu. Události obsahuje název procesu a ID procesu.  
