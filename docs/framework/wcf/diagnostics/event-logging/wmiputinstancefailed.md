...
## <a name="description"></a>Popis  
 Tato událost označuje, že provedení funkce PutInstance WMI požadavek nebyl zpracován. ID události seznamy objekt rozhraní WMI, výjimky, název procesu a proces.  
