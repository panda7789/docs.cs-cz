...
## <a name="description"></a>Popis  
 Tato událost označuje, že došlo k výjimce HTTP tomuto webovému hostiteli. Události uvádí informace o odesílateli, HtmlErrorMessage, výjimky, název procesu a ID procesu.  
