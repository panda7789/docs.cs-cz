...
## <a name="description"></a>Popis  
 Tato událost označuje, že došlo k chybě při importu knihovny typů. Události jsou uvedené identifikátory IID, zadejte ID knihovny, výjimky, název procesu a ID procesu.  
