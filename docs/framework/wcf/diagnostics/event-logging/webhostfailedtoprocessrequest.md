...
## <a name="description"></a>Popis  
 Tato událost označuje, že webového hostitele se nepodařilo zpracovat žádost. ID události zobrazí informace o odesílateli, výjimky, název procesu a proces.  
