...
## <a name="description"></a>Popis  
 Tato událost ukazuje na to, že tomuto webovému hostiteli nepovedlo se zpracovat požadavek. ID události seznamy informace odesílatele, výjimky, název procesu a proces.  
