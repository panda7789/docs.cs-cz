...
## <a name="description"></a>Popis  
 Tato událost označuje, že došlo k neošetřené výjimce během zpracování události stavu počítače. ID události seznamy ID transakce, název stavu počítače, aktuální stav, historie, zařazení ID, výjimku, název procesu a proces.  
