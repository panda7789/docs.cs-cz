...
## <a name="description"></a>Popis  
 Tato událost označuje, že tomuto webovému hostiteli neošetřené výjimky došlo k chybě. ID události zobrazí informace o odesílateli, výjimky, název procesu a proces.  
