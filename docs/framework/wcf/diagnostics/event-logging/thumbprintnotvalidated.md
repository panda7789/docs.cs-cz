...
## <a name="description"></a>Popis  
 Tato událost označuje, že nebylo možné ověřit certifikát identity s zadaný kryptografický otisk. Události obsahuje název procesu a ID procesu.  
