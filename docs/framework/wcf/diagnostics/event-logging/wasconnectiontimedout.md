...
## <a name="description"></a>Popis  
 Tato událost ukazuje na to, že připojení, které vyžaduje služba Aktivace procesu Windows (WAS) vypršel časový limit, název procesu a ID.  
