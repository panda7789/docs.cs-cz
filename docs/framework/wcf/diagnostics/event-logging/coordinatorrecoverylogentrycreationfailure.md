...
## <a name="description"></a>Popis  
 Položka protokolu obnovení nebylo možné vygenerovat pro zařazení coordinator. Transakce bude přerušena. Seznamy událost ID transakce, důvod, výjimky, název procesu a proces.  
