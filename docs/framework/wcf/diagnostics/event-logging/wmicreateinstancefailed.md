...
## <a name="description"></a>Popis  
 Tato událost ukazuje na to, že požadavek WMI CreateInstance nebyl zpracován. Událost obsahuje název třídy, výjimky, název procesu a ID procesu.  
