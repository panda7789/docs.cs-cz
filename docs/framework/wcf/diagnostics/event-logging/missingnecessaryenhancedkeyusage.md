...
## <a name="description"></a>Popis  
 Tato událost označuje, že certifikát identity s názvem konkrétní předmětu a kryptografický otisk nenabízí konkrétní data mezi jeho EnhancedKeyUsages. Události obsahuje název procesu a ID procesu.  
