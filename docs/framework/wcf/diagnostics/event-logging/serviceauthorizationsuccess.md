...
## <a name="description"></a>Popis  
 Tato událost označuje, že služba ověření bylo úspěšné. Události jsou uvedené služby, akce, identita klienta, autorizační kontext, ID aktivity a ServiceAuthorizationManager.  
