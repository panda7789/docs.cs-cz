...
## <a name="description"></a>Popis  
 Protokolování zpráv je zapnutý. Citlivé informace mohou být zaznamenány, i v případě, že byla šifrovaná v drátové síti. Například zpráva subjektů. Události jsou uvedeny AppID, výjimky, název procesu a ID procesu.  
