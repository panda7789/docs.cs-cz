...
## <a name="description"></a>Popis  
 Tato událost ukazuje na to, že certifikát identity s názvem zadaným předmětem a kryptografický otisk neposkytuje konkrétní data mezi jeho KeyUsages. Také uvádí název procesu a ID procesu.  
