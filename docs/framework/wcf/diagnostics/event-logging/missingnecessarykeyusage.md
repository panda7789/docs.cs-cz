...
## <a name="description"></a>Popis  
 Tato událost označuje, že certifikát identity s zadanému názvu subjektu a kryptografický otisk nenabízí konkrétní data mezi jeho KeyUsages. Také uvádí název procesu a ID procesu.  
