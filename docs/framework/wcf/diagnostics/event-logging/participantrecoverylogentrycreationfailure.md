...
## <a name="description"></a>Popis  
 Tato událost označuje, že položka protokolu arecovery nebylo možné vygenerovat pro zápis účastníka. Transakce bude přerušena. Seznamy událost ID transakce zařazení ID, výjimky, název procesu a ID procesu.  
