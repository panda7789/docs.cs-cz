...
## <a name="description"></a>Popis  
 Tato událost označuje, že položka protokolu účastnické obnovení byl poškozen a nelze deserializovat. Z této chybě může dojít ke ztrátě dat. Seznamy událost ID transakce, obnovení dat (kódováním Base64), výjimky, název procesu a proces.  
