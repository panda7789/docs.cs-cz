...
## <a name="description"></a>Popis  
 Tato událost označuje, že nebyla načtena. čítače výkonu. Událost uvádí název kategorie, název čítače, název instance, výjimky, název procesu a ID procesu.  
