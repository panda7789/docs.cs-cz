...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Obsahuje pokyny pro vyrovnávání zatížení pomocí webové farmy.  
 ...
 Popisuje vlastnosti, které jsou navržené tak, které pomůže zabránit spotřeba zbytečného prostředků a zlepšení zabezpečení a odkazuje na podrobnější informace o jejich použití.  
  
 [Nasazení aplikací služby WCF technologií ClickOnce](../../../docs/framework/wcf/deploying-wcf-applications-with-clickonce.md)  
 Popisuje důležité informace, které budou při použití funkce ClickOnce.  
