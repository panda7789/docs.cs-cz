...
Šablony sady Visual Studio Windows Communication Foundation (WCF) jsou předdefinovaných šablon projektů a položek v sadě Visual Studio můžete použít k rychlému vytvoření [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] služby a okolního aplikace.  
