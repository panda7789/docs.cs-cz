...
WCF teď obsahují podporu pro rozvoje prvního kontraktu. Svcutil.exe má /serviceContract přepínač, který vám umožní generovat kontrakty služby a dat z dokumentu WSDL.
