...
-   Provést jako objekt factory pro <xref:System.IdentityModel.Selectors.SecurityTokenManager> implementace.  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)]třídy přihlašovací údaje a jak je začlenit do [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] Architektura zabezpečení, najdete v části [Architektura zabezpečení](http://msdn.microsoft.com/en-us/16593476-d36a-408d-808c-ae6fd483e28f).  
