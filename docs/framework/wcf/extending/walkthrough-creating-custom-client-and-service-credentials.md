...
Třídy i dědí <xref:System.ServiceModel.Security.SecurityCredentialsManager> z abstraktní třídydefinujícíkontraktprovrácení.<xref:System.IdentityModel.Selectors.SecurityTokenManager> <xref:System.ServiceModel.Description.ClientCredentials> <xref:System.ServiceModel.Description.ServiceCredentials>
