...
|IIS 5.1, IIS 6.0|– Spouštění služby WCF vedle sebe s obsahem ASP.NET na Internetu pomocí protokolu HTTP.|– Recyklace procesu.<br />-Nečinnosti vypnutí.<br />-Zpracování monitorování stavu.<br />-Založenou na zprávách aktivace.<br />-Pouze protokolu HTTP.|  
