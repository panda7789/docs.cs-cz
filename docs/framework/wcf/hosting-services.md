...
|IIS 5.1, [!INCLUDE[iis601](../../../includes/iis601-md.md)]|– Spouštění WCF service souběžně s [!INCLUDE[vstecasp](../../../includes/vstecasp-md.md)] obsahu na Internetu pomocí protokolu HTTP.|– Recyklace procesu.<br />-Nečinnosti vypnutí.<br />-Zpracování monitorování stavu.<br />-Založenou na zprávách aktivace.<br />-Pouze protokolu HTTP.|  
...
|Internetová informační služba 7,0|– Spouštění WCF Services [!INCLUDE[vstecasp](../../../includes/vstecasp-md.md)] obsah.<br />– Spouštění služby WCF na Internetu s použitím různé přenosové protokoly.|-BYLO výhody.<br />– Integrované s [!INCLUDE[vstecasp](../../../includes/vstecasp-md.md)] a obsah služby IIS.|  
