...
|-----------|--------------|-----------------|
|`GCStart_V1`|první|Bylo zahájeno uvolňování paměti.|

Následující tabulka ukazuje data události:

|název pole|Datový typ|Popis|
|----------------|---------------|-----------------|
|Výpočtu|Win: UInt32|*N*-tou kolekci uvolnění paměti.|
...
|Událost|ID události|Vyvolá se, když|
|-----------|--------------|-----------------|
|`GCEnd_V1`|odst|Uvolňování paměti bylo ukončeno.|
...
|název pole|Datový typ|Popis|
|----------------|---------------|-----------------|
|Adresáře|Win: UInt64|Adresa segmentu.|
...
|Událost|ID události|Vyvolá se, když|
|-----------|--------------|-----------------|
|`GCRestartEEBegin_V1`|čl|Bylo zahájeno obnovení z pozastavení modulu CLR (Common Language Runtime).|
...
|Výpočtu|Win: UInt32|Počet GC v daném okamžiku. Obvykle se vám po tomto zobrazení zobrazí další počáteční událost GC a její počet by byl tento počet + 1, protože během uvolňování paměti narůstá index GC.|
|ClrInstanceID|Win: UInt16|Jedinečné ID pro instanci CLR nebo CoreCLR.|
...
|Událost|ID události|Vyvolá se, když|
|-----------|--------------|-----------------|
|`GCAllocationTick_V2`|10pruhový|Pokaždé, když se přidělí přibližně 100 KB.|
...
|Událost|ID události|Vyvolá se, když|
|-----------|--------------|-----------------|
|`GCFinalizersBegin_V1`|čtrnáct|Začátek spuštění finalizační metody.|
...
|Událost|ID události|Vyvolá se, když|
|-----------|--------------|-----------------|
|`GCFinalizersEnd_V1`|13,5|Konec spuštění finalizační metody.|

Následující tabulka ukazuje data události:

|název pole|Datový typ|Popis|
|----------------|---------------|-----------------|
|Výpočtu|Win: UInt32|Počet finalizační metody, které byly spuštěny.|
|ClrInstanceID|Win: UInt16|Jedinečné ID pro instanci CLR nebo CoreCLR.|
...
|Událost|ID události|Vyvolá se, když|
|-----------|--------------|-----------------|
|`GCCreateConcurrentThread_V1`|odst|Bylo vytvořeno souběžné vlákno uvolňování paměti.|
...
|Událost|ID události|Vyvolá se, když|
|-----------|--------------|-----------------|
|`GCTerminateConcurrentThread_V1`|12,5|Vlákno souběžného uvolňování paměti bylo ukončeno.|
