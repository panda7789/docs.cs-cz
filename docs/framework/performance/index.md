...
|App type|Další informace naleznete v tématu|  
|--------------|---------|  
|.NET Framework apps for all platforms|[Kolekce paměti a výkon](../../standard/garbage-collection/performance.md)<br /><br /> [Tipy pro zvýšení výkonu](performance-tips.md)|  
...
|Název|Popis|  
|-----------|-----------------|  
|[Ukládání do vyrovnávací paměti v aplikacích .NET Framework](caching-in-net-framework-applications.md)|Describes techniques for caching data to improve performance in your app.|  
|[Opožděná inicializace](lazy-initialization.md)|Describes how to initialize objects as-needed to improve performance, particularly at app startup.|  
|[Spolehlivost](reliability.md)|Provides information about preventing asynchronous exceptions in a server environment.|  
|[Psaní velkých a pohotově reagujících aplikací .NET Framework](writing-large-responsive-apps.md)|Provides performance tips gathered from rewriting the C# and Visual Basic compilers in managed code, and includes several real examples from the C# compiler.|
