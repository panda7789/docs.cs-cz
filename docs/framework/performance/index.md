...
|--------------|---------|  
|.NET Framework aplikací pro všechny platformy|[Kolekce paměti a výkon](../../standard/garbage-collection/performance.md)<br /><br /> [Tipy pro zvýšení výkonu](../../../docs/framework/performance/performance-tips.md)|  
|[!INCLUDE[win8_appname_long](../../../includes/win8-appname-long-md.md)]aplikace napsané C++v C#, a Visual Basic|[Osvědčené postupy výkonu pro aplikace pro Windows C++Store C#využívající systémy, a Visual Basic](https://docs.microsoft.com/previous-versions/windows/apps/hh750313%28v=win.10%29)|  
...
|Název|Popis|  
|-----------|-----------------|  
|[Ukládání do vyrovnávací paměti v aplikacích .NET Framework](../../../docs/framework/performance/caching-in-net-framework-applications.md)|Popisuje techniky ukládání dat do mezipaměti pro zlepšení výkonu aplikace.|  
|[Opožděná inicializace](../../../docs/framework/performance/lazy-initialization.md)|Popisuje, jak inicializovat objekty podle potřeby pro zlepšení výkonu, zejména při spuštění aplikace.|  
...
|[Psaní velkých a pohotově reagujících aplikací .NET Framework](../../../docs/framework/performance/writing-large-responsive-apps.md)|Poskytuje tipy k výkonu shromážděné z přepisu kompilátorů C# a Visual Basic ve spravovaném kódu a obsahuje několik reálných příkladů C# z kompilátoru.|
