...
## <a name="protected-objects"></a>Chráněné objekty  
 ...
 Jedním z příkladů je vytvoření objektu <xref:System.IO.FileStream>. <xref:System.Security.Permissions.FileIOPermission> je vyžádané v době vytvoření a v případě úspěchu dojde k vrácení objektu souboru. Pokud je však tento odkaz na objekt předán do kódu bez oprávnění k souboru, bude objekt moci číst a zapisovat do tohoto konkrétního souboru.  
