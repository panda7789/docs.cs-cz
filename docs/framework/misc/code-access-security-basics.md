...
description: 'Naučte se základy zabezpečení přístupu ke kódu pro aplikace zaměřené na CLR: kód zajišťující bezpečnost typů, imperativní a deklarativní syntaxi, zabezpečené knihovny tříd a transparentní kód.'
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
