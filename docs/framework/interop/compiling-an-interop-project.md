...
- [Návod: Vložení informací o typu ze sestavení sady Microsoft Office (C# a Visual Basic)](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/ee317478(v=vs.100))
