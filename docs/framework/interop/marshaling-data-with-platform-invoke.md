...
|Nespravovaný typ v Wtypes.h|Nespravovaný typ jazyka C|Název spravovaného typu|Popis|
|--------------------------------|-------------------------------|------------------------|-----------------|
|**TYP VOID**|**void**|<xref:System.Void?displayProperty=nameWithType>|Použít pro funkci, která nevrací hodnotu.|
|**POPISOVAČ**|**Typ void \***|<xref:System.IntPtr?displayProperty=nameWithType> Nebo <xref:System.UIntPtr?displayProperty=nameWithType>|32 bitů na 32bitové operační systémy Windows, 64 bitů v operačních systémech Windows 64-bit.|
...
|**PLOVOUCÍ DESETINNOU ČÁRKOU**|**float**|<xref:System.Single?displayProperty=nameWithType>|32 bitů|
