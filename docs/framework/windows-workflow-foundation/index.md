...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 [Novinky ve Windows Workflow Foundation](../../../docs/framework/windows-workflow-foundation/whats-new.md)  
 Popisuje změny v několika vývoj vzorů z předchozích verzí.  
  
 [Novinky ve Windows Workflow Foundation v rozhraní .NET 4.5](../../../docs/framework/windows-workflow-foundation/whats-new-in-wf-in-dotnet.md)  
 ...
 [Ukázky Windows Workflow](../../../docs/framework/windows-workflow-foundation/samples/index.md)  
