...
## <a name="message"></a>Zpráva  
 Záznam sledování = WorkflowInstanceRecord, ID instance = %1, číslo záznamu = %2, čas události = %3, ID definice aktivity = %4, stav = %5, poznámky = %6, název profilu = %7, identita definice pracovního postupu = %8  
