...
|Hodnota [1-32]|Parametr SqlVariant|Hodnota [1-32] obsahuje hodnoty, které mohou být uloženy ve sloupci hodnotu SqlVariant. V rámci jednoho propagační akce nemůže obsahovat více než 32 SqlVariants.|  
