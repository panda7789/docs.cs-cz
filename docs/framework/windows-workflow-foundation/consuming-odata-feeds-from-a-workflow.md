...
### <a name="adding-a-service-reference-to-the-wcf-data-service"></a>Přidat odkaz na službu WCF Data Service  
 Ke generování klientských knihoven Northwind, můžete použít **přidat odkaz na službu** dialogové okno v [!INCLUDE[vs_current_long](../../../includes/vs-current-long-md.md)] přidáte odkaz na službu OData s názvem Northwind.  
 ...
 **Volání datové služby WCF...**  
**Alfreds Futterkiste, kontaktujte: Marie Marková**   
**ANA Trujillo Emparedados y helados kontakt: Ana Trujillo**   
**Taquería Antonio Moreno, kontaktujte: Antonio Moreno**   
**Kolem roh, kontaktujte: Thomas Hardy**   
**Berglunds snabbköp, kontaktujte: Christina Berglund**   
**...**    
...
**\<? xml verze = "1.0" encoding = "utf-8" samostatné = "yes"? >**   
**\<ContactName xmlns = "http://schemas.microsoft.com/ado/2007/08/dataservices" > Marie Marková\</ContactName >** v pracovním postupu, může být součástí kódu v tomto příkladu <xref:System.Activities.CodeActivity.Execute%2A> přepsání <xref:System.Activities.CodeActivity>– na základě vlastní aktivitu, ale stejné funkci lze dosáhnout také pomocí <xref:System.Activities.Expressions.InvokeMethod%601> aktivity. <xref:System.Activities.Expressions.InvokeMethod%601> Aktivity umožňuje autorům pracovní postup volání statické a instanci metody dané třídy a má také možnost vyvolat určenou metodu asynchronně. V následujícím příkladu <xref:System.Activities.Expressions.InvokeMethod%601> aktivity je nakonfigurován k volání <xref:System.Net.WebClient.DownloadString%2A> metodu <xref:System.Net.WebClient> třídy a vrátí seznam zákazníků.  
 ...
 **\<Aktualizovat > 2010-05-19T19:37:07Z\</ aktualizován >**  
 **\<propojit rel = "vlastní" title = "Orders" href = "Orders" / >**  
 **\<Položka >**  
 ...
 **\<název / >**  
 **\</ Vytvoření >**  
 **\<propojit rel = "edit" title = "Order" href="Orders(10643)" / >**  
 **\<propojit rel = "http://schemas.microsoft.com/ado/2007/08/dataservices/related/Customer"**  
 **typ = "application/atom + xml; zadejte = položka" title = "Zákazník" href = "Orders (10643) nebo zákazníka" / >**  
