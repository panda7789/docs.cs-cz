...
## <a name="in-this-section"></a>V tomto oddílu  
 [Zabudované aktivity](../../../../docs/framework/windows-workflow-foundation/samples/built-in-activities.md)  
 ...
 [Návrhář opětovného hostování](../../../../docs/framework/windows-workflow-foundation/samples/designer-rehosting.md)  
 ...
 [Trvalost](../../../../docs/framework/windows-workflow-foundation/samples/persistence.md)  
 Obsahuje ukázky, která ukazují zachování pracovní postupy pro trvanlivého média.  
  
 [Ukázky pravidla](../../../../docs/framework/windows-workflow-foundation/samples/rules-samples.md)  
