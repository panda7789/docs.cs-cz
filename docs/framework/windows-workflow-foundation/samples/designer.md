...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Ukazuje, jak se orientovat <xref:System.Activities.Presentation.Model.ModelItem> stromu pomocí deklarativní data vazby z Windows Presentation Foundation (WPF) stromovém zobrazení.  
