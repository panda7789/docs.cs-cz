...
Tato část obsahuje ukázky související s kompenzace v systému Windows Workflow Foundation (WF).  
...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Ukazuje, jak používat <xref:System.Activities.Statements.CompensableActivity> a její obslužnou rutinu kompenzace k definování vlastní kompenzace logiku.  
