...
## <a name="discussion"></a>Diskuse  
 ...
 Návrhář verzi ukázky ukazuje, jak vytvořit pracovní postup v návrháři. Jsou zahrnuty následující soubory:  
...
-   Sequence1.XAML: Pracovní postup vytvořený v Návrháři vyberte používá.  
 ...
 Programové verzi ukázky ukazuje, jak vytvořit pracovní postup v návrháři. Jsou zahrnuty následující soubory:  
