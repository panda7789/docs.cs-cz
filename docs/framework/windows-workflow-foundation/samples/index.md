...
Tyto ukázky poskytují pokyny o různé funkce Windows Workflow Foundation (WF).  
...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Poskytuje ukázky, která ukazují základní funkce Windows Workflow Foundation (WF).  
  
 [Scénář](../../../../docs/framework/windows-workflow-foundation/samples/scenario.md)  
 Obsahuje příklady scénářů Windows Workflow Foundation (WF).  
