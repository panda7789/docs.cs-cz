...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Obsahuje ukázky, která ukazují scénáře s využitím knihovna předdefinovaných aktivit.  
  
 [Služby](../../../../docs/framework/windows-workflow-foundation/samples/services.md)  
 Obsahuje ukázky, která ukazují scénáře použití služby pracovních postupů.  
