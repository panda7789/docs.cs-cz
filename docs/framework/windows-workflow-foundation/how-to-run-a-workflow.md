...
1.  Otevřete řešení od předchozího [postupy: vytvoření aktivity](../../../docs/framework/windows-workflow-foundation/how-to-create-an-activity.md) tématu pomocí [!INCLUDE[vs_current_long](../../../includes/vs-current-long-md.md)].  
