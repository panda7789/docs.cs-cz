...
## <a name="description"></a>Popis  
 Označuje, že že runtimeworkitem zahajuje provádění.  
  
## <a name="message"></a>Zpráva  
 Spouštění spuštění pracovní položky modulu runtime pro aktivitu %1, DisplayName: %2, identifikátor InstanceId: '%3'.  
