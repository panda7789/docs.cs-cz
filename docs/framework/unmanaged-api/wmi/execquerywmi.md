...
| `WBEM_FLAG_ENSURE_LOCATABLE` | 0x100 | Zajistí, aby všechny vrácené objekty měly v nich dostatek informací, takže systémové vlastnosti, jako jsou **__PATH**, **__RELPATH**a `null`__SERVER, nejsou. |
