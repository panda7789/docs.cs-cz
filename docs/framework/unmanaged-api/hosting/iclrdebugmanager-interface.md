...
|[SetConnectionTasks – metoda](iclrdebugmanager-setconnectiontasks-method.md)|Přidruží seznam instancí [ICLRTask](iclrtask-interface.md) s identifikátorem a popisným názvem.|  
