...
- [Zastaralá rozhraní a třídy typu Coclass rozhraní hostování CLR](../../../../docs/framework/unmanaged-api/hosting/deprecated-clr-hosting-interfaces-and-coclasses.md)
