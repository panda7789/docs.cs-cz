...
## <a name="remarks"></a>Poznámky  
 Obvykle není nutné volat metodu `Stop`, protože kód se zastaví, když se proces ukončí.  
  
> [!NOTE]
> Po volání `Stop`nelze modul CLR znovu inicializovat do stejného procesu.  
