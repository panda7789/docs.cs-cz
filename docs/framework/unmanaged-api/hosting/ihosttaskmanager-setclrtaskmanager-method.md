...
Poskytuje hostitele s ukazatelem rozhraní [ICLRTaskManager](iclrtaskmanager-interface.md) instance implementované modulem CLR (Common Language Runtime).  
...
## <a name="parameters"></a>Parametry  
 `pManager`  
 pro Ukazatel na instanci implementovanou modulem CLR ( `ICLRTaskManager` Common Language Runtime).  
  
## <a name="return-value"></a>Návratová hodnota  
  
|HRESULT|Popis|  
|-------------|-----------------|  
|S_OK|`SetCLRTaskManager`úspěšně vráceno.|  
...
## <a name="remarks"></a>Poznámky  
 Běhové volání `SetCLRTaskManager` pro poskytnutí hostitele s ukazatelem rozhraní na `ICLRTaskManager` instanci.  
