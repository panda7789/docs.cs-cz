...
---
# <a name="igchostcontrol-interface"></a>IGCHostControl – rozhraní
...
|Metoda|Popis|  
|------------|-----------------|  
|[RequestVirtualMemLimit – metoda](../../../../docs/framework/unmanaged-api/hosting/igchostcontrol-requestvirtualmemlimit-method.md)|Požadavky na hostiteli a změnit omezení virtuální paměti.|  
