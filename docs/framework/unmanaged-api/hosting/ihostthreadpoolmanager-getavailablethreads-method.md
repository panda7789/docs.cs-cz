...
|HRESULT|Popis|  
|-------------|-----------------|  
|S_OK|`GetAvailableThreads` byla úspěšně vrácena.|  
...
## <a name="remarks"></a>Poznámky  
 Pokud hostitel neposkytuje implementaci `GetAvailableThreads`, měla by vrátit hodnotu HRESULT typu E_NOTIMPL.  
