...
## <a name="remarks"></a>Poznámky  
 Hostitel může být vhodné výhradní kontrolu nad velikost fondu vláken dokončení vstupně-výstupních operací, z důvodů, například provádění, výkon a škálovatelnost. Proto není nutné implementovat hostitele `GetAvailableThreads`. V takovém případě hostitele by měl vrátit E_NOTIMPL z této metody.  
