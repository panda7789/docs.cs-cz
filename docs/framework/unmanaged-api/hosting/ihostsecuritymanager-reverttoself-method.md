...
Ukončí zosobnění identity aktuálního uživatele a vrátí původní token vlákna.  
...
|HRESULT|Popis|  
|-------------|-----------------|  
|S_OK|`RevertToSelf` byla úspěšně vrácena.|  
...
## <a name="remarks"></a>Poznámky  
 `RevertToSelf` je volána pro návrat k původnímu tokenu vlákna po předchozím volání metody [ImpersonateLoggedOnUser –](../../../../docs/framework/unmanaged-api/hosting/ihostsecuritymanager-impersonateloggedonuser-method.md) .  
