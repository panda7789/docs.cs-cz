...
Tato část popisuje rozhraní, která nespravovaných hostitelů můžete použít k integraci common language runtime (CLR) do svých aplikací.  
 ...
 [!INCLUDE[net_v40_long](../../../../includes/net-v40-long-md.md)] Nahrazují rozhraní hostování rozhraní .NET Framework 2.0.
...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Popisuje hostitelské rozhraní zavedený [!INCLUDE[net_v40_long](../../../../includes/net-v40-long-md.md)].  
