...
ms.locfileid: "33428668"
---
# <a name="eclrassemblyidentityflags-enumeration"></a>ECLRAssemblyIdentityFlags – výčet
...
|Člen|Popis|  
|------------|-----------------|  
|`CLR_ASSEMBLY_IDENTITY_FLAGS_DEFAULT`|Identita je kanonizovaného.|  
