...
#### <a name="parameters"></a>Parametry  
 ...
 [v] Název sestavení, ve kterém na požadovaný typ odvozený z <xref:System.AppDomainManager> je implementována.  
  
 `pwzAppDomainManagerType`  
 [v] Název typu implementované v `pwzAppDomainManagerAssembly` parametr, který implementuje možnosti <xref:System.AppDomainManager>.  
