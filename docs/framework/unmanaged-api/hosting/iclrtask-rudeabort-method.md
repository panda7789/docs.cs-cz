...
Instruuje modul CLR (Common Language Runtime), aby přerušil úlohu reprezentovanou aktuální instancí [rozhraní ICLRTask](iclrtask-interface.md) okamžitě a bezpodmínečně.  
...
|HRESULT|Popis|  
|-------------|-----------------|  
|S_OK|`RudeAbort`úspěšně vráceno.|  
...
## <a name="remarks"></a>Poznámky  
 Hostitel volá `RudeAbort` okamžité přerušení úlohy. Není zaručeno provést finalizační metody a rutiny zpracování výjimek.  
