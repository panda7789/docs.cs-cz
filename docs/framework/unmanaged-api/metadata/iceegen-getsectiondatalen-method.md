...
## <a name="parameters"></a>Parametry  
 `section`  
 pro Datová část, jejíž délka bude načtena.  
  
 `dataLen`  
 mimo Vrácená délka zadaného oddílu.  
  
## <a name="remarks"></a>Poznámky  
 Vyvolejte `GetSectionDataLen` pouze v případě, že máte zvláštní požadavky na oddíly, které nejsou zpracovány jinými metodami.  
