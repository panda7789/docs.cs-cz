...
Uloží všechna metadata v aktuálním oboru do zadané oblasti paměti.  
...
## <a name="parameters"></a>Parametry  
 `pbData`  
 mimo Adresa, na které začíná zapisovat metadata  
  
 `cbData`  
 pro Velikost přidělené paměti (v bajtech)  
