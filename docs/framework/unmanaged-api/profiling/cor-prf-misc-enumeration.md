...
|Člen|Popis|  
|------------|-----------------|  
|`PROFILER_PARENT_UNKNOWN`|Výchozí identifikátor používaný v [ICorProfilerInfo:: GetModuleInfo –](../../../../docs/framework/unmanaged-api/profiling/icorprofilerinfo-getmoduleinfo-method.md) pro modul, který ještě nebyl připojen k sestavení.|  
