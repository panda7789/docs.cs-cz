...
> [!NOTE]
> Místo této metody byste měli zavolat metodu [SetEventMask2 –](icorprofilerinfo5-seteventmask2-method.md) . I když je `SetEventMask` metoda stále podporovaná, [SetEventMask2 –](icorprofilerinfo5-seteventmask2-method.md) poskytuje další funkce.  
