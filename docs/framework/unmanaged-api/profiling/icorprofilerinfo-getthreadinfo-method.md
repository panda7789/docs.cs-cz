...
Získá aktuální identitu vlákna Win32 pro zadané vlákno.  
...
## <a name="parameters"></a>Parametry  
 `threadId`  
 pro ID vlákna, pro které se má získat aktuální ID Win32  
  
 `pdwWin32ThreadId`  
 mimo Ukazatel na aktuální ID vlákna Win32 daného vlákna.  
