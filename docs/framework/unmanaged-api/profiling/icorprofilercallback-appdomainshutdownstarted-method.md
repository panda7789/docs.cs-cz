...
## <a name="remarks"></a>Poznámky  
 Hodnota `appDomainId` není platná pro žádnou žádost o informace po `AppDomainShutdownStarted` návratu metody – jedná se o poslední možnost profileru k získání informací o této doméně aplikace.  
