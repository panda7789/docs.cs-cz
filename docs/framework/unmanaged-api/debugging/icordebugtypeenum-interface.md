...
|Metoda|Popis|  
|------------|-----------------|  
|[Next – metoda](../../../../docs/framework/unmanaged-api/debugging/icordebugtypeenum-next-method.md)|Získá zadaný počet `ICorDebugType` instancí z výčtu počínaje aktuální pozicí.|  
