...
## <a name="parameters"></a>Parametry  
 `cdim`  
 pro Počet rozměrů tohoto `ICorDebugArrayValue` objektu. Tato hodnota je také velikost `indicies` pole, protože jeho velikost je rovna počtu rozměrů `ICorDebugArrayValue` objektu.  
