...
- Vrátí `S_FALSE`se Metoda ICorDebugAssembly3. GetContainerAssembly –.  
...
- Vrátí `S_FALSE`se metoda ICorDebugModule3. EnumerateContainedAssemblies –.  
