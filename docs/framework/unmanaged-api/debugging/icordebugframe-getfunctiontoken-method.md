...
Získá token metadat pro funkci, která obsahuje kód spojený s tímto rámcem zásobníku.  
...
## <a name="parameters"></a>Parametry  
 `pToken`  
 mimo Ukazatel na `mdMethodDef` token, který odkazuje na metadata funkce.  
