...
## <a name="parameters"></a><span data-ttu-id="9514f-105">Parametry</span><span class="sxs-lookup"><span data-stu-id="9514f-105">Parameters</span></span>  
 `moduleBaseAddress`  
