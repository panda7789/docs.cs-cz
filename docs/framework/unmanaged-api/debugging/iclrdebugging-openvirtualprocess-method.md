...
## <a name="parameters"></a>Parametry  
 ...
 `pVersion`  
 [in, out] Verze modulu CLR. U vstupu může být tato hodnota `null`. Může také ukazovat na strukturu [CLR_DEBUGGING_VERSION](clr-debugging-version-structure.md) . v takovém případě musí být pole `wStructVersion` struktury inicializováno na hodnotu 0 (nula).  
