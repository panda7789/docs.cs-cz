...
Získá zaregistrovat, nastavte pro tento rámce zásobníku.  
...
#### <a name="parameters"></a>Parametry  
 `ppRegisters`  
 [out] Ukazatel na adresu [ICorDebugRegisterSet](../../../../docs/framework/unmanaged-api/debugging/icordebugregisterset-interface.md) objekt, který reprezentuje rejstříku nastavte pro tento rámce zásobníku.  
