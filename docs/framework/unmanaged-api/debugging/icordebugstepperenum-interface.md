...
|Metoda|Popis|  
|------------|-----------------|  
|[Next – metoda](../../../../docs/framework/unmanaged-api/debugging/icordebugstepperenum-next-method.md)|Získá zadaný počet `ICorDebugStepper` instancí z výčtu od aktuální pozice.|  
