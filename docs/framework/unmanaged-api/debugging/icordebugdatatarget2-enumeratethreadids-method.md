...
## <a name="parameters"></a>Parametry  
 ...
 pcThreadIds  
 mimo Ukazatel na `ULONG32` , který označuje skutečný počet ID vláken zapsaných do `pThreadIds` pole.  
 ...
 **Platformy:** Viz [požadavky na systém](../../get-started/system-requirements.md). **Hlavička:** CorDebug. idl, CorDebug. h  
