...
## <a name="remarks"></a>Poznámky  
 Do metody [DecodeEvent –](../../../../docs/framework/unmanaged-api/debugging/icordebugprocess6-decodeevent-method.md) se předává člen výčtu `CorDebugRecordFormat`, který určuje formát pole bajtů ve svém argumentu `pRecord`.  
