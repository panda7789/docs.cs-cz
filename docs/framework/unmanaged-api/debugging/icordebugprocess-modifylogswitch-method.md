...
## <a name="remarks"></a>Poznámky  
 Tato metoda je platná až po výskytu zpětného volání [ICorDebugManagedCallback:: CreateProcess](../../../../docs/framework/unmanaged-api/debugging/icordebugmanagedcallback-createprocess-method.md) .  
