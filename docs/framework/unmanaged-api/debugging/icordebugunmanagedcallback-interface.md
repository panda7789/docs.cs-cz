...
|Metoda|Popis|  
|------------|-----------------|  
|[DebugEvent – metoda](../../../../docs/framework/unmanaged-api/debugging/icordebugunmanagedcallback-debugevent-method.md)|Oznamuje ladicímu programu, že byla vyvolána nativní událost.|  
