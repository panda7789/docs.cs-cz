...
|.NET Framework 4.5. x Už je součástí tohoto operačního systému, ale je momentálně vypnutý (jenom[!INCLUDE[winserver8](../../../includes/winserver8-md.md)]).|Viz [zapnout nebo vypnout funkce systému Windows](https://go.microsoft.com/fwlink/p/?LinkId=248438) na webu Windows.|  
