...
|Rozhraní .NET framework 4.5 *.x*/4.6 *.x*/4.7 *.x*  /4.8 nebyl nainstalován z těchto důvodů je poškozeno úložiště součástí.|Zobrazit [chyby opravit aktualizací Windows pomocí nástroje DISM nebo připravenosti aktualizace systému](https://support.microsoft.com/kb/947821) Další informace.|  
