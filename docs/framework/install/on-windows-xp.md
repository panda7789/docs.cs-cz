...
[.NET Framework 4.0.3](https://www.microsoft.com/download/details.aspx?id=29053) je nejnovější podporovaná verze .NET Framework v systémech Windows XP a windows Server 2003. .NET Framework 4.0.3 vyžaduje, aby se nejdřív nainstaloval [.NET Framework 4](https://dotnet.microsoft.com/download/dotnet-framework/net40) . Společnost Microsoft již nepodporuje obě tyto verze .NET Framework.

## <a name="net-framework-4"></a>.NET Framework 4

Můžete nainstalovat [.NET Framework 4](https://dotnet.microsoft.com/download/dotnet-framework/net40) v systému Windows XP. Společnost Microsoft je již nepodporuje.

## <a name="net-framework-35"></a>.NET Framework 3.5

Můžete nainstalovat [.NET Framework 3,5](https://dotnet.microsoft.com/download/dotnet-framework/net35-sp1) v systému Windows XP.
