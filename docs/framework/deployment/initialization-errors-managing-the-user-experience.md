...
description: Řízení uživatelského prostředí, když dojde k chybě inicializace rozhraní .NET, například v případě, že systém aktivace nemůže najít správnou verzi CLR, která se má načíst.
ms.date: 03/30/2017
helpviewer_keywords:
...
Pokud systém aktivace CLR nemůže načíst správnou verzi modulu runtime, který je vyžadován aplikací, zobrazí uživatelům chybovou zprávu s oznámením, že jejich počítač není správně nakonfigurován pro spuštění aplikace, a poskytuje jim příležitost k nápravě situace. V této situaci se obvykle zobrazí následující chybová zpráva. Uživatel může zvolit **Ano** a přejít na web společnosti Microsoft, kde si může stáhnout správnou verzi .NET Framework pro aplikaci.
