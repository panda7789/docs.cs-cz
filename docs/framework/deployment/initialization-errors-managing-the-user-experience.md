...
## <a name="ui-for-initialization-errors"></a>Uživatelské rozhraní pro chyby inicializace  
 ...
 ![Chyba inicializace rozhraní .NET framework dialogovému oknu](../../../docs/framework/deployment/media/initerrordialog.png "InitErrorDialog")  
Typické chybové zprávy pro chyby inicializace  
...
## <a name="includewin8includeswin8-mdmd-behavior-and-ui"></a>[!INCLUDE[win8](../../../includes/win8-md.md)] Chování a uživatelského rozhraní  
 ...
 ![Dialogové okno pro instalaci verze 3.5 v systému Windows 8](../../../docs/framework/deployment/media/installdialog.png "installdialog")  
Výzva k instalaci rozhraní .NET Framework 3.5 na vyžádání  
