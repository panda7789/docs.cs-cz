...
### <a name="xkey-as-an-object-element"></a>x: Key jako Element objektu  
 XAML 2009 může podporovat `x:Key` jako objekt (prvek vlastnosti, která má hodnotu elementu objektu), ale pouze podporované XAML 2006 `x:Key` jako atribut. Viz část "XAML 2009" [x: Key – direktiva](../../../docs/framework/xaml-services/x-key-directive.md).  
