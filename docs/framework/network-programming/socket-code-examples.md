...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Ukazuje, jak implementovat synchronního <xref:System.Net.Sockets.Socket> klienta, který se připojuje k serveru a zobrazí data vrácená serverem.  
 ...
 Ukazuje, jak implementovat asynchronní <xref:System.Net.Sockets.Socket> klienta, který se připojuje k serveru a zobrazí data vrácená serverem.  
