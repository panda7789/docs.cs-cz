...
## <a name="in-this-section"></a>V tomto oddílu  
 [Stáhněte si ukázky technologie indikátor průběhu](https://msdn.microsoft.com/library/t8w6294a(v=vs.85).aspx)  
 Ukazuje, jak zobrazit průběh stahování souborů.  
  
 [Ukázka technologie klienta FTP](https://msdn.microsoft.com/library/b7810t5c(v=vs.85).aspx)  
 Ukazuje, jak nahrávat a stahovat soubory ze serveru FTP.  
  
 [Ukázka technologie HttpListener](https://msdn.microsoft.com/library/y7cbb2y2(v=vs.85).aspx)  
 ...
 [Ukázka technologie poštovní modul](https://msdn.microsoft.com/library/whw7xbk2(v=vs.85).aspx)  
 Ukazuje, jak odesílat zprávy e-mailu z klientské aplikace.  
  
 [Ukázka technologie NetStat nástroj](https://msdn.microsoft.com/library/ks32hs88(v=vs.85).aspx)  
 Ukazuje nástroj NCLNetStat síťové informace.  
  
 [Ukázka technologie informace o síti](https://msdn.microsoft.com/library/2xatedhd(v=vs.85).aspx)  
 Ukazuje, jak monitorovat a zobrazit informace o síti.  
  
 [Ukázka technologie ping klienta](https://msdn.microsoft.com/library/5253acs7(v=vs.85).aspx)  
 Ukazuje klientské aplikace, které může příkaz ping na vzdáleného hostitele.  
  
 [Ukázka technologie WebClient](https://msdn.microsoft.com/library/fxk992zc(v=vs.85).aspx)  
 Ukazuje, jak k provádění běžných operací, jako je nahrávání a stahování souborů nebo data.  
  
 [Ukázka zabezpečení datových proudů](https://msdn.microsoft.com/library/ms180980(v=vs.85).aspx)  
 ...
 [Ukázka technologie Průzkumníka serveru FTP](https://msdn.microsoft.com/library/ms233623(v=vs.85).aspx)  
