...
|**Verze Windows serveru**|➕ 2012 R2<br />➕ 2012<br />➕ 2008 R2 SP1<br />➕ 2008 SP2|
|**Určení nainstalované verze rozhraní .NET**|Použít `Release` DWORD 379893<br /><br />(Viz [pokyny](how-to-determine-which-versions-are-installed.md))|
...
|**Určení nainstalované verze rozhraní .NET**|Použít `Release` DWORD 378389<br /><br />(Viz [pokyny](how-to-determine-which-versions-are-installed.md))|
...
|**Verze systému Windows**|Není k dispozici|
|**Verze Windows serveru**|✔️ 2008 R2 SP1<br />✔️ 2008 SP2<br />✔️ 200|
|**Určení nainstalované verze rozhraní .NET**|Zobrazit [pokyny](how-to-determine-which-versions-are-installed.md)|
...
|**Verze systému Windows**|Není k dispozici|
|**Verze Windows serveru**|Není k dispozici|
|**Určení nainstalované verze rozhraní .NET**|Zobrazit [pokyny](how-to-determine-which-versions-are-installed.md)|
...
- 
| [kompatibility verzí](version-compatibility.md) [.NET Framework oficiální zásady podpory](https://dotnet.microsoft.com/platform/support/policy/dotnet-framework)
