...
|----------------------------|-----------------|--------------|---------------------------------------|----------------------------------------------------|-----------------------------------------------------------|-----------------------------------------| 
|4.7.2<br/><br/>[Nové funkce](../whats-new/index.md#whats-new-in-the-net-framework-472)<br/><br/>[Nového v usnadnění](../whats-new/whats-new-in-accessibility.md#whats-new-in-accessibility-in-the-net-framework-472)|4| |✓ 10. dubna 2018 Update (verze 1803) <br/><br/> + 10 fall Creators Update (verze 1709) <br/> <br/> + 10 Creators Update (verze 1703) <br/> + 10 anniversary Update (verze 1607) <br/> + 8.1 <br/> +7 | + 2016 <br/> + 2012 R2 <br/> + 2012 <br/> + 2008 R2 SP1 |Použití `Release` DWORD:<br/><br/> -461808 (aktualizace systému Windows 10. dubna 2018) <br/> -461814 (všechny ostatní operační systém verze) <br/><br/> (viz [pokyny](../../../docs/framework/migration-guide/how-to-determine-which-versions-are-installed.md))|
|4.7.1<br/><br/>[Nové funkce](../whats-new/index.md#whats-new-in-the-net-framework-471)<br/><br/>[Nového v usnadnění](../whats-new/whats-new-in-accessibility.md#whats-new-in-accessibility-in-the-net-framework-471)|4| | ✓ 10 Fall Creators Update (verze 1709) <br/> <br/> + 10 Creators Update (verze 1703) <br/> + 10 anniversary Update (verze 1607) <br/> + 8.1 <br/> +7| + 2016 <br/> + 2012 R2 <br/> + 2012 <br/> + 2008 R2 SP1 |Použití `Release` DWORD:<br/><br/> -461308 (Windows 10 Creators Update) <br/> -461310 (všechny ostatní operační systém verze) <br/><br/> (viz [pokyny](../../../docs/framework/migration-guide/how-to-determine-which-versions-are-installed.md))| 
...
|4<br/><br/>[Nové funkce](http://msdn.microsoft.com/library/ms171868\(v=vs.100\).aspx)|4|2010|+ 7<br />+ Vista|+ 2008 R2 SP1<br />+ 2008 SP2<br />+ 2003|Zobrazit [pokyny](../../../docs/framework/migration-guide/how-to-determine-which-versions-are-installed.md)|  
