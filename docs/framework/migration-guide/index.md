...
## <a name="migration-resources"></a>Migrace prostředků  
 Před migrací aplikace z dřívějších verzí rozhraní .NET Framework verze 4.5, 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7 nebo 4.7.1, projděte si následující dokumenty:  
