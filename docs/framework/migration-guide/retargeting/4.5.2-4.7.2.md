---
title: Změna cílení na migraci z .NET Framework 4.5.2 na 4.7.2
description: Vyhledejte informace o problémech s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci při migraci z .NET Framework 4.5.2 na 4.7.2.
ms.date: 07/10/2019
...
ms.locfileid: "86443751"
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-472"></a><span data-ttu-id="a4aea-103">Změna cílení na migraci z .NET Framework 4.5.2 na 4.7.2</span><span class="sxs-lookup"><span data-stu-id="a4aea-103">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.7.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="a4aea-104">Pokud migrujete z .NET Framework 4.5.2 na 4.7.2, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="a4aea-104">If you are migrating from the .NET Framework 4.5.2 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="a4aea-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="a4aea-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="a4aea-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="a4aea-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="a4aea-107">Jádro</span><span class="sxs-lookup"><span data-stu-id="a4aea-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="a4aea-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="a4aea-108">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="a4aea-109">JIT</span><span class="sxs-lookup"><span data-stu-id="a4aea-109">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="a4aea-110">Sítě</span><span class="sxs-lookup"><span data-stu-id="a4aea-110">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="a4aea-111">Zabezpečení</span><span class="sxs-lookup"><span data-stu-id="a4aea-111">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="a4aea-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="a4aea-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="a4aea-113">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="a4aea-113">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="a4aea-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="a4aea-114">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="a4aea-115">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="a4aea-115">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="a4aea-116">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="a4aea-116">XML, XSLT</span></span>
