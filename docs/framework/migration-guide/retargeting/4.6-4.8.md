...
---
# <a name="retargeting-changes-for-migration-from-net-framework-46-to-48"></a>Odlišnosti ve změnách cílení pro migraci z rozhraní .NET Framework 4.6 pro 4.8

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

Pokud migrujete z rozhraní .NET Framework 4.6 4.8, projděte si následující témata pro problémy s kompatibilitou aplikace, které může mít vliv na vaši aplikaci:
