...
---
# <a name="retargeting-changes-for-migration-from-net-framework-471-to-48"></a>Odlišnosti ve změnách cílení pro migraci z rozhraní .NET Framework 4.7.1 k 4.8

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

Pokud provádíte migraci z rozhraní .NET Framework 4.7.1 k 4.8, projděte si následující témata pro problémy s kompatibilitou aplikace, které může mít vliv na vaši aplikaci:
