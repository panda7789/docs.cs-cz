...
---
# <a name="retargeting-changes-for-migration-from-net-framework-45-to-451"></a><span data-ttu-id="50f7f-103">Změna cíle pro migraci z .NET Framework 4,5 na 4.5.1</span><span class="sxs-lookup"><span data-stu-id="50f7f-103">Retargeting Changes for Migration from .NET Framework 4.5 to 4.5.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="50f7f-104">Pokud migrujete z .NET Framework 4,5 na 4.5.1, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="50f7f-104">If you are migrating from the .NET Framework 4.5 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="50f7f-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="50f7f-105">ADO.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="50f7f-106">Jádro</span><span class="sxs-lookup"><span data-stu-id="50f7f-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="50f7f-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="50f7f-107">Entity Framework</span></span>
...
## <a name="msbuild"></a><span data-ttu-id="50f7f-108">MSBuild</span><span class="sxs-lookup"><span data-stu-id="50f7f-108">MSBuild</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="50f7f-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="50f7f-109">Windows Presentation Foundation (WPF)</span></span>
