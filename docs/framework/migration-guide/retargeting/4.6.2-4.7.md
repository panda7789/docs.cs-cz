...
---
# <a name="retargeting-changes-for-migration-from-net-framework-462-to-47"></a>Retargeting Změny pro migraci z rozhraní .NET Framework 4.6.2 na 4.7

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

Pokud migrujete z rozhraní .NET Framework 4.6.2 do 4.7, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které mohou mít vliv na vaši aplikaci:
