...
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-451"></a>Odlišnosti ve změnách cílení pro migraci z rozhraní .NET Framework 4.0 na 4.5.1

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

Pokud provádíte migraci z rozhraní .NET Framework 4.0 verze 4.5.1, projděte si následující témata pro problémy s kompatibilitou aplikace, které může mít vliv na vaši aplikaci:
