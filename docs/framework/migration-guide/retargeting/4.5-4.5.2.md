...
---
# <a name="retargeting-changes-for-migration-from-net-framework-45-to-452"></a>Odlišnosti ve změnách cílení pro migraci z rozhraní .NET Framework 4.5 na 4.5.2

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

Pokud provádíte migraci z rozhraní .NET Framework 4.5 na 4.5.2, projděte si v následujících tématech problémům s kompatibilitou aplikací, které může mít vliv na vaši aplikaci:
