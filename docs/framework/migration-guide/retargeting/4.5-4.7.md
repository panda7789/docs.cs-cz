---
title: Mění se cílení změn migrace z .NET Framework 4,5 na 4,7.
description: Vyhledejte informace o problémech s kompatibilitou aplikací, které by mohly ovlivnit vaši aplikaci při migraci z .NET Framework 4,5 na 4,7.
ms.date: 07/10/2019
...
ms.locfileid: "86444336"
---
# <a name="retargeting-changes-for-migration-from-net-framework-45-to-47"></a><span data-ttu-id="3b55d-103">Mění se cílení změn migrace z .NET Framework 4,5 na 4,7.</span><span class="sxs-lookup"><span data-stu-id="3b55d-103">Retargeting Changes for Migration from .NET Framework 4.5 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="3b55d-104">Pokud migrujete z .NET Framework 4,5 na 4,7, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="3b55d-104">If you are migrating from the .NET Framework 4.5 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="3b55d-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="3b55d-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="3b55d-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="3b55d-106">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="3b55d-107">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="3b55d-107">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="3b55d-108">Jádro</span><span class="sxs-lookup"><span data-stu-id="3b55d-108">Core</span></span>
...
## <a name="jit"></a><span data-ttu-id="3b55d-109">JIT</span><span class="sxs-lookup"><span data-stu-id="3b55d-109">JIT</span></span>
...
## <a name="msbuild"></a><span data-ttu-id="3b55d-110">MSBuild</span><span class="sxs-lookup"><span data-stu-id="3b55d-110">MSBuild</span></span>
...
## <a name="networking"></a><span data-ttu-id="3b55d-111">Sítě</span><span class="sxs-lookup"><span data-stu-id="3b55d-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="3b55d-112">Zabezpečení</span><span class="sxs-lookup"><span data-stu-id="3b55d-112">Security</span></span>
...
## <a name="visual-basic-net"></a><span data-ttu-id="3b55d-113">Visual Basic .NET</span><span class="sxs-lookup"><span data-stu-id="3b55d-113">Visual Basic .NET</span></span>

[!INCLUDE[VB.NET no longer supports partial namespace qualification for System.Windows APIs](~/includes/migration-guide/retargeting/vb/vbnet-no-longer-supports-partial-namespace-qualification-for-systemwindows.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="3b55d-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="3b55d-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="3b55d-115">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="3b55d-115">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="3b55d-116">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="3b55d-116">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="3b55d-117">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="3b55d-117">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="3b55d-118">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="3b55d-118">XML, XSLT</span></span>
