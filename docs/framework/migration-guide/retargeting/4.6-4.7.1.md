...
---
# <a name="retargeting-changes-for-migration-from-net-framework-46-to-471"></a>Retargeting Změny pro migraci z rozhraní .NET Framework 4.6 na 4.7.1

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

Pokud migrujete z rozhraní .NET Framework 4.6 na 4.7.1, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které mohou mít vliv na vaši aplikaci:
