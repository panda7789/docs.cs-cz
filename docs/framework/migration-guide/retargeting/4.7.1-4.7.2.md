---
title: Změna cílení na migraci z .NET Framework 4.7.1 na 4.7.2
description: Vyhledejte informace o problémech s kompatibilitou aplikací, které by mohly ovlivnit vaši aplikaci při migraci z .NET Framework 4.7.1 na 4.7.2.
ms.date: 07/10/2019
...
ms.locfileid: "86444063"
---
# <a name="retargeting-changes-for-migration-from-net-framework-471-to-472"></a><span data-ttu-id="1c5fc-103">Změna cílení na migraci z .NET Framework 4.7.1 na 4.7.2</span><span class="sxs-lookup"><span data-stu-id="1c5fc-103">Retargeting Changes for Migration from .NET Framework 4.7.1 to 4.7.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="1c5fc-104">Pokud migrujete z .NET Framework 4.7.1 na 4.7.2, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="1c5fc-104">If you are migrating from the .NET Framework 4.7.1 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="1c5fc-105">Jádro</span><span class="sxs-lookup"><span data-stu-id="1c5fc-105">Core</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="1c5fc-106">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="1c5fc-106">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="1c5fc-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="1c5fc-107">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="1c5fc-108">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="1c5fc-108">Windows Workflow Foundation (WF)</span></span>
