...
---
# <a name="retargeting-changes-for-migration-from-net-framework-46-to-47"></a>Odlišnosti ve změnách cílení pro migraci z rozhraní .NET Framework 4.6 k 4.7

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

Pokud migrujete z rozhraní .NET Framework 4.6 do 4.7, projděte si v následujících tématech problémům s kompatibilitou aplikací, které může mít vliv na vaši aplikaci:
