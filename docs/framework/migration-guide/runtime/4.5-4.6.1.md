...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-461"></a><span data-ttu-id="811c1-102">Změny v modulu runtime pro migraci z rozhraní .NET Framework 4.5 na 4.6.1</span><span class="sxs-lookup"><span data-stu-id="811c1-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.6.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="811c1-103">Pokud provádíte migraci z rozhraní .NET Framework 4.5 na 4.6.1, projděte si v následujících tématech problémům s kompatibilitou aplikací, které může mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="811c1-103">If you are migrating from the .NET Framework 4.5 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="811c1-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="811c1-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="811c1-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="811c1-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="811c1-106">Jádro</span><span class="sxs-lookup"><span data-stu-id="811c1-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="811c1-107">Data</span><span class="sxs-lookup"><span data-stu-id="811c1-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="811c1-108">Ladicí program</span><span class="sxs-lookup"><span data-stu-id="811c1-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="811c1-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="811c1-109">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="811c1-110">Síťové služby</span><span class="sxs-lookup"><span data-stu-id="811c1-110">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="811c1-111">Serializace</span><span class="sxs-lookup"><span data-stu-id="811c1-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="811c1-112">Instalace a nasazení</span><span class="sxs-lookup"><span data-stu-id="811c1-112">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="811c1-113">Nástroje</span><span class="sxs-lookup"><span data-stu-id="811c1-113">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="811c1-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="811c1-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="811c1-115">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="811c1-115">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="811c1-116">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="811c1-116">Windows Presentation Foundation (WPF)</span></span>
