...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-47"></a>Změny v modulu runtime pro migraci z rozhraní .NET Framework 4.5.1 na 4.7

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Pokud provádíte migraci z rozhraní .NET Framework 4.5.1 na 4.7, naleznete v následujících tématech problémy s kompatibilitou aplikací, které může mít vliv na vaši aplikaci:
