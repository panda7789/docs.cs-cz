...
ms.locfileid: "58760583"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-472"></a><span data-ttu-id="cdfba-102">Změny v modulu runtime pro migraci z rozhraní .NET Framework 4.0 na 4.7.2</span><span class="sxs-lookup"><span data-stu-id="cdfba-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.7.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="cdfba-103">Pokud migrujete z rozhraní .NET Framework 4.0 4.7.2, projděte si následující témata pro problémy s kompatibilitou aplikace, které může mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="cdfba-103">If you are migrating from the .NET Framework 4.0 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="cdfba-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="cdfba-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="cdfba-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="cdfba-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="cdfba-106">Jádro</span><span class="sxs-lookup"><span data-stu-id="cdfba-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="cdfba-107">Data</span><span class="sxs-lookup"><span data-stu-id="cdfba-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="cdfba-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="cdfba-108">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="cdfba-109">Globalizace</span><span class="sxs-lookup"><span data-stu-id="cdfba-109">Globalization</span></span>
...
## <a name="linq"></a><span data-ttu-id="cdfba-110">LINQ</span><span class="sxs-lookup"><span data-stu-id="cdfba-110">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="cdfba-111">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="cdfba-111">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="cdfba-112">Síťové služby</span><span class="sxs-lookup"><span data-stu-id="cdfba-112">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="cdfba-113">Tisk</span><span class="sxs-lookup"><span data-stu-id="cdfba-113">Printing</span></span>
...
## <a name="runtime"></a><span data-ttu-id="cdfba-114">Modul runtime</span><span class="sxs-lookup"><span data-stu-id="cdfba-114">Runtime</span></span>

[!INCLUDE[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="cdfba-115">Zabezpečení</span><span class="sxs-lookup"><span data-stu-id="cdfba-115">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="cdfba-116">Serializace</span><span class="sxs-lookup"><span data-stu-id="cdfba-116">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="cdfba-117">Instalace a nasazení</span><span class="sxs-lookup"><span data-stu-id="cdfba-117">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="cdfba-118">Nástroje</span><span class="sxs-lookup"><span data-stu-id="cdfba-118">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="cdfba-119">Webové aplikace</span><span class="sxs-lookup"><span data-stu-id="cdfba-119">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="cdfba-120">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="cdfba-120">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="cdfba-121">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="cdfba-121">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="cdfba-122">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="cdfba-122">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="cdfba-123">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="cdfba-123">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="cdfba-124">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="cdfba-124">XML, XSLT</span></span>
