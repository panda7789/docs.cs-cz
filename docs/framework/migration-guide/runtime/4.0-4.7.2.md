---
title: Změny v modulu runtime pro migraci z .NET Framework 4,0 do 4.7.2
description: Vyhledejte informace o problémech s kompatibilitou aplikací z úprav modulu runtime, které by mohly mít vliv na vaši aplikaci při migraci z .NET Framework 4,0 na 4.7.2.
ms.date: 07/10/2019
...
ms.locfileid: "86443660"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-472"></a><span data-ttu-id="c1397-103">Změny v modulu runtime pro migraci z .NET Framework 4,0 do 4.7.2</span><span class="sxs-lookup"><span data-stu-id="c1397-103">Runtime Changes for Migration from .NET Framework 4.0 to 4.7.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="c1397-104">Pokud migrujete z .NET Framework 4,0 na 4.7.2, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="c1397-104">If you are migrating from the .NET Framework 4.0 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="c1397-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="c1397-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="c1397-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="c1397-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="c1397-107">Jádro</span><span class="sxs-lookup"><span data-stu-id="c1397-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="c1397-108">Data</span><span class="sxs-lookup"><span data-stu-id="c1397-108">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="c1397-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="c1397-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="c1397-110">Globalizace</span><span class="sxs-lookup"><span data-stu-id="c1397-110">Globalization</span></span>
...
## <a name="linq"></a><span data-ttu-id="c1397-111">LINQ</span><span class="sxs-lookup"><span data-stu-id="c1397-111">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="c1397-112">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="c1397-112">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="c1397-113">Sítě</span><span class="sxs-lookup"><span data-stu-id="c1397-113">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="c1397-114">Tisk</span><span class="sxs-lookup"><span data-stu-id="c1397-114">Printing</span></span>
...
## <a name="runtime"></a><span data-ttu-id="c1397-115">Modul runtime</span><span class="sxs-lookup"><span data-stu-id="c1397-115">Runtime</span></span>

[!INCLUDE[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="c1397-116">Zabezpečení</span><span class="sxs-lookup"><span data-stu-id="c1397-116">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="c1397-117">Serializace</span><span class="sxs-lookup"><span data-stu-id="c1397-117">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="c1397-118">Nastavení a nasazení</span><span class="sxs-lookup"><span data-stu-id="c1397-118">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="c1397-119">Nástroje</span><span class="sxs-lookup"><span data-stu-id="c1397-119">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="c1397-120">Webové aplikace</span><span class="sxs-lookup"><span data-stu-id="c1397-120">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="c1397-121">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="c1397-121">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="c1397-122">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="c1397-122">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="c1397-123">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="c1397-123">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="c1397-124">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="c1397-124">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="c1397-125">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="c1397-125">XML, XSLT</span></span>
