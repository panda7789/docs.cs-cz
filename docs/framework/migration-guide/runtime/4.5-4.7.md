...
ms.locfileid: "33391547"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-47"></a><span data-ttu-id="0a3bb-102">Změny v modulu runtime pro migraci z rozhraní .NET Framework 4.5 na 4.7</span><span class="sxs-lookup"><span data-stu-id="0a3bb-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.7</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="0a3bb-103">Pokud provádíte migraci z rozhraní .NET Framework 4.5 na 4.7, projděte si v následujících tématech problémům s kompatibilitou aplikací, které může mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="0a3bb-103">If you are migrating from the .NET Framework 4.5 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>
...
## <a name="core"></a><span data-ttu-id="0a3bb-106">Jádro</span><span class="sxs-lookup"><span data-stu-id="0a3bb-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="0a3bb-107">Data</span><span class="sxs-lookup"><span data-stu-id="0a3bb-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="0a3bb-108">Ladicí program</span><span class="sxs-lookup"><span data-stu-id="0a3bb-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="0a3bb-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="0a3bb-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="0a3bb-110">Globalizace</span><span class="sxs-lookup"><span data-stu-id="0a3bb-110">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="0a3bb-111">JIT</span><span class="sxs-lookup"><span data-stu-id="0a3bb-111">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="0a3bb-112">Síťové služby</span><span class="sxs-lookup"><span data-stu-id="0a3bb-112">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="0a3bb-113">Zabezpečení</span><span class="sxs-lookup"><span data-stu-id="0a3bb-113">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="0a3bb-114">Serializace</span><span class="sxs-lookup"><span data-stu-id="0a3bb-114">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="0a3bb-115">Instalace a nasazení</span><span class="sxs-lookup"><span data-stu-id="0a3bb-115">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="0a3bb-116">Nástroje</span><span class="sxs-lookup"><span data-stu-id="0a3bb-116">Tools</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="0a3bb-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="0a3bb-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="0a3bb-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="0a3bb-119">Windows Workflow Foundation (WF)</span></span>
