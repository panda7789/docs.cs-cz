...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-47"></a>Změny v modulu runtime pro migraci z .NET Framework 4,5 do 4,7

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Pokud migrujete z .NET Framework 4,5 na 4,7, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:
