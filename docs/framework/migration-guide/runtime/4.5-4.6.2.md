---
title: Změny v modulu runtime pro migraci z .NET Framework 4,5 do 4.6.2
description: Vyhledejte informace o problémech s kompatibilitou aplikací z úprav modulu runtime, které by mohly mít vliv na vaši aplikaci při migraci z .NET Framework 4,5 na 4.6.2.
ms.date: 07/10/2019
...
ms.locfileid: "86443192"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-462"></a><span data-ttu-id="679ff-103">Změny v modulu runtime pro migraci z .NET Framework 4,5 do 4.6.2</span><span class="sxs-lookup"><span data-stu-id="679ff-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="679ff-104">Pokud migrujete z .NET Framework 4,5 na 4.6.2, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="679ff-104">If you are migrating from the .NET Framework 4.5 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="679ff-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="679ff-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="679ff-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="679ff-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="679ff-107">Jádro</span><span class="sxs-lookup"><span data-stu-id="679ff-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="679ff-108">Data</span><span class="sxs-lookup"><span data-stu-id="679ff-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="679ff-109">Ladicí program</span><span class="sxs-lookup"><span data-stu-id="679ff-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="679ff-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="679ff-110">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="679ff-111">Globalizace</span><span class="sxs-lookup"><span data-stu-id="679ff-111">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="679ff-112">Sítě</span><span class="sxs-lookup"><span data-stu-id="679ff-112">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="679ff-113">Zabezpečení</span><span class="sxs-lookup"><span data-stu-id="679ff-113">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="679ff-114">Serializace</span><span class="sxs-lookup"><span data-stu-id="679ff-114">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="679ff-115">Nastavení a nasazení</span><span class="sxs-lookup"><span data-stu-id="679ff-115">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="679ff-116">Nástroje</span><span class="sxs-lookup"><span data-stu-id="679ff-116">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="679ff-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="679ff-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="679ff-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="679ff-118">Windows Presentation Foundation (WPF)</span></span>
