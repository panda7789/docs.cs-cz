...
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-48"></a>Změny v modulu runtime pro migraci z .NET Framework 4,6 do 4,8

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Pokud migrujete z .NET Framework 4,6 na 4,8, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:
