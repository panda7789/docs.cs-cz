...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-471"></a>Změny v modulu runtime pro migraci z .NET Framework 4.5.2 do 4.7.1

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Pokud migrujete z .NET Framework 4.5.2 na 4.7.1, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:
