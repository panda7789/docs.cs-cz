...
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-47"></a><span data-ttu-id="a7576-102">Změny v modulu runtime pro migraci z rozhraní .NET Framework 4.6 k 4.7</span><span class="sxs-lookup"><span data-stu-id="a7576-102">Runtime Changes for Migration from .NET Framework 4.6 to 4.7</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="a7576-103">Pokud migrujete z rozhraní .NET Framework 4.6 do 4.7, projděte si v následujících tématech problémům s kompatibilitou aplikací, které může mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="a7576-103">If you are migrating from the .NET Framework 4.6 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="a7576-104">Jádro</span><span class="sxs-lookup"><span data-stu-id="a7576-104">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="a7576-105">Data</span><span class="sxs-lookup"><span data-stu-id="a7576-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="a7576-106">Globalizace</span><span class="sxs-lookup"><span data-stu-id="a7576-106">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="a7576-107">JIT</span><span class="sxs-lookup"><span data-stu-id="a7576-107">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="a7576-108">Zabezpečení</span><span class="sxs-lookup"><span data-stu-id="a7576-108">Security</span></span>
...
## <a name="tools"></a><span data-ttu-id="a7576-109">Nástroje</span><span class="sxs-lookup"><span data-stu-id="a7576-109">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="a7576-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="a7576-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="a7576-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="a7576-111">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="a7576-112">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="a7576-112">Windows Workflow Foundation (WF)</span></span>
