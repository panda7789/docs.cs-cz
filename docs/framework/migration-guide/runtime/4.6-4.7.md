---
title: Změny v modulu runtime pro migraci z .NET Framework 4,6 do 4,7
description: Vyhledejte informace o problémech s kompatibilitou aplikací z úprav modulu runtime, které by mohly ovlivnit vaši aplikaci při migraci z .NET Framework 4,6 na 4,7.
ms.date: 07/10/2019
...
ms.locfileid: "86444024"
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-47"></a><span data-ttu-id="aac7a-103">Změny v modulu runtime pro migraci z .NET Framework 4,6 do 4,7</span><span class="sxs-lookup"><span data-stu-id="aac7a-103">Runtime Changes for Migration from .NET Framework 4.6 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="aac7a-104">Pokud migrujete z .NET Framework 4,6 na 4,7, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="aac7a-104">If you are migrating from the .NET Framework 4.6 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="aac7a-105">Data</span><span class="sxs-lookup"><span data-stu-id="aac7a-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="aac7a-106">Globalizace</span><span class="sxs-lookup"><span data-stu-id="aac7a-106">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="aac7a-107">JIT</span><span class="sxs-lookup"><span data-stu-id="aac7a-107">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="aac7a-108">Zabezpečení</span><span class="sxs-lookup"><span data-stu-id="aac7a-108">Security</span></span>
...
## <a name="tools"></a><span data-ttu-id="aac7a-109">Nástroje</span><span class="sxs-lookup"><span data-stu-id="aac7a-109">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="aac7a-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="aac7a-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="aac7a-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="aac7a-111">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="aac7a-112">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="aac7a-112">Windows Workflow Foundation (WF)</span></span>
