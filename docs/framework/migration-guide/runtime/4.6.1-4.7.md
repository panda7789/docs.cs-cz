...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-47"></a>Změny za běhu pro migraci z .NET Framework 4.6.1 až 4,7

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Pokud migrujete z .NET Framework 4.6.1 na 4,7, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:
