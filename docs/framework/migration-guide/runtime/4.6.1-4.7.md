...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-47"></a><span data-ttu-id="9c1e5-102">Změny v modulu runtime pro migraci z rozhraní .NET Framework 4.6.1 k 4.7</span><span class="sxs-lookup"><span data-stu-id="9c1e5-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="9c1e5-103">Pokud provádíte migraci z rozhraní .NET Framework 4.6.1 k 4.7, naleznete v následujících tématech problémy s kompatibilitou aplikací, které může mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="9c1e5-103">If you are migrating from the .NET Framework 4.6.1 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="9c1e5-104">Data</span><span class="sxs-lookup"><span data-stu-id="9c1e5-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="9c1e5-105">Globalizace</span><span class="sxs-lookup"><span data-stu-id="9c1e5-105">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="9c1e5-106">JIT</span><span class="sxs-lookup"><span data-stu-id="9c1e5-106">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="9c1e5-107">Zabezpečení</span><span class="sxs-lookup"><span data-stu-id="9c1e5-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="9c1e5-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="9c1e5-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="9c1e5-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="9c1e5-109">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="9c1e5-110">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="9c1e5-110">Windows Workflow Foundation (WF)</span></span>
