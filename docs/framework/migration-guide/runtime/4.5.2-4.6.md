...
ms.locfileid: "61977233"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-46"></a><span data-ttu-id="db7e6-102">Změny v modulu runtime pro migraci z rozhraní .NET Framework 4.5.2 – 4.6</span><span class="sxs-lookup"><span data-stu-id="db7e6-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="db7e6-103">Pokud provádíte migraci z rozhraní .NET Framework 4.5.2 na 4.6, projděte si následující témata pro problémy s kompatibilitou aplikace, které může mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="db7e6-103">If you are migrating from the .NET Framework 4.5.2 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="db7e6-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="db7e6-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="db7e6-105">Jádro</span><span class="sxs-lookup"><span data-stu-id="db7e6-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="db7e6-106">Data</span><span class="sxs-lookup"><span data-stu-id="db7e6-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="db7e6-107">Ladicí program</span><span class="sxs-lookup"><span data-stu-id="db7e6-107">Debugger</span></span>
...
## <a name="networking"></a><span data-ttu-id="db7e6-108">Síťové služby</span><span class="sxs-lookup"><span data-stu-id="db7e6-108">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="db7e6-109">Serializace</span><span class="sxs-lookup"><span data-stu-id="db7e6-109">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="db7e6-110">Instalace a nasazení</span><span class="sxs-lookup"><span data-stu-id="db7e6-110">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="db7e6-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="db7e6-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="db7e6-112">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="db7e6-112">Windows Presentation Foundation (WPF)</span></span>
