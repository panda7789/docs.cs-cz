---
title: Změny modulu runtime pro migraci z .NET Framework 4.5.2 až 4,6
description: Vyhledejte informace o problémech s kompatibilitou aplikací z úprav modulu runtime, které by mohly ovlivnit vaši aplikaci při migraci z .NET Framework 4.5.2 na 4,6.
ms.date: 07/10/2019
...
ms.locfileid: "86442165"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-46"></a><span data-ttu-id="715bc-103">Změny modulu runtime pro migraci z .NET Framework 4.5.2 až 4,6</span><span class="sxs-lookup"><span data-stu-id="715bc-103">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="715bc-104">Pokud migrujete z .NET Framework 4.5.2 na 4,6, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="715bc-104">If you are migrating from the .NET Framework 4.5.2 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="715bc-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="715bc-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="715bc-106">Jádro</span><span class="sxs-lookup"><span data-stu-id="715bc-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="715bc-107">Data</span><span class="sxs-lookup"><span data-stu-id="715bc-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="715bc-108">Ladicí program</span><span class="sxs-lookup"><span data-stu-id="715bc-108">Debugger</span></span>
...
## <a name="networking"></a><span data-ttu-id="715bc-109">Sítě</span><span class="sxs-lookup"><span data-stu-id="715bc-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="715bc-110">Serializace</span><span class="sxs-lookup"><span data-stu-id="715bc-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="715bc-111">Nastavení a nasazení</span><span class="sxs-lookup"><span data-stu-id="715bc-111">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="715bc-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="715bc-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="715bc-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="715bc-113">Windows Presentation Foundation (WPF)</span></span>
