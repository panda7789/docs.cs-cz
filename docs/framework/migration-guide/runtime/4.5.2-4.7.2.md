...
ms.locfileid: "59980106"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-472"></a><span data-ttu-id="ab5df-102">Změny v modulu runtime pro migraci z rozhraní .NET Framework 4.5.2 k 4.7.2</span><span class="sxs-lookup"><span data-stu-id="ab5df-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.7.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="ab5df-103">Pokud provádíte migraci z rozhraní .NET Framework 4.5.2 k 4.7.2, projděte si následující témata pro problémy s kompatibilitou aplikace, které může mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="ab5df-103">If you are migrating from the .NET Framework 4.5.2 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="ab5df-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="ab5df-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="ab5df-105">Jádro</span><span class="sxs-lookup"><span data-stu-id="ab5df-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="ab5df-106">Data</span><span class="sxs-lookup"><span data-stu-id="ab5df-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="ab5df-107">Ladicí program</span><span class="sxs-lookup"><span data-stu-id="ab5df-107">Debugger</span></span>
...
## <a name="globalization"></a><span data-ttu-id="ab5df-108">Globalizace</span><span class="sxs-lookup"><span data-stu-id="ab5df-108">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="ab5df-109">Síťové služby</span><span class="sxs-lookup"><span data-stu-id="ab5df-109">Networking</span></span>
...
## <a name="runtime"></a><span data-ttu-id="ab5df-110">Modul runtime</span><span class="sxs-lookup"><span data-stu-id="ab5df-110">Runtime</span></span>

[!INCLUDE[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="ab5df-111">Zabezpečení</span><span class="sxs-lookup"><span data-stu-id="ab5df-111">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="ab5df-112">Serializace</span><span class="sxs-lookup"><span data-stu-id="ab5df-112">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="ab5df-113">Instalace a nasazení</span><span class="sxs-lookup"><span data-stu-id="ab5df-113">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="ab5df-114">Nástroje</span><span class="sxs-lookup"><span data-stu-id="ab5df-114">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="ab5df-115">Webové aplikace</span><span class="sxs-lookup"><span data-stu-id="ab5df-115">Web Applications</span></span>

[!INCLUDE["dataAnnotations:dataTypeAttribute:disableRegEx" app setting is on by default in .NET Framework 4.7.2](~/includes/migration-guide/runtime/web/dataannotationsdatatypeattributedisableregex-app-setting-on-by-default-net.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="ab5df-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="ab5df-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="ab5df-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="ab5df-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="ab5df-118">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="ab5df-118">Windows Workflow Foundation (WF)</span></span>
