...
ms.locfileid: "59980145"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-452"></a><span data-ttu-id="a5242-102">Změny v modulu runtime pro migraci z rozhraní .NET Framework 4.5 na 4.5.2</span><span class="sxs-lookup"><span data-stu-id="a5242-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="a5242-103">Pokud provádíte migraci z rozhraní .NET Framework 4.5 na 4.5.2, projděte si následující témata pro problémy s kompatibilitou aplikace, které může mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="a5242-103">If you are migrating from the .NET Framework 4.5 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="a5242-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="a5242-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="a5242-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="a5242-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="a5242-106">Jádro</span><span class="sxs-lookup"><span data-stu-id="a5242-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="a5242-107">Data</span><span class="sxs-lookup"><span data-stu-id="a5242-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="a5242-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="a5242-108">Entity Framework</span></span>
...
## <a name="serialization"></a><span data-ttu-id="a5242-109">Serializace</span><span class="sxs-lookup"><span data-stu-id="a5242-109">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="a5242-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="a5242-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="a5242-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="a5242-111">Windows Presentation Foundation (WPF)</span></span>
