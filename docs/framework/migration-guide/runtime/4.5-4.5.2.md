---
title: Změny za běhu pro migraci z .NET Framework 4,5 až 4.5.2
description: Vyhledejte informace o problémech s kompatibilitou aplikací z úprav modulu runtime, které by mohly ovlivnit vaši aplikaci při migraci z .NET Framework 4,5 na 4.5.2.
ms.date: 07/10/2019
...
ms.locfileid: "86443218"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-452"></a><span data-ttu-id="36f39-103">Změny za běhu pro migraci z .NET Framework 4,5 až 4.5.2</span><span class="sxs-lookup"><span data-stu-id="36f39-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="36f39-104">Pokud migrujete z .NET Framework 4,5 až 4.5.2, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="36f39-104">If you are migrating from the .NET Framework 4.5 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="36f39-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="36f39-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="36f39-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="36f39-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="36f39-107">Jádro</span><span class="sxs-lookup"><span data-stu-id="36f39-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="36f39-108">Data</span><span class="sxs-lookup"><span data-stu-id="36f39-108">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="36f39-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="36f39-109">Entity Framework</span></span>
...
## <a name="serialization"></a><span data-ttu-id="36f39-110">Serializace</span><span class="sxs-lookup"><span data-stu-id="36f39-110">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="36f39-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="36f39-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="36f39-112">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="36f39-112">Windows Presentation Foundation (WPF)</span></span>
