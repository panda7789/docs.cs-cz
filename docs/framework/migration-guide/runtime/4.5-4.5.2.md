...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-452"></a>Změny za běhu pro migraci z .NET Framework 4,5 až 4.5.2

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Pokud migrujete z .NET Framework 4,5 až 4.5.2, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:
