---
title: Změny za běhu pro migraci z .NET Framework 4.5.2 do 4.6.1
description: Vyhledejte informace o problémech s kompatibilitou aplikací z úprav modulu runtime, které by mohly ovlivnit vaši aplikaci při migraci z .NET Framework 4.5.2 na 4.6.1.
ms.date: 07/10/2019
...
ms.locfileid: "86443439"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-461"></a><span data-ttu-id="4892c-103">Změny za běhu pro migraci z .NET Framework 4.5.2 do 4.6.1</span><span class="sxs-lookup"><span data-stu-id="4892c-103">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="4892c-104">Pokud migrujete z .NET Framework 4.5.2 na 4.6.1, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="4892c-104">If you are migrating from the .NET Framework 4.5.2 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="4892c-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="4892c-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="4892c-106">Jádro</span><span class="sxs-lookup"><span data-stu-id="4892c-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="4892c-107">Data</span><span class="sxs-lookup"><span data-stu-id="4892c-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="4892c-108">Ladicí program</span><span class="sxs-lookup"><span data-stu-id="4892c-108">Debugger</span></span>
...
## <a name="networking"></a><span data-ttu-id="4892c-109">Sítě</span><span class="sxs-lookup"><span data-stu-id="4892c-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="4892c-110">Serializace</span><span class="sxs-lookup"><span data-stu-id="4892c-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="4892c-111">Nastavení a nasazení</span><span class="sxs-lookup"><span data-stu-id="4892c-111">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="4892c-112">Nástroje</span><span class="sxs-lookup"><span data-stu-id="4892c-112">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="4892c-113">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="4892c-113">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="4892c-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="4892c-114">Windows Presentation Foundation (WPF)</span></span>
