...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-46"></a><span data-ttu-id="476ed-102">Změny v modulu runtime pro migraci z rozhraní .NET Framework 4.0 na 4.6</span><span class="sxs-lookup"><span data-stu-id="476ed-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.6</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="476ed-103">Pokud migrujete z rozhraní .NET Framework 4.0 do 4.6, projděte si v následujících tématech problémům s kompatibilitou aplikací, které může mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="476ed-103">If you are migrating from the .NET Framework 4.0 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="476ed-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="476ed-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="476ed-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="476ed-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="476ed-106">Jádro</span><span class="sxs-lookup"><span data-stu-id="476ed-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="476ed-107">Data</span><span class="sxs-lookup"><span data-stu-id="476ed-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="476ed-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="476ed-108">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="476ed-109">LINQ</span><span class="sxs-lookup"><span data-stu-id="476ed-109">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="476ed-110">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="476ed-110">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="476ed-111">Síťové služby</span><span class="sxs-lookup"><span data-stu-id="476ed-111">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="476ed-112">Tisk</span><span class="sxs-lookup"><span data-stu-id="476ed-112">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="476ed-113">Serializace</span><span class="sxs-lookup"><span data-stu-id="476ed-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="476ed-114">Instalace a nasazení</span><span class="sxs-lookup"><span data-stu-id="476ed-114">Setup and Deployment</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="476ed-115">Webové aplikace</span><span class="sxs-lookup"><span data-stu-id="476ed-115">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="476ed-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="476ed-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="476ed-117">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="476ed-117">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="476ed-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="476ed-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="476ed-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="476ed-119">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="476ed-120">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="476ed-120">XML, XSLT</span></span>
