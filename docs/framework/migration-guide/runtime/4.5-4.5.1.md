---
title: Změny v modulu runtime pro migraci z .NET Framework 4,5 do 4.5.1
description: Vyhledejte informace o problémech s kompatibilitou aplikací z úprav modulu runtime, které by mohly ovlivnit vaši aplikaci při migraci z .NET Framework 4,5 na 4.5.1.
ms.date: 07/10/2019
...
ms.locfileid: "86443205"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-451"></a><span data-ttu-id="c1332-103">Změny v modulu runtime pro migraci z .NET Framework 4,5 do 4.5.1</span><span class="sxs-lookup"><span data-stu-id="c1332-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="c1332-104">Pokud migrujete z .NET Framework 4,5 na 4.5.1, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="c1332-104">If you are migrating from the .NET Framework 4.5 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="c1332-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="c1332-105">ADO.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="c1332-106">Jádro</span><span class="sxs-lookup"><span data-stu-id="c1332-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="c1332-107">Data</span><span class="sxs-lookup"><span data-stu-id="c1332-107">Data</span></span>

[!INCLUDE[ADO.NET now attempts to automatically reconnect broken SQL connections](~/includes/migration-guide/runtime/adonet/adonet-now-attempts-automatically-reconnect-broken-sql-connections.md)]

## <a name="serialization"></a><span data-ttu-id="c1332-108">Serializace</span><span class="sxs-lookup"><span data-stu-id="c1332-108">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="c1332-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="c1332-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="c1332-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="c1332-110">Windows Presentation Foundation (WPF)</span></span>
