---
title: Změny za běhu pro migraci z rozhraní .NET Framework 4.6.1 na 4.7.1
ms.date: 07/10/2019
...
ms.locfileid: "73196448"
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-471"></a><span data-ttu-id="4b125-102">Změny za běhu pro migraci z rozhraní .NET Framework 4.6.1 na 4.7.1</span><span class="sxs-lookup"><span data-stu-id="4b125-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="4b125-103">Pokud migrujete z rozhraní .NET Framework 4.6.1 na 4.7.1, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které mohou mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="4b125-103">If you are migrating from the .NET Framework 4.6.1 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="4b125-104">Data</span><span class="sxs-lookup"><span data-stu-id="4b125-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="4b125-105">Globalizace</span><span class="sxs-lookup"><span data-stu-id="4b125-105">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="4b125-106">Zabezpečení</span><span class="sxs-lookup"><span data-stu-id="4b125-106">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="4b125-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="4b125-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="4b125-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="4b125-108">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="4b125-109">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="4b125-109">Windows Workflow Foundation (WF)</span></span>
