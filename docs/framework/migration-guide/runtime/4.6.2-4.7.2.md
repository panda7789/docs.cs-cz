...
---
# <a name="runtime-changes-for-migration-from-net-framework-462-to-472"></a>Změny v modulu runtime pro migraci z .NET Framework 4.6.2 na 4.7.2

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Pokud migrujete z .NET Framework 4.6.2 na 4.7.2, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:
