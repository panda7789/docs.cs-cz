---
title: Změny v modulu runtime pro migraci z .NET Framework 4.5.1 na 4,6
description: Vyhledejte informace o problémech s kompatibilitou aplikací z úprav modulu runtime, které by mohly ovlivnit vaši aplikaci při migraci z .NET Framework 4.5.1 na 4,6.
ms.date: 07/10/2019
...
ms.locfileid: "86443530"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-46"></a><span data-ttu-id="7341e-103">Změny v modulu runtime pro migraci z .NET Framework 4.5.1 na 4,6</span><span class="sxs-lookup"><span data-stu-id="7341e-103">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="7341e-104">Pokud migrujete z .NET Framework 4.5.1 na 4,6, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="7341e-104">If you are migrating from the .NET Framework 4.5.1 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="7341e-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="7341e-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="7341e-106">Jádro</span><span class="sxs-lookup"><span data-stu-id="7341e-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="7341e-107">Data</span><span class="sxs-lookup"><span data-stu-id="7341e-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="7341e-108">Ladicí program</span><span class="sxs-lookup"><span data-stu-id="7341e-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="7341e-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="7341e-109">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="7341e-110">Sítě</span><span class="sxs-lookup"><span data-stu-id="7341e-110">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="7341e-111">Serializace</span><span class="sxs-lookup"><span data-stu-id="7341e-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="7341e-112">Nastavení a nasazení</span><span class="sxs-lookup"><span data-stu-id="7341e-112">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="7341e-113">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="7341e-113">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="7341e-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="7341e-114">Windows Presentation Foundation (WPF)</span></span>
