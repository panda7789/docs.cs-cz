...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-47"></a>Změny za běhu pro migraci z rozhraní .NET Framework 4.5.2 na 4.7

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Pokud migrujete z rozhraní .NET Framework 4.5.2 do 4.7, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které mohou mít vliv na vaši aplikaci:
