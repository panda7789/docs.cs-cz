...
ms.locfileid: "59111082"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-471"></a><span data-ttu-id="e18d9-102">Změny v modulu runtime pro migraci z rozhraní .NET Framework 4.5 na 4.7.1</span><span class="sxs-lookup"><span data-stu-id="e18d9-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="e18d9-103">Pokud provádíte migraci z rozhraní .NET Framework 4.5 na 4.7.1, projděte si následující témata pro problémy s kompatibilitou aplikace, které může mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="e18d9-103">If you are migrating from the .NET Framework 4.5 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="e18d9-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="e18d9-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="e18d9-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="e18d9-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="e18d9-106">Jádro</span><span class="sxs-lookup"><span data-stu-id="e18d9-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="e18d9-107">Data</span><span class="sxs-lookup"><span data-stu-id="e18d9-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="e18d9-108">Ladicí program</span><span class="sxs-lookup"><span data-stu-id="e18d9-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="e18d9-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="e18d9-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="e18d9-110">Globalizace</span><span class="sxs-lookup"><span data-stu-id="e18d9-110">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="e18d9-111">Síťové služby</span><span class="sxs-lookup"><span data-stu-id="e18d9-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="e18d9-112">Zabezpečení</span><span class="sxs-lookup"><span data-stu-id="e18d9-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="e18d9-113">Serializace</span><span class="sxs-lookup"><span data-stu-id="e18d9-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="e18d9-114">Instalace a nasazení</span><span class="sxs-lookup"><span data-stu-id="e18d9-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="e18d9-115">Nástroje</span><span class="sxs-lookup"><span data-stu-id="e18d9-115">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="e18d9-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="e18d9-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="e18d9-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="e18d9-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="e18d9-118">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="e18d9-118">Windows Workflow Foundation (WF)</span></span>
