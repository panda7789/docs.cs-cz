...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-462"></a>Změny v modulu runtime pro migraci z rozhraní .NET Framework 4.5.1 do 4.6.2

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Pokud provádíte migraci z rozhraní .NET Framework 4.5.1 do 4.6.2, projděte si následující témata pro problémy s kompatibilitou aplikace, které může mít vliv na vaši aplikaci:
