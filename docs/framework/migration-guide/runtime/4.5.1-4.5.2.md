...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-452"></a><span data-ttu-id="19391-102">Změny v modulu runtime pro migraci z .NET Framework 4.5.1 na 4.5.2</span><span class="sxs-lookup"><span data-stu-id="19391-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="19391-103">Pokud migrujete z .NET Framework 4.5.1 na 4.5.2, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="19391-103">If you are migrating from the .NET Framework 4.5.1 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="19391-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="19391-104">ASP.NET</span></span>
...
## <a name="data"></a><span data-ttu-id="19391-105">Data</span><span class="sxs-lookup"><span data-stu-id="19391-105">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="19391-106">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="19391-106">Entity Framework</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="19391-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="19391-107">Windows Presentation Foundation (WPF)</span></span>
