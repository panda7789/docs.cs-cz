---
title: Změny v modulu runtime pro migraci z .NET Framework 4,0 do 4.5.1
description: Vyhledejte informace o problémech s kompatibilitou aplikací z úprav modulu runtime, které by mohly ovlivnit vaši aplikaci při migraci z .NET Framework 4,0 na 4.5.1.
ms.date: 07/10/2019
...
ms.locfileid: "86443699"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-451"></a><span data-ttu-id="e7244-103">Změny v modulu runtime pro migraci z .NET Framework 4,0 do 4.5.1</span><span class="sxs-lookup"><span data-stu-id="e7244-103">Runtime Changes for Migration from .NET Framework 4.0 to 4.5.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="e7244-104">Pokud migrujete z .NET Framework 4,0 na 4.5.1, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="e7244-104">If you are migrating from the .NET Framework 4.0 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="e7244-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="e7244-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="e7244-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="e7244-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="e7244-107">Jádro</span><span class="sxs-lookup"><span data-stu-id="e7244-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="e7244-108">Data</span><span class="sxs-lookup"><span data-stu-id="e7244-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="e7244-109">Ladicí program</span><span class="sxs-lookup"><span data-stu-id="e7244-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="e7244-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="e7244-110">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="e7244-111">LINQ</span><span class="sxs-lookup"><span data-stu-id="e7244-111">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="e7244-112">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="e7244-112">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="e7244-113">Sítě</span><span class="sxs-lookup"><span data-stu-id="e7244-113">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="e7244-114">Tisk</span><span class="sxs-lookup"><span data-stu-id="e7244-114">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="e7244-115">Serializace</span><span class="sxs-lookup"><span data-stu-id="e7244-115">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="e7244-116">Webové aplikace</span><span class="sxs-lookup"><span data-stu-id="e7244-116">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="e7244-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="e7244-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="e7244-118">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="e7244-118">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="e7244-119">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="e7244-119">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="e7244-120">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="e7244-120">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="e7244-121">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="e7244-121">XML, XSLT</span></span>
