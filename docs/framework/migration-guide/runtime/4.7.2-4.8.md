...
ms.locfileid: "68237616"
---
# <a name="runtime-changes-for-migration-from-net-framework-472-to-48"></a><span data-ttu-id="0567d-102">Změny v modulu runtime pro migraci z rozhraní .NET Framework 4.7.2 k 4.8</span><span class="sxs-lookup"><span data-stu-id="0567d-102">Runtime Changes for Migration from .NET Framework 4.7.2 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="0567d-103">Pokud provádíte migraci z rozhraní .NET Framework 4.7.2 k 4.8, projděte si následující témata pro problémy s kompatibilitou aplikace, které může mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="0567d-103">If you are migrating from the .NET Framework 4.7.2 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="0567d-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="0567d-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="0567d-105">Jádro</span><span class="sxs-lookup"><span data-stu-id="0567d-105">Core</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="0567d-106">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="0567d-106">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="0567d-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="0567d-107">Windows Presentation Foundation (WPF)</span></span>
