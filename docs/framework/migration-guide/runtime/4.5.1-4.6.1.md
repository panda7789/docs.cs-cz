---
title: Změny za běhu pro migraci z .NET Framework 4.5.1 na 4.6.1
description: Vyhledejte informace o problémech s kompatibilitou aplikací z úprav modulu runtime, které by mohly ovlivnit vaši aplikaci při migraci z .NET Framework 4.5.1 na 4.6.1.
ms.date: 07/10/2019
...
ms.locfileid: "86443556"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-461"></a><span data-ttu-id="303af-103">Změny za běhu pro migraci z .NET Framework 4.5.1 na 4.6.1</span><span class="sxs-lookup"><span data-stu-id="303af-103">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="303af-104">Pokud migrujete z .NET Framework 4.5.1 na 4.6.1, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="303af-104">If you are migrating from the .NET Framework 4.5.1 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="303af-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="303af-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="303af-106">Jádro</span><span class="sxs-lookup"><span data-stu-id="303af-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="303af-107">Data</span><span class="sxs-lookup"><span data-stu-id="303af-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="303af-108">Ladicí program</span><span class="sxs-lookup"><span data-stu-id="303af-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="303af-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="303af-109">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="303af-110">Sítě</span><span class="sxs-lookup"><span data-stu-id="303af-110">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="303af-111">Serializace</span><span class="sxs-lookup"><span data-stu-id="303af-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="303af-112">Nastavení a nasazení</span><span class="sxs-lookup"><span data-stu-id="303af-112">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="303af-113">Nástroje</span><span class="sxs-lookup"><span data-stu-id="303af-113">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="303af-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="303af-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="303af-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="303af-115">Windows Presentation Foundation (WPF)</span></span>
