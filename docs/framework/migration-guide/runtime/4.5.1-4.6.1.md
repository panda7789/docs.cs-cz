---
title: Změny za běhu pro migraci z rozhraní .NET Framework 4.5.1 na 4.6.1
ms.date: 07/10/2019
...
ms.locfileid: "73196196"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-461"></a><span data-ttu-id="e23de-102">Změny za běhu pro migraci z rozhraní .NET Framework 4.5.1 na 4.6.1</span><span class="sxs-lookup"><span data-stu-id="e23de-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="e23de-103">Pokud migrujete z rozhraní .NET Framework 4.5.1 na 4.6.1, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které mohou mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="e23de-103">If you are migrating from the .NET Framework 4.5.1 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="e23de-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="e23de-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="e23de-105">Jádro</span><span class="sxs-lookup"><span data-stu-id="e23de-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="e23de-106">Data</span><span class="sxs-lookup"><span data-stu-id="e23de-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="e23de-107">Ladicí program</span><span class="sxs-lookup"><span data-stu-id="e23de-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="e23de-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="e23de-108">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="e23de-109">Sítě</span><span class="sxs-lookup"><span data-stu-id="e23de-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="e23de-110">Serializace</span><span class="sxs-lookup"><span data-stu-id="e23de-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="e23de-111">Nastavení a nasazení</span><span class="sxs-lookup"><span data-stu-id="e23de-111">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="e23de-112">nástroje</span><span class="sxs-lookup"><span data-stu-id="e23de-112">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="e23de-113">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="e23de-113">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="e23de-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="e23de-114">Windows Presentation Foundation (WPF)</span></span>
