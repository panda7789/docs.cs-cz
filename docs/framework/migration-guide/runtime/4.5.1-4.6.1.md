...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-461"></a>Změny za běhu pro migraci z rozhraní .NET Framework 4.5.1 na 4.6.1

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Pokud migrujete z rozhraní .NET Framework 4.5.1 na 4.6.1, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které mohou mít vliv na vaši aplikaci:
