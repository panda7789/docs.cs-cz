---
title: Změny za běhu pro migraci z rozhraní .NET Framework 4.5.1 na 4.8
ms.date: 07/10/2019
...
ms.locfileid: "73196560"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-48"></a><span data-ttu-id="ad549-102">Změny za běhu pro migraci z rozhraní .NET Framework 4.5.1 na 4.8</span><span class="sxs-lookup"><span data-stu-id="ad549-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="ad549-103">Pokud migrujete z rozhraní .NET Framework 4.5.1 na 4.8, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které mohou mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="ad549-103">If you are migrating from the .NET Framework 4.5.1 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="ad549-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="ad549-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="ad549-105">Jádro</span><span class="sxs-lookup"><span data-stu-id="ad549-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="ad549-106">Data</span><span class="sxs-lookup"><span data-stu-id="ad549-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="ad549-107">Ladicí program</span><span class="sxs-lookup"><span data-stu-id="ad549-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="ad549-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="ad549-108">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="ad549-109">Globalizace</span><span class="sxs-lookup"><span data-stu-id="ad549-109">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="ad549-110">Sítě</span><span class="sxs-lookup"><span data-stu-id="ad549-110">Networking</span></span>
...
## <a name="runtime"></a><span data-ttu-id="ad549-111">Modul runtime</span><span class="sxs-lookup"><span data-stu-id="ad549-111">Runtime</span></span>

[!INCLUDE[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="ad549-112">Zabezpečení</span><span class="sxs-lookup"><span data-stu-id="ad549-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="ad549-113">Serializace</span><span class="sxs-lookup"><span data-stu-id="ad549-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="ad549-114">Nastavení a nasazení</span><span class="sxs-lookup"><span data-stu-id="ad549-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="ad549-115">nástroje</span><span class="sxs-lookup"><span data-stu-id="ad549-115">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="ad549-116">Webové aplikace</span><span class="sxs-lookup"><span data-stu-id="ad549-116">Web Applications</span></span>

[!INCLUDE["dataAnnotations:dataTypeAttribute:disableRegEx" app setting is on by default in .NET Framework 4.7.2](~/includes/migration-guide/runtime/web/dataannotationsdatatypeattributedisableregex-app-setting-on-by-default-net.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="ad549-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="ad549-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="ad549-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="ad549-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="ad549-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="ad549-119">Windows Workflow Foundation (WF)</span></span>
