...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-462"></a>Změny v modulu runtime pro migraci z .NET Framework 4.5.2 do 4.6.2

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Pokud migrujete z .NET Framework 4.5.2 na 4.6.2, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:
