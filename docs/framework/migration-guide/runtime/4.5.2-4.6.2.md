---
title: Změny za běhu pro migraci z rozhraní .NET Framework 4.5.2 na 4.6.2
ms.date: 07/10/2019
...
ms.locfileid: "73196523"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-462"></a><span data-ttu-id="5b9c3-102">Změny za běhu pro migraci z rozhraní .NET Framework 4.5.2 na 4.6.2</span><span class="sxs-lookup"><span data-stu-id="5b9c3-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="5b9c3-103">Pokud migrujete z rozhraní .NET Framework 4.5.2 na 4.6.2, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které mohou mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="5b9c3-103">If you are migrating from the .NET Framework 4.5.2 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="5b9c3-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="5b9c3-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="5b9c3-105">Jádro</span><span class="sxs-lookup"><span data-stu-id="5b9c3-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="5b9c3-106">Data</span><span class="sxs-lookup"><span data-stu-id="5b9c3-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="5b9c3-107">Ladicí program</span><span class="sxs-lookup"><span data-stu-id="5b9c3-107">Debugger</span></span>
...
## <a name="globalization"></a><span data-ttu-id="5b9c3-108">Globalizace</span><span class="sxs-lookup"><span data-stu-id="5b9c3-108">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="5b9c3-109">Sítě</span><span class="sxs-lookup"><span data-stu-id="5b9c3-109">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="5b9c3-110">Zabezpečení</span><span class="sxs-lookup"><span data-stu-id="5b9c3-110">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="5b9c3-111">Serializace</span><span class="sxs-lookup"><span data-stu-id="5b9c3-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="5b9c3-112">Nastavení a nasazení</span><span class="sxs-lookup"><span data-stu-id="5b9c3-112">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="5b9c3-113">nástroje</span><span class="sxs-lookup"><span data-stu-id="5b9c3-113">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="5b9c3-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="5b9c3-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="5b9c3-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="5b9c3-115">Windows Presentation Foundation (WPF)</span></span>
