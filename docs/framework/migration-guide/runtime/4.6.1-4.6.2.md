...
ms.locfileid: "59125850"
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-462"></a><span data-ttu-id="35d1f-102">Změny v modulu runtime pro migraci z rozhraní .NET Framework 4.6.1 k 4.6.2</span><span class="sxs-lookup"><span data-stu-id="35d1f-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="35d1f-103">Pokud provádíte migraci z rozhraní .NET Framework 4.6.1 k 4.6.2, projděte si následující témata pro problémy s kompatibilitou aplikace, které může mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="35d1f-103">If you are migrating from the .NET Framework 4.6.1 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="35d1f-104">Data</span><span class="sxs-lookup"><span data-stu-id="35d1f-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="35d1f-105">Globalizace</span><span class="sxs-lookup"><span data-stu-id="35d1f-105">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="35d1f-106">Zabezpečení</span><span class="sxs-lookup"><span data-stu-id="35d1f-106">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="35d1f-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="35d1f-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="35d1f-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="35d1f-108">Windows Presentation Foundation (WPF)</span></span>
