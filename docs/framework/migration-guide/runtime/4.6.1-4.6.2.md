...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-462"></a><span data-ttu-id="6d037-102">Změny za běhu pro migraci z .NET Framework 4.6.1 do 4.6.2</span><span class="sxs-lookup"><span data-stu-id="6d037-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="6d037-103">Pokud migrujete z .NET Framework 4.6.1 na 4.6.2, přečtěte si následující témata, kde najdete problémy s kompatibilitou aplikací, které můžou mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="6d037-103">If you are migrating from the .NET Framework 4.6.1 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="6d037-104">Data</span><span class="sxs-lookup"><span data-stu-id="6d037-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="6d037-105">Globalizace</span><span class="sxs-lookup"><span data-stu-id="6d037-105">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="6d037-106">Zabezpečení</span><span class="sxs-lookup"><span data-stu-id="6d037-106">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="6d037-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="6d037-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="6d037-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="6d037-108">Windows Presentation Foundation (WPF)</span></span>
