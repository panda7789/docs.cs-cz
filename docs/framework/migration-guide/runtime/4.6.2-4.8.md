...
ms.locfileid: "67857299"
---
# <a name="runtime-changes-for-migration-from-net-framework-462-to-48"></a><span data-ttu-id="dbf79-102">Změny v modulu runtime pro migraci z rozhraní .NET Framework 4.6.2 – 4.8</span><span class="sxs-lookup"><span data-stu-id="dbf79-102">Runtime Changes for Migration from .NET Framework 4.6.2 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="dbf79-103">Pokud provádíte migraci z rozhraní .NET Framework 4.6.2 – 4.8, projděte si následující témata pro problémy s kompatibilitou aplikace, které může mít vliv na vaši aplikaci:</span><span class="sxs-lookup"><span data-stu-id="dbf79-103">If you are migrating from the .NET Framework 4.6.2 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="dbf79-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="dbf79-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="dbf79-105">Jádro</span><span class="sxs-lookup"><span data-stu-id="dbf79-105">Core</span></span>
...
## <a name="runtime"></a><span data-ttu-id="dbf79-106">Modul runtime</span><span class="sxs-lookup"><span data-stu-id="dbf79-106">Runtime</span></span>

[!INCLUDE[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="dbf79-107">Zabezpečení</span><span class="sxs-lookup"><span data-stu-id="dbf79-107">Security</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="dbf79-108">Webové aplikace</span><span class="sxs-lookup"><span data-stu-id="dbf79-108">Web Applications</span></span>

[!INCLUDE["dataAnnotations:dataTypeAttribute:disableRegEx" app setting is on by default in .NET Framework 4.7.2](~/includes/migration-guide/runtime/web/dataannotationsdatatypeattributedisableregex-app-setting-on-by-default-net.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="dbf79-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="dbf79-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="dbf79-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="dbf79-110">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="dbf79-111">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="dbf79-111">Windows Workflow Foundation (WF)</span></span>
