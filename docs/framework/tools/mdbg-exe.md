...
|**l**[**ist**] [*modules* &#124; *appdomains* &#124; *assemblies*]|Zobrazí načtené moduly, aplikační domény a sestavení.|  
...
|**p**[**rint**] [*var*] &#124; [`-d`]|Vytiskne všechny proměnné v rozsahu (**tisk**), vytiskne zadanou proměnnou (**tisk** *var*), nebo vytiskne proměnné ladicího programu (**tisk** `-d`).|  
