...
|**-s,-přihlašovací**`[signOptions]`|Použije k podpisu souboru pár klíčů nebo certifikát X509. Podpisy jsou do souboru vloženy jako prvky jazyka XML.<br /><br /> Musíte být připojeni k Internetu při podepsání manifestu, který určuje **- TimestampUri** hodnotu.|  
