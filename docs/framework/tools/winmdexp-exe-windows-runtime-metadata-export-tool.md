...
- [Vytváření komponent prostředí Windows Runtime v C# nástroji a Visual Basic](https://docs.microsoft.com/previous-versions/br230301(v=vs.110))
