...
|**-listgroups**<br /><br /> or<br /><br /> **kontaktní-skupina**|Zobrazuje skupiny kódu konkrétní úrovně nebo všech úrovní zásad. Nástroj Caspol.exe zobrazuje nejprve popisek skupiny kódu a poté název, pokud není null.|  
...
|**-u**[**ser**]|Značí, že jsou všechny možnosti následující po této možnosti aplikovány na zásadu na uživatelské úrovni pro uživatele, který nástroj Caspol.exe spustil. Pro běžní uživatelé **-uživatele** je výchozí.|  
