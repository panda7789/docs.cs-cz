...
ms.locfileid: "46001087"
---
# <a name="sosdll-sos-debugging-extension"></a>SOS.dll (rozšíření ladění SOS)
Nástroj SOS Debugging Extension (SOS.dll) pomáhá při ladění spravovaných programů v sadě Visual Studio a v ladicím programu sady Windows (WinDbg.exe) poskytováním informací o vnitřním prostředí modulu Common Language Runtime (CLR). Tento nástroj vyžaduje, aby měl projekt povoleno nespravované ladění. Knihovna SOS.dll je automaticky nainstalována společně s rozhraním .NET Framework. Pro použití knihovny SOS.dll v sadě Visual Studio, nainstalujte [Windows Driver Kit (WDK)](https://msdn.microsoft.com/windows/hardware/hh852362).  
  
> [!NOTE]
>  Pokud používáte [!INCLUDE[vs_dev12](../../../includes/vs-dev12-md.md)], knihovna SOS.dll je podporována v ladicím programu sady Windows v sadě Visual Studio, ale ne v příkazovém podokně ladicího programu sady Visual Studio.  
...
## <a name="remarks"></a>Poznámky  
 ...
 Chcete-li použít nástroj SOS Debugging Extension v sadě Visual Studio, nainstalujte [Windows Driver Kit (WDK)](https://msdn.microsoft.com/windows/hardware/hh852362). Informace o integrovaném ladicím prostředí v sadě Visual Studio najdete v tématu [ladicí prostředí](https://msdn.microsoft.com/library/windows/hardware/hh406268.aspx) Windows Dev Center.  
  
 Nástroj SOS Debugging Extension můžete také použít jeho načtením do ladicího programu WinDbg.exe, který je k dispozici [webu WDK a nástrojů pro vývojáře](https://go.microsoft.com/fwlink/?LinkId=103787)a provádění příkazů v rámci WinDbg.exe.  
