...
---
# <a name="wif-features"></a>Funkce technologie WIF
...
-   [Přehled modulu ověřování WSFederation](../../../docs/framework/security/wsfederation-authentication-module-overview.md)  
