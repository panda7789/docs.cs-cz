...
## [Paralelní zpracování a souběžnost](standard/parallel-processing-and-concurrency.md)
...
## [Rychlé starty](csharp/quick-starts/)
...
#### [Přístup ke službě OData s použitím zprostředkovatelů typů](fsharp/tutorials/type-providers/accessing-an-odata-service.md)
#### [Přístup k webové službě s použitím zprostředkovatelů typů](fsharp/tutorials/type-providers/accessing-a-web-service.md)
#### [Generování typů F# ze souboru DBML](fsharp/tutorials/type-providers/generating-fsharp-types-from-dbml.md)
#### [Generování typů F# ze souboru EDMX](fsharp/tutorials/type-providers/generating-fsharp-types-from-edmx.md)
#### [Vytvoření zprostředkovatele typů](fsharp/tutorials/type-providers/creating-a-type-provider.md)
