...
### [Rozšíření možností práce s daty pomocí porovnávání vzorů](csharp/tutorials/pattern-matching.md)
...
### [Doporučení filmů (doporučení)](machine-learning/tutorials/movie-recommmendation.md)
