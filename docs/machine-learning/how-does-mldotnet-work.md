...
V tomto fragmentu kódu `Concatenate` a `Sdca` jsou obě metody v katalogu. Každá vytvořit [IEstimator](xref:Microsoft.ML.IEstimator`1) objekt, který se připojí k kanálu.
