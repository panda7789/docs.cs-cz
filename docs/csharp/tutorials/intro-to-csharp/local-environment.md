...
[Interpolace](interpolated-strings-local.md) kurzu se dozvíte, jak vložit hodnot do řetězce. Dozvíte se víc o vytvoření interpolovaného řetězce s vloženými C# výrazy a jak řídí formátování výsledného řetězce.

V tomto kurzu se předpokládá, že jste dokončili [Hello world](hello-world.yml), [čísla ve C# ](numbers-in-csharp-local.md), a [větve a smyčky](branches-and-loops-local.md) lekce.
