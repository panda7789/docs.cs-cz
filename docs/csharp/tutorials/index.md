...
## <a name="string-interpolationintro-to-csharpinterpolated-stringsyml"></a>[Interpolace řetězců](intro-to-csharp/interpolated-strings.yml)

[Interpolace](intro-to-csharp/interpolated-strings.yml) kurzu se dozvíte, jak vložit hodnot do řetězce. Dozvíte se víc o vytvoření interpolovaného řetězce s vloženými C# výrazy a tom, jak řídit vzhled textu výrazu výsledků ve výsledném řetězci. Tento kurz je také k dispozici [spouštět místně na svém počítači](intro-to-csharp/interpolated-strings-local.md).
