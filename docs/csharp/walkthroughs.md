...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Ukazuje, jak vytvořit typ Windows Runtime, zabalíte ji komponenty prostředí Windows Runtime a poté zavolejte komponentu z [!INCLUDE[win8_appname_long](~/includes/win8-appname-long-md.md)] aplikaci, která je vytvořená pro Windows pomocí jazyka JavaScript.  
