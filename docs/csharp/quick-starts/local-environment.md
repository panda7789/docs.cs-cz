...
Prvním krokem k pokusu o rychlý start místně, je nastavení prostředí pro vývoj na místním počítači.
...
Můžete spustit v některé z následujících rychlé spuštění:

## <a name="numbers-in-cnumbers-in-csharp-localmd"></a>[Čísla v jazyce C#](numbers-in-csharp-local.md)

V [čísla v jazyce C#](numbers-in-csharp-local.md) rychlý start získáte informace, jak počítače ukládat čísla a jak provádět výpočty s různými číselné typy. Dozvíte se základy zaokrouhlení a jak provádět výpočty pomocí jazyka C#. 
