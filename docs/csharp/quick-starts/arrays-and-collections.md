...
Zobrazí se příklad řešení s nástrojem [prohlížení dokončení ukázkový kód na Githubu](https://github.com/dotnet/samples/tree/master/csharp/list-quickstart/Program.cs#L13-L23)
