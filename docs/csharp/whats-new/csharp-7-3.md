...
- <span data-ttu-id="6ed4c-119">Řešení přetížení má nyní méně dvojznačné případy.</span><span class="sxs-lookup"><span data-stu-id="6ed4c-119">Overload resolution now has fewer ambiguous cases.</span></span>
