...
```
 ...
 CS0120 bude také generována, pokud je volání nestatické metody ze statické metody, takto:
...
```
 ...
 Podobně statickou metodu nelze volat metodu instance, pokud explicitně dát instanci třídy, takto:
