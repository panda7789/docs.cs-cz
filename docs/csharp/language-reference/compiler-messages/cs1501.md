...
---
# <a name="compiler-error-cs1501"></a>Chyba kompilátoru CS1501
Žádné přetížení metody ' Method ' přebírá ' Number ' argumenty  
  
 Bylo provedeno volání metody třídy, ale žádná definice metody nepřijímá zadaný počet argumentů.  
  
## <a name="example"></a>Příklad  
 Následující ukázka generuje CS1501.  
