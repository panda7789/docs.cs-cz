...
ms.locfileid: "33215242"
---
# <a name="compiler-error-cs1501"></a>Chyba kompilátoru CS1501
Žádné přetížení metody 'metoda' má "číslo" argumenty  
  
 Došlo k volání metody třídy, ale žádné definice metody provede zadaný počet argumentů.  
