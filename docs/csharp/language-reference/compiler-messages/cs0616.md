...
'class' není třída atributu  
 ...
 Došlo pokusu o použití třídy bez atributu v bloku atributu. Všechny typy atributů musí být zděděné od <xref:System.Attribute?displayProperty=nameWithType>.  
...
## <a name="example"></a>Příklad  
 Následující příklad ukazuje, jak můžete třeba definovat atribut:  
