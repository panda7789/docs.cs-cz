...
'function': nelze explicitně volat operátor nebo přístupový objekt  
  
 Některé operátory mají interní názvy. Například **op_Increment** je interní název ++ – operátor. Neměli použít nebo explicitně volat tyto metody názvy.  
