...
ms.locfileid: "61671961"
---
# <a name="compiler-error-cs0015"></a><span data-ttu-id="9821e-102">Chyba kompilátoru CS0015</span><span class="sxs-lookup"><span data-stu-id="9821e-102">Compiler Error CS0015</span></span>
<span data-ttu-id="9821e-103">Název typu 'type' je příliš dlouhý</span><span class="sxs-lookup"><span data-stu-id="9821e-103">The name of type 'type' is too long</span></span>  
  
 <span data-ttu-id="9821e-104">Plně kvalifikovaný název uživatelem definovaného typu musí mít méně než 1024 znaků, včetně doby.</span><span class="sxs-lookup"><span data-stu-id="9821e-104">The fully qualified name of a user-defined type must have fewer than 1024 characters, including the periods.</span></span>  
  
 <span data-ttu-id="9821e-105">Následující ukázka generuje CS0015:</span><span class="sxs-lookup"><span data-stu-id="9821e-105">The following sample generates CS0015:</span></span>  
