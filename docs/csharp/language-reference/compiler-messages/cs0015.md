...
ms.locfileid: "33210279"
---
# <a name="compiler-error-cs0015"></a><span data-ttu-id="b0f27-102">Chyba kompilátoru CS0015</span><span class="sxs-lookup"><span data-stu-id="b0f27-102">Compiler Error CS0015</span></span>
<span data-ttu-id="b0f27-103">Název typu "typ" je příliš dlouhý</span><span class="sxs-lookup"><span data-stu-id="b0f27-103">The name of type 'type' is too long</span></span>  
  
 <span data-ttu-id="b0f27-104">Plně kvalifikovaný název uživatelem definovaného typu musí mít méně než 1024 znaků, včetně období.</span><span class="sxs-lookup"><span data-stu-id="b0f27-104">The fully qualified name of a user-defined type must have fewer than 1024 characters, including the periods.</span></span>  
  
 <span data-ttu-id="b0f27-105">Následující ukázka generuje CS0015:</span><span class="sxs-lookup"><span data-stu-id="b0f27-105">The following sample generates CS0015:</span></span>  
