...
Klíčové slovo 'this' nebo 'base' byl očekáván  
  
 Kompilátor narazil na neúplnou deklaraci konstruktoru.  
  
## <a name="example"></a>Příklad  
 Následující příklad generuje CS1018 a navrhne několik způsobů, jak vyřešit chybu:  
