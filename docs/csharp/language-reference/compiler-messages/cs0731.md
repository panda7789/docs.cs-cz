...
Předávání typu pro typ "typ" v sestavení 'assembly' způsobuje cyklický odkaz  
  
 K této chybě může dojít pouze se nesprávně utvořenou importované metadat. Nelze k ní dojít pouze zdroje C#.  
  
## <a name="example"></a>Příklad  
 Následující ukázka generuje CS0731. V příkladu se skládá ze tří souborů:  
 ...
 Napřed zkompilovat. Soubory IL jako knihovny a potom kompilace .cs kód odkazující na dva soubory.  
