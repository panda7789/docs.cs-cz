...
Předávání typů pro typ 'type' v sestavení 'assembly' způsobuje cyklus  
  
 K této chybě může dojít pouze se nesprávně vytvořené importovaná metadata. Ho nelze provést s pouze C# zdroje.  
...
## <a name="example"></a>Příklad  
 ...
 Nejprve ji zkompilujte. Soubory IL jako knihovny a poté zkompilovat kód .cs odkazující na příslušné dva soubory.  
