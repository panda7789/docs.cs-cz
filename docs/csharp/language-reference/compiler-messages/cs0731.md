...
Typ pro předávání pro typ "typ" v sestavě "sestava" způsobí cyklus  
  
 K této chybě může dojít pouze s nesprávně vytvořenými importovanými metadaty. Nemůže dojít pouze se zdrojem Jazyka C#.  
...
## <a name="example"></a>Příklad  
 ...
 Nejprve zkompilujte . IL soubory jako knihovny a pak zkompilovat .cs kód odkazující na dva soubory.  
