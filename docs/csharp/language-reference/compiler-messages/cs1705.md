...
- Klient, který odkazuje pouze na verzi 1,0 stejných knihoven DLL, ale přistupuje ke třídě z verze 2,0.  
 ...
 Následující kód vytvoří první ze stejných knihoven DLL. Informace o tom, jak vygenerovat soubor klíče, naleznete v tématu [/keyfile (C# možnosti kompilátoru)](../../../csharp/language-reference/compiler-options/keyfile-compiler-option.md).  
