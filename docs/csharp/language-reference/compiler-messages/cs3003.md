...
Typ 'variable' není kompatibilní se Specifikací CLS  
  
 A [veřejné](../../../csharp/language-reference/keywords/public.md), [chráněné](../../../csharp/language-reference/keywords/protected.md), nebo `protected internal` proměnná musí být typu, který je kompatibilní s specifikace CLS (Common Language). Další informace o dodržování specifikace CLS naleznete v tématu [jazyková nezávislost a jazykově nezávislé komponenty](../../../standard/language-independence-and-language-independent-components.md).  
