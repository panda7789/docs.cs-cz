...
Byla zjištěna dvojznačnost mezi – metoda a jiných metoda "bez method". Pomocí skupinu metod.  
  
 Zděděné členy z různých rozhraní, které mají stejnou signaturu způsobit chybu nejednoznačnost.  
