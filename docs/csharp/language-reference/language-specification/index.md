...
Verze 6.0 specifikace nebyla schválena jako standard. Tento web obsahuje [ *koncept* specifikace jazyka C# 6.0](../../../../_csharplang/spec/lexical-structure.md). Je sestaven z obsažené v souborech markdownu [úložiště GitHub dotnet/csharplang](https://github.com/dotnet/csharplang/blob/master/spec/README.md).
...
[Další](../../../../_csharplang/spec/lexical-structure.md)
