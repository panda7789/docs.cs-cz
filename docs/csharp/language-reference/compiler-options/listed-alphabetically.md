...
Následující možnosti kompilátoru jsou seřazené abecedně. Seznam kategorií naleznete v tématu [Možnosti kompilátoru C# uvedené podle kategorie](listed-by-category.md).
...
|položk\<file>|Zadejte soubor pro protokolování všech diagnostik kompilátorů a analyzátorů.|
...
|[langversion –\<string>](langversion-compiler-option.md)|Zadejte jazykovou verzi: výchozí, ISO-1, ISO-2, 3, 4, 5, 6, 7, 7,1, 7,2, 7,3 nebo nejnovější. |
...
|[– platforma](platform-compiler-option.md)|Omezuje platformy, na kterých lze tento kód spustit: x86, Itanium, x64, anycpu nebo anycpu32bitpreferred. Výchozí hodnota je anycpu.|
...
|[– Referenční informace](reference-compiler-option.md)|Odkazuje na metadata ze zadaných souborů sestavení.|
