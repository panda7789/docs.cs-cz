...
V tomto příkladu `decimal` a [int](../../../csharp/language-reference/builtin-types/integral-numeric-types.md) jsou kombinované ve stejném výrazu. Výsledek je vyhodnocen `decimal` typu.
