...
Můžete přidělit paměť v zásobníku, kde není předmětem uvolňování paměti a proto není nutné připnout. Chcete-li to provést, použijte [ `stackalloc` výraz](../operators/stackalloc.md).
