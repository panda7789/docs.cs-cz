...
Následující tabulka uvádí podporované specifikátorů pro formátování číselných výsledků. Formátovaný výsledek odpovídá "en US" <xref:System.Globalization.CultureInfo>.
