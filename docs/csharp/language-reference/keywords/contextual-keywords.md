---
title: Kontextová klíčová slova - C# odkaz
ms.custom: seodec18
ms.date: 03/07/2017
helpviewer_keywords:
...
|Klíčové slovo|Popis|  
|-------------|-----------------|  
|[add](../../../csharp/language-reference/keywords/add.md)|Definuje přístupový objekt vlastní událost, která je volána, když kód klienta tuto událost odebírá.|  
...
|[await](../../../csharp/language-reference/keywords/await.md)|Asynchronní metody pozastaví až do dokončení očekávané úlohy.|  
...
|[var](../../../csharp/language-reference/keywords/var.md)|Umožňuje, aby typ proměnné deklarované v oboru metoda bude určen kompilátorem.|  
|[Kdy](when.md)|Určuje podmínku filtrování `catch` bloku nebo `case` popisek `switch` příkazu.|
|[kde](../../../csharp/language-reference/keywords/where-generic-type-constraint.md)|Přidá omezení do obecného deklarace. (Viz také [kde](../../../csharp/language-reference/keywords/where-clause.md)).|  
|[yield](../../../csharp/language-reference/keywords/yield.md)|Použít v blok iterátoru, bude vrácena hodnota objekt enumerator nebo který signalizuje, že konci iterace.|  
