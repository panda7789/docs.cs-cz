...
Kontextové klíčové slovo se používá k poskytnutí konkrétního významu v kódu, ale není to rezervované slovo v C#. V této části jsou představena následující kontextová klíčová slova:  
...
|[remove](./remove.md)|Definuje vlastní přistupující událost, která se vyvolá, když se kód klienta odhlásí od události.|  
...
|[yield](./yield.md)|Používá se v bloku iterátoru k vrácení hodnoty objektu enumerátoru nebo k signalizaci konce iterace.|  
 ...
 Všechna klíčová slova pro C# dotazy představená v 3,0 jsou také kontextová. Další informace najdete v tématu [klíčová slova dotazu (LINQ)](./query-keywords.md).  
