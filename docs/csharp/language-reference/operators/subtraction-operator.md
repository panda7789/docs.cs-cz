...
## <a name="remarks"></a>Poznámky  
 ...
 Uživatelem definované typy mohou přetížit unární `-` a binární `-` operátory. Další informace najdete v tématu [– operátor (referenční dokumentace jazyka C#)](../../../csharp/language-reference/keywords/operator.md).  
