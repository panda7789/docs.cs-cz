...
Komentář XML v konstrukci má duplicitní značku param parametru pro parametr.  
 ...
 Při použití možnosti kompilátoru [/doc](../language-reference/compiler-options/doc-compiler-option.md) bylo nalezeno více komentářů pro stejný parametr metody. Odeberte jeden z duplicitních řádků.  
