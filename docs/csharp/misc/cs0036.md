...
---
# <a name="compiler-error-cs0036"></a>CS0036 chyby kompilátoru
Výstupní parametr nemůže mít atribut '[v].  
  
 V současné době **v** atributu není povolená u [out](../../csharp/language-reference/keywords/out-parameter-modifier.md) parametr.  
