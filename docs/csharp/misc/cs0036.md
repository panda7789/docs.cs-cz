...
---
# <a name="compiler-error-cs0036"></a>Compiler Error CS0036
Parametr out nemůže obsahovat atribut '[In].  
  
 V současné době **v** atribut není povolený [si](../../csharp/language-reference/keywords/out-parameter-modifier.md) parametru.  
