...
---
# <a name="compiler-error-cs0416"></a>Compiler Error CS0416
parametr typu: argument atributu nemůže používat parametry typu  
  
 Parametr typu byla použita jako argument atributu, který není povolen. Pomocí jiného než obecného typu.  
