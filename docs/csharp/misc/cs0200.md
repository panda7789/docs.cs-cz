...
Vlastnost nebo indexer vlastnosti nelze přiřadit – je jen pro čtení.  
 ...
 Došlo k pokusu o přiřazení hodnoty k [vlastnosti](../programming-guide/classes-and-structs/using-properties.md), ale vlastnost nemá přístupový objekt set. Chybu vyřešte přidáním přístupového objektu set. Další informace najdete v tématu [postup deklarace a použití vlastností zápisu pro čtení](../programming-guide/classes-and-structs/how-to-declare-and-use-read-write-properties.md).
