...
---
# <a name="compiler-warning-level-1-cs1581"></a>Kompilátor CS1581 upozornění (úroveň 1)
Neplatný návratový typ v atributu cref komentáře XML  
  
 Při pokusu o odkazovat na metodu, kompilátor zjistil chybu z důvodu neplatný návratový typ.  
