...
---
# <a name="compiler-warning-level-1-cs1581"></a>CS1581 kompilátoru upozornění (úroveň 1)
Neplatný návratový typ v atributu cref komentáře XML  
  
 Při pokusu o odkaz na metodu, kompilátor došlo k chybě z důvodu neplatný návratový typ.  
