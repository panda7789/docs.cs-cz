...
---
# <a name="compiler-error-cs1728"></a>Compiler Error CS1728
Nelze vytvořit vazbu delegáta s 'member' protože je členem 'type'  
  
 Nelze vytvořit vazbu delegátů k členům `Nullable` typy.  
