...
Možnost/moduleassemblyname se dá zadat jenom při vytváření cílového typu Module.  
 ...
 Možnost kompilátoru **/moduleassemblyname** by měla být použita pouze při sestavování typu. netmodule. Další informace naleznete v tématu [/moduleassemblyname (C# možnost kompilátoru)](../language-reference/compiler-options/moduleassemblyname-compiler-option.md) .  
