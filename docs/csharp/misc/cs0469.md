...
Hodnota 'goto case' není implicitně převoditelná na typ typu 'type'  
  
 Při použití `goto case`musí být implicitní převod z hodnoty případu goto na typ přepínače.  
