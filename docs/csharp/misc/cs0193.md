...
* Nebo -> operátor je nutné použít na ukazatele  
  
 **\*** Nebo **->** operátor byl použit s typem nonpointer. Další informace najdete v tématu [typy ukazatelů](../../csharp/programming-guide/unsafe-code-pointers/pointer-types.md).  
