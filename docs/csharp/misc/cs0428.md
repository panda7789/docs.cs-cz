...
---
# <a name="compiler-error-cs0428"></a>Compiler Error CS0428
Nelze převést skupinu metod 'Identifier' na nedelegující typ 'type'.  Chtěli jste vyvolat metodu?  
  
 K této chybě dochází při převodu skupinu metod na nedelegující typ, nebo při pokusu o vyvolání metody bez použití závorek.  
