...
ms.locfileid: "61657574"
---
# <a name="compiler-error-cs0428"></a><span data-ttu-id="18c20-102">Compiler Error CS0428</span><span class="sxs-lookup"><span data-stu-id="18c20-102">Compiler Error CS0428</span></span>
<span data-ttu-id="18c20-103">Nelze převést skupinu metod 'Identifier' na nedelegující typ 'type'.</span><span class="sxs-lookup"><span data-stu-id="18c20-103">Cannot convert method group 'Identifier' to non-delegate type 'type'.</span></span>  <span data-ttu-id="18c20-104">Chtěli jste vyvolat metodu?</span><span class="sxs-lookup"><span data-stu-id="18c20-104">Did you  intend to invoke the method?</span></span>  
  
 <span data-ttu-id="18c20-105">K této chybě dochází při převodu skupinu metod na nedelegující typ, nebo při pokusu o vyvolání metody bez použití závorek.</span><span class="sxs-lookup"><span data-stu-id="18c20-105">This error occurs when converting a method group to a non-delegate type, or attempting to invoke a method without using parentheses.</span></span>  
  
## <a name="example"></a><span data-ttu-id="18c20-106">Příklad</span><span class="sxs-lookup"><span data-stu-id="18c20-106">Example</span></span>  
 <span data-ttu-id="18c20-107">Následující ukázka generuje CS0428:</span><span class="sxs-lookup"><span data-stu-id="18c20-107">The following sample generates CS0428:</span></span>  
