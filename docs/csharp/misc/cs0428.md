...
---
# <a name="compiler-error-cs0428"></a>Chyba kompilátoru CS0428
Nelze převést skupinu metod ' identifier ' na typ bez delegáta ' type '.  Chtěli jste vyvolat metodu?  
  
 K této chybě dochází při převodu skupiny metod na typ bez delegáta nebo při pokusu o vyvolání metody bez použití závorek.  
  
## <a name="example"></a>Příklad  
 Následující ukázka generuje CS0428:  
