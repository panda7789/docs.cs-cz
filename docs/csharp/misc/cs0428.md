...
---
# <a name="compiler-error-cs0428"></a>CS0428 chyby kompilátoru
Nelze převést Metoda skupiny "Identifikátor" bez delegátem typu "typ".  Máte v úmyslu vyvolání metody?  
  
 K této chybě dojde při převodu skupinu metoda typem jiných delegáta nebo pokus o volání metody bez použití závorek.  
