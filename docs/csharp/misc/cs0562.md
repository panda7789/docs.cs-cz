...
Deklarace metody pro přetížení operátoru musí splňovat určitá pravidla. Další informace najdete v tématu [přetížení operátoru](../../csharp/language-reference/operators/operator-overloading.md).
