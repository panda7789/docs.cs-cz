...
##  <a name="BKMK_SimpleIterator"></a><span data-ttu-id="5e4fd-125">Jednoduché iterátorů</span><span class="sxs-lookup"><span data-stu-id="5e4fd-125">Simple Iterator</span></span>  
...
##  <a name="BKMK_CollectionClass"></a><span data-ttu-id="5e4fd-128">Vytvoření třídy kolekce</span><span class="sxs-lookup"><span data-stu-id="5e4fd-128">Creating a Collection Class</span></span>  
...
##  <a name="BKMK_GenericList"></a><span data-ttu-id="5e4fd-135">Pomocí seznamu obecné iterátory</span><span class="sxs-lookup"><span data-stu-id="5e4fd-135">Using Iterators with a Generic List</span></span>  
...
##  <a name="BKMK_SyntaxInformation"></a><span data-ttu-id="5e4fd-145">Informace ze syntaxe</span><span class="sxs-lookup"><span data-stu-id="5e4fd-145">Syntax Information</span></span>  
...
##  <a name="BKMK_Technical"></a><span data-ttu-id="5e4fd-151">Technická implementace</span><span class="sxs-lookup"><span data-stu-id="5e4fd-151">Technical Implementation</span></span>  
...
##  <a name="BKMK_UseOfIterators"></a><span data-ttu-id="5e4fd-162">Použití iterátory</span><span class="sxs-lookup"><span data-stu-id="5e4fd-162">Use of Iterators</span></span>  
