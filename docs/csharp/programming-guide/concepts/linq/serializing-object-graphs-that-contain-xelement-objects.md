...
|Téma|Popis|  
|-----------|-----------------|  
|[Postupy: serializace pomocí třídy XmlSerializer (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-serialize-using-xmlserializer.md)|Ukazuje, jak lze serializovat pomocí <xref:System.Xml.Serialization.XmlSerializer>.|  
|[Postupy: serializace pomocí třídy DataContractSerializer (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-serialize-using-datacontractserializer.md)|Ukazuje, jak lze serializovat pomocí <xref:System.Runtime.Serialization.DataContractSerializer>.|  
