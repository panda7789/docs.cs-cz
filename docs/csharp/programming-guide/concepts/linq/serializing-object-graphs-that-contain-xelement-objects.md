...
---
# <a name="serializing-object-graphs-that-contain-xelement-objects-c"></a>Serializace grafů objektů, které obsahují XElement objekty (C#)
...
|Téma|Popis|  
|-----------|-----------------|  
|[Postupy: serializace pomocí třídy XmlSerializer (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-serialize-using-xmlserializer.md)|Ukazuje, jak serializovat pomocí <xref:System.Xml.Serialization.XmlSerializer>.|  
|[Postupy: serializace použití DataContractSerializer (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-serialize-using-datacontractserializer.md)|Ukazuje, jak serializovat pomocí <xref:System.Runtime.Serialization.DataContractSerializer>.|  
