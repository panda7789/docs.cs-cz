...
|[Postupy: řízení předpon Namespace (C#) (LINQ to XML)](../../../../csharp/programming-guide/concepts/linq/how-to-control-namespace-prefixes-linq-to-xml.md)|Ukazuje, jak řízení předpon názvového prostoru vložením atributy oboru názvů do stromu XML.|  
