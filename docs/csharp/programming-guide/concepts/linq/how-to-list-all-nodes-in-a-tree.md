...
```
 ...
 <span data-ttu-id="fc3cd-118">Tento příklad vytvoří následující výstup:</span><span class="sxs-lookup"><span data-stu-id="fc3cd-118">This example produces the following output:</span></span>
