...
---
# <a name="how-to-retrieve-a-single-child-element-linq-to-xml-c"></a>Postupy: načtení jeden podřízený Element (technologie LINQ to XML) (C#)
...
## <a name="example"></a>Příklad  
 Následující příklad ukazuje stejný kód pro formát XML, který je v oboru názvů. Další informace najdete v tématu [práci s obory názvů XML (C#)](../../../../csharp/programming-guide/concepts/linq/working-with-xml-namespaces.md).  
