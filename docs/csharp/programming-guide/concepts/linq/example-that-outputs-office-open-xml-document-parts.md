...
---
# <a name="example-that-outputs-office-open-xml-document-parts-c"></a>Příklad, který vyvádí Office Open XML document parts (C#)
Toto téma ukazuje, jak otevřít dokument Office Open XML a získat v něm přístup k částem.  
