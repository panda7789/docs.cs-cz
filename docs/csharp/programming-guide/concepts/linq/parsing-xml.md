...
|Téma|Popis|  
|-----------|-----------------|  
|[Postupy: Analyzovat řetězec (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-parse-a-string.md)|Ukazuje, jak analyzovat řetězec k vytvoření stromu XML.|  
|[Postupy: Načtení XML ze souboru (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-load-xml-from-a-file.md)|Ukazuje, jak načíst XML z identifikátoru URI pomocí <xref:System.Xml.Linq.XElement.Load%2A> metody.|  
|[Zachování prázdných znaků při načítání nebo analýze XML](../../../../csharp/programming-guide/concepts/linq/preserving-white-space-while-loading-or-parsing-xml1.md)|Popisuje, jak řídit chování mezer [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] při načítání stromů XML.|  
|[Postupy: Zachycení chyb při analýze (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-catch-parsing-errors.md)|Ukazuje, jak detekovat XML chybně vytvořený nebo je neplatný.|  
