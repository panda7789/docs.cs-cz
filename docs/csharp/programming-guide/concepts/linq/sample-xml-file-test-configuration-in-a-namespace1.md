...
Následující soubor XML se v dokumentaci používá v různých příkladech [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] . Toto je konfigurační soubor testu. KÓD XML je v oboru názvů.  
