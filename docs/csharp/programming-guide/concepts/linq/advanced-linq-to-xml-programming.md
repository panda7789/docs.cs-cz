...
|[Postupy: použití anotací transformace stromů LINQ to XML ve stylu XSLT (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-use-annotations-to-transform-linq-to-xml-trees-in-an-xslt-style.md)|Popisuje použití poznámek k usnadnění transformace stromu XML.|  
