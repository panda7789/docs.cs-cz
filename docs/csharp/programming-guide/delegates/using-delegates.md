...
Vzhledem k tomu, že typy delegátů jsou odvozeny od `System.Delegate`, metody a vlastnosti definované touto třídou mohou být v delegátovi volány. Pokud například chcete najít počet metod v seznamu volání delegáta, můžete napsat:
