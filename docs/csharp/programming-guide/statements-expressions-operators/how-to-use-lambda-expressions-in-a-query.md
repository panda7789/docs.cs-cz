...
## <a name="compiling-the-code"></a>Probíhá kompilace kódu  
 Chcete-li spustit tento kód, zkopírujte a vložte metodu do `StudentClass` , který je k [dispozici v tématu How to: Dotaz na kolekci objektů](../linq-query-expressions/how-to-query-a-collection-of-objects.md) a jejich volání `Main` z metody.  
