...
|Název|Popis|  
|-----------|-----------------|  
|[Postupy: Testování rovnosti (identity) odkazů](../../../csharp/programming-guide/statements-expressions-operators/how-to-test-for-reference-equality-identity.md)|Popisuje, jak zjistit, zda dvě proměnné referenční rovnosti.|  
...
|[Průvodce programováním v jazyce C#](../../../csharp/programming-guide/index.md)|Obsahuje odkazy na podrobné informace o důležitých funkcí jazyka C# a funkce, které jsou k dispozici pro C# prostřednictvím rozhraní .NET Framework.|  
