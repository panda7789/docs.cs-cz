---
title: Postupy v článcích (Průvodce C#)
...
ms.locfileid: "82794699"
---
# <a name="how-to-c"></a>Postupy (C#)

V části Postupy v průvodci C# můžete najít rychlé odpovědi na časté otázky. V některých případech mohou být články uvedeny ve více částech. Chtěli bychom snadno najít více cest pro hledání.

## <a name="general-c-concepts"></a>Obecné koncepty jazyka C#

K dispozici je několik tipů a štychů, které jsou běžné postupy pro vývojáře v jazyce C#:
...
- I programátoři v C# můžou chtít [použít `My` obor názvů z Visual Basic](../programming-guide/namespaces/how-to-use-the-my-namespace.md).
...
- [Přepsáním `ToString` metody poskytněte výstup řetězce](../programming-guide/classes-and-structs/how-to-override-the-tostring-method.md).
...
- [Použijte porovnávání vzorů, `as` operátory `is` a pro bezpečné přetypování na jiný typ](safely-cast-using-pattern-matching-is-and-as-operators.md).
...
- [Zvyšte výkon asynchronního výkonu pomocí nástroje `System.Threading.Tasks.Task.WhenAll` ](../programming-guide/concepts/async/how-to-extend-the-async-walkthrough-by-using-task-whenall.md).
...
Obvykle programy v jazyce C# obsahují argumenty příkazového řádku. Tyto články vás seznámí s přístupem k argumentům příkazového řádku a jejich zpracování.
