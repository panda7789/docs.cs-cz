...
<xref:System.String.Split%2A?displayProperty=nameWithType>Metoda vytvoří pole podřetězců rozdělením vstupního řetězce na základě jednoho nebo více oddělovačů. Je často nejjednodušší způsob, jak oddělit řetězec na hranici slova. Používá se také k rozdělení řetězců na jiné konkrétní znaky nebo řetězce.
...
Následující příklad používá mezery, čárky, tečky, dvojtečky a tabulátory, všechny předané v poli, které obsahuje tyto dělicí znaky, do <xref:System.String.Split%2A> .
