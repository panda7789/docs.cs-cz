---
title: Podpis souborů
description: Další informace o použití F# podpis souborů k ukládání informací o veřejných podpisů sadu F# programu prvky, jako jsou moduly, typy a obory názvů.
ms.date: 06/15/2018
