...
Toto téma obsahuje tabulky symbolů a operátorů, které se používají v F# jazyka.

## <a name="table-of-symbols-and-operators"></a>Tabulka symbolů a operátorů

Následující tabulka popisuje symboly použité v F# jazyka, obsahuje odkazy na témata, která poskytují další informace a obsahuje stručný popis některých používá symbolu. Symboly jsou řazeny podle sadu pořadí znaků ASCII.
...
V následující tabulce jsou uvedeny pořadí podle priority operátorů a dalších klíčových slovech výrazu z F# jazyk, v pořadí od nejnižší, nejvyšší priority. Také je asociativita operátorů, pokud je k dispozici.
