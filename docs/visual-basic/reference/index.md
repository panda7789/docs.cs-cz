...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 [Visual Basic Kompilátor příkazového řádku](command-line-compiler/index.md)  
 ...
 [Referenční informace k rozhraní .NET Framework](net-framework-reference-information.md)  
 Obsahuje odkazy na informace o práci s knihovnou tříd .NET Framework.  
  
 [Specifikace jazyka Visual Basic](language-specification/index.md)  
