...
|[– optimalizovat](../../../visual-basic/reference/command-line-compiler/optimize.md)|Povolí nebo zakáže optimalizaci kódu.|  
...
|[– platforma](../../../visual-basic/reference/command-line-compiler/platform.md)|Určuje platformu procesoru, kterou kompilátor cílí na výstupní soubor.|  
...
|[– Referenční informace](../../../visual-basic/reference/command-line-compiler/reference.md)|Importuje metadata ze sestavení.|  
