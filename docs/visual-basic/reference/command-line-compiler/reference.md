...
## <a name="example"></a>Příklad  
 Následující příkaz zkompiluje zdrojový `Input.vb` soubor a referenční sestavení z `Metad1.dll` a `Metad2.dll` do. `Out.exe`  
...
- [Republik](../../../visual-basic/language-reference/modifiers/public.md)
