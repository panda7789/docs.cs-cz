...
## <a name="remarks"></a>Poznámky  
 ...
 Můžete také předat informace o šifrování kompilátoru s parametrem [-keyfile](keyfile.md). Použijte [-delaysign](delaysign.md) , pokud chcete použít částečně podepsané sestavení.  
