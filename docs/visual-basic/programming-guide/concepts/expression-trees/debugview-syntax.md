...
Každý příklad následuje obsahující blok komentáře `DebugView`. 
...
Pro některé číselné typy se přidá přípona k hodnotě:
...
| <xref:System.Single> | [Jeden](../../../language-reference/data-types/single-data-type.md) | F | 
