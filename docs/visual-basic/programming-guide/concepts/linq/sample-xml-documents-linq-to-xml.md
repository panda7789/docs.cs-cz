...
|[Ukázkový soubor XML: Typická nákupní objednávka v názvovém prostoru](../../../../visual-basic/programming-guide/concepts/linq/sample-xml-file-typical-purchase-order-in-a-namespace.md)|Dokument XML v oboru názvů, který obsahuje Typická nákupní objednávka.|  
...
|[Ukázkový soubor XSD: Zákazníci a objednávky](../../../../visual-basic/programming-guide/concepts/linq/sample-xsd-file-customers-and-orders.md)|Definice schématu Xml (XSD), která ověřuje [ukázkový soubor XML: Zákazníci a objednávky (LINQ to XML)](http://msdn.microsoft.com/library/26790c41-5976-4558-a096-d0f67bfc4d92).|  
