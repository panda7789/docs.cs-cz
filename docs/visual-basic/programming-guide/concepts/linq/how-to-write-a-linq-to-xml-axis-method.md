...
---
# <a name="how-to-write-a-linq-to-xml-axis-method-visual-basic"></a><span data-ttu-id="7bae9-102">Postupy: LINQ zápis metody osy XML (Visual Basic)</span><span class="sxs-lookup"><span data-stu-id="7bae9-102">How to: Write a LINQ to XML Axis Method (Visual Basic)</span></span>
<span data-ttu-id="7bae9-103">Můžete napsat vlastní metody osy pro načtení kolekce ze stromu XML.</span><span class="sxs-lookup"><span data-stu-id="7bae9-103">You can write your own axis methods to retrieve collections from an XML tree.</span></span> <span data-ttu-id="7bae9-104">Jedním z nejlepších způsobů je zápis metody rozšíření, která vrátí kolekci elementy nebo atributy.</span><span class="sxs-lookup"><span data-stu-id="7bae9-104">One of the best ways to do this is to write an extension method that returns a collection of elements or attributes.</span></span> <span data-ttu-id="7bae9-105">Můžete napsat metodu rozšíření k vrácení konkrétním podmnožinám elementy nebo atributy, na základě požadavků vaší aplikace.</span><span class="sxs-lookup"><span data-stu-id="7bae9-105">You can write your extension method to return specific subsets of elements or attributes, based on the requirements of your application.</span></span>  
  
## <a name="example"></a><span data-ttu-id="7bae9-106">Příklad</span><span class="sxs-lookup"><span data-stu-id="7bae9-106">Example</span></span>  
 <span data-ttu-id="7bae9-107">Následující příklad používá dvě metody rozšíření.</span><span class="sxs-lookup"><span data-stu-id="7bae9-107">The following example uses two extension methods.</span></span> <span data-ttu-id="7bae9-108">První metoda rozšíření `GetXPath`, pracuje <xref:System.Xml.Linq.XObject>a vrátí výraz XPath, který při vyhodnocování vrátí uzlu nebo atributu.</span><span class="sxs-lookup"><span data-stu-id="7bae9-108">The first extension method, `GetXPath`, operates on <xref:System.Xml.Linq.XObject>, and returns an XPath expression that when evaluated will return the node or attribute.</span></span> <span data-ttu-id="7bae9-109">Druhá metoda rozšíření `Find`, pracuje <xref:System.Xml.Linq.XElement>.</span><span class="sxs-lookup"><span data-stu-id="7bae9-109">The second extension method, `Find`, operates on <xref:System.Xml.Linq.XElement>.</span></span> <span data-ttu-id="7bae9-110">Vrátí kolekci <xref:System.Xml.Linq.XAttribute> objekty a <xref:System.Xml.Linq.XElement> objektů, které obsahují některé zadaný text.</span><span class="sxs-lookup"><span data-stu-id="7bae9-110">It returns a collection of <xref:System.Xml.Linq.XAttribute> objects and <xref:System.Xml.Linq.XElement> objects that contain some specified text.</span></span>  
  
 <span data-ttu-id="7bae9-111">Tento příklad používá následujícího dokumentu XML: [Ukázkový soubor XML: Více nákupních objednávek (LINQ to XML)](../../../../visual-basic/programming-guide/concepts/linq/sample-xml-file-multiple-purchase-orders-linq-to-xml.md).</span><span class="sxs-lookup"><span data-stu-id="7bae9-111">This example uses the following XML document: [Sample XML File: Multiple Purchase Orders (LINQ to XML)](../../../../visual-basic/programming-guide/concepts/linq/sample-xml-file-multiple-purchase-orders-linq-to-xml.md).</span></span>  
...
```  
 ...
 <span data-ttu-id="7bae9-112">Tento kód vytvoří následující výstup:</span><span class="sxs-lookup"><span data-stu-id="7bae9-112">This code produces the following output:</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="7bae9-113">Viz také:</span><span class="sxs-lookup"><span data-stu-id="7bae9-113">See also</span></span>

- [<span data-ttu-id="7bae9-114">Pokročilé techniky dotazování (LINQ to XML) (Visual Basic)</span><span class="sxs-lookup"><span data-stu-id="7bae9-114">Advanced Query Techniques (LINQ to XML) (Visual Basic)</span></span>](../../../../visual-basic/programming-guide/concepts/linq/advanced-query-techniques-linq-to-xml.md)
