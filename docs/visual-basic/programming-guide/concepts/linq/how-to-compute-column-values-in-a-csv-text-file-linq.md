...
---
# <a name="how-to-compute-column-values-in-a-csv-text-file-linq-visual-basic"></a>Postupy: Hodnoty výpočetních sloupců v textovém souboru CSV (LINQ) (Visual Basic)
