...
## <a name="example"></a>Příklad  
 Pokud pracujete v návodu, můžete tento kód pro soubor Module1.vb projekt, který je vytvořen existuje. Právě nahradit řádky označené jako *** v `Main` metoda s dotazy a spuštění dotazu, které jsou k dispozici v tomto návodu.  
