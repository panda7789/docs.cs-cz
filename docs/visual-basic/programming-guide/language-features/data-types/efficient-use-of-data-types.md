...
## <a name="character-conversion"></a>Převod znaků
 `AscW`Funkce a `ChrW` fungují v kódování Unicode. Měli byste je používat v předvolbách `Asc` a `Chr` , které se musí překládat do kódování Unicode a z něj.
