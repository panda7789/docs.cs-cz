...
## <a name="most-efficient-data-types"></a>Nejúčinnější datové typy  
 Pro proměnné, které nikdy nesmí obsahovat zlomků jsou efektivnější než nonintegral typy integrální datové typy. V [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)], `Integer` a `UInteger` jsou nejúčinnější číselnými typy.  
