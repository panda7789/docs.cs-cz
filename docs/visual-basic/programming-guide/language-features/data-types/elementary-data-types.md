...
[!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]poskytuje sadu předem definovaných datových typů, které můžete použít pro řadu programovací prvky. Tato část popisuje tyto typy a jejich použití.  
...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Popisuje `Boolean`, `Date`, a `Object` typy.  
...
## <a name="related-sections"></a>Související oddíly  
 ...
 Poskytuje přehled základní datové typy poskytl [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)].
