...
|Uděláte to tak|Další informace naleznete v tématu|  
|----------------|---------|  
|Najít předem definované – výčet|[Konstanty a výčty](../../../../visual-basic/language-reference/constants-and-enumerations.md)|  
...
|Název výčtu plnému určení|[Výčty a kvalifikace názvu](../../../../visual-basic/programming-guide/language-features/constants-enums/enumerations-and-name-qualification.md)|  
...
|Iterace výčet|[Postupy: iterace výčet v jazyce Visual Basic](../../../../visual-basic/programming-guide/language-features/constants-enums/how-to-iterate-through-an-enumeration.md)|  
