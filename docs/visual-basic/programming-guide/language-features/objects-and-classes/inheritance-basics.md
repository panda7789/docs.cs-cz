...
## <a name="inheritance-modifiers"></a>Modifikátory dědičnosti  
 [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]zavádí následující příkazy úrovni třídy a modifikátory pro podporu dědičnosti:  
