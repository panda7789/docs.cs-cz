...
---
# <a name="how-to-declare-and-use-xml-namespace-prefixes-visual-basic"></a>Postupy: Deklarace a používání předpon Namespace XML (Visual Basic)
Tento příklad ukazuje, jak importovat předponu oboru názvů XML `ns` a použít ho literál XML a vlastnosti OS XML.  
