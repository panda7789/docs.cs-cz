...
Literál syntaxe XML [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] podporuje většinu specifikace jazyka XML (Extensible Markup) 1.0. Podrobnosti o specifikace XML 1.0 najdete v tématu [jazyka XML (Extensible Markup) 1.0](http://go.microsoft.com/fwlink/?LinkId=73927) na webu W3C.  
