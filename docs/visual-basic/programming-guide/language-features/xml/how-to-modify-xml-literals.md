...
[!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]poskytuje praktické způsoby, jak změna literálů XML. Můžete přidat nebo odstranit elementů a atributů, a můžete také nahradit existující element nového elementu XML. Toto téma obsahuje několik příkladů, jak upravit existující literál XML.  
