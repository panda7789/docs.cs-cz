...
Tento příklad ukazuje, jak používat vlastnost osy atributu pro přístup k atributům XML v elementu XML podle názvu. Konkrétně, použije `type` atributu – vlastnost osy pro přístup k atributu s názvem `type` v `phone` objektu.  
