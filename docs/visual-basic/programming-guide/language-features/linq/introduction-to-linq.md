...
|[Technologie LINQ to SQL](https://msdn.microsoft.com/library/bb386976)|Obsahuje obecné informace, pokyny pro programovací a ukázky pro technologie LINQ to SQL.|  
