...
Typ proměnné lze také odvodit z vrácených hodnot funkcí, jak ukazuje následující příklad. @No__t_0 i `pList2` jsou pole procesů, protože `Process.GetProcesses` vrací pole procesů.
