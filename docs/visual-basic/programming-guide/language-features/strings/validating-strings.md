...
Tato část popisuje, jak k ověření řetězce v jazyce Visual Basic.  
  
## <a name="in-this-section"></a>V tomto oddílu  
 [Postupy: ověření názvů souborů a cest v jazyce Visual Basic](../../../../visual-basic/programming-guide/language-features/strings/how-to-validate-file-names-and-paths.md)  
 Postup určení, zda řetězec reprezentuje název souboru nebo cestu.  
 ...
 Postup určení, zda řetězec reprezentuje platné datum.  
