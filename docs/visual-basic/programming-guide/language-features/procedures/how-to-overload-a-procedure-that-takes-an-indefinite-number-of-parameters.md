...
## <a name="example"></a>Příklad  
 ...
 Kód v přetížené verze nemá k ověření, zda jeden nebo více hodnot pro zadaný kód volání `ParamArray` parametr, nebo pokud ano, kolik. [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]ovládací prvek předává verzi odpovídající volání seznam argumentů.  
