...
3. Přidejte následující konstanty pro `ComClass1`. Budou ukládat konstanty globálně jedinečného identifikátoru (GUID), které objekty COM musí mít.  
...
5. Nahraďte prázdný řetězec pro `ClassId` identifikátorem GUID a odeberte úvodní a koncové složené závorky. Například pokud je identifikátor GUID poskytovaný nástrojem Guidgen `"{2C8B0AEE-02C9-486e-B809-C780A11530FE}"` pak by se měl váš kód zobrazit takto.  
  
     [!code-vb[VbVbalrInterop#3](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrInterop/VB/Class1.vb#3)]  
  
6. Opakujte předchozí postup pro konstanty `InterfaceId` a `EventsId`, jako v následujícím příkladu.  
...
7. Přidejte atribut `ComClass` do `ComClass1`a zadejte identifikátory GUID pro ID třídy, ID rozhraní a ID událostí, jako v následujícím příkladu:  
  
     [!code-vb[VbVbalrInterop#5](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrInterop/VB/Class1.vb#5)]  
  
8. Třídy COM musí mít konstruktor `Public Sub New()` bez parametrů, jinak se třída nebude registrovat správně. Přidejte do třídy konstruktor bez parametrů:  
  
     [!code-vb[VbVbalrInterop#6](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrInterop/VB/Class1.vb#6)]  
  
9. Do třídy přidejte vlastnosti, metody a události a končící je příkazem `End Class`. V nabídce **sestavení** vyberte **sestavení řešení** . Visual Basic sestavení sestavení a registruje objekt COM s operačním systémem.  
