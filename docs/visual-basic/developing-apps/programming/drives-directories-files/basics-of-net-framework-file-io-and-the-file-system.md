...
> [!NOTE]
>  Další témata v této části použijte `My.Computer.FileSystem` objektu místo `System.IO` třídy pro práci s disky, souborů a adresářů. `My.Computer.FileSystem` Objektu je určena především pro použití v [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] programy. `System.IO`třídy jsou určeny k použití v jakémkoli jazyce, který podporuje [!INCLUDE[dnprdnshort](~/includes/dnprdnshort-md.md)], včetně [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)].  
...
-   **Vyhledávání**. Můžete vyhledat a upravit vaši pozici v datovém proudu.  
 ...
 Další informace najdete v tématu [vytváření datových proudů](https://msdn.microsoft.com/library/e4y2dch9).  
...
|---|---|   
|Čtení a zápisu do datového souboru|[Postupy: čtení a zápisu do nově vytvořeného datového souboru](https://msdn.microsoft.com/library/36b93480.aspx)|  
|Čtení textu ze souboru|[Postupy: čtení textu ze souboru](https://msdn.microsoft.com/library/db5x7c0d.aspx)|  
|Zápis textu do souboru|[Postupy: zápis textu do souboru](https://msdn.microsoft.com/library/6ka1wd3w.aspx)|  
|Čtení znaků z řetězce|[Postupy: čtení znaků z řetězce](https://msdn.microsoft.com/library/9yyz8a6c.aspx)|  
|Zápis znaků do řetězce|[Postupy: zápis znaků do řetězce](https://msdn.microsoft.com/library/z4kzt0dd.aspx)|  
|Šifrování dat|[Šifrování dat](https://msdn.microsoft.com/library/as0w18af.aspx)|  
|Dešifrování dat|[Dešifrování dat](https://msdn.microsoft.com/library/te15te69.aspx)|  
...
|Chcete-li|Další informace naleznete v tématu|  
|---|---|
|Otevření a přidání textu do souboru protokolu|[Postupy: otevření a připojení k souboru protokolu](https://msdn.microsoft.com/library/3zc0w663.aspx)|  
...
|Chcete-li|Další informace naleznete v tématu|
|---|---|  
|Vytvoření izolovaného úložiště|[Postupy: získávání úložišť pro izolované úložiště](https://msdn.microsoft.com/library/k48a6h13.aspx)|  
|Zobrazení výčtu izolované úložiště|[Postupy: vytvoření výčtu úložišť pro izolované úložiště](https://msdn.microsoft.com/library/c3dy613a.aspx)|  
|Odstranění izolovaného úložiště|[Postupy: odstraňování úložišť v izolovaném úložišti](https://msdn.microsoft.com/library/5w71t104.aspx)|  
|Vytvořit soubor nebo adresář v izolovaném úložišti|[Postupy: vytváření souborů a adresářů v izolovaném úložišti](https://msdn.microsoft.com/library/6h2ws3ft.aspx)|  
|Vyhledat soubor v izolovaném úložišti|[Postupy: hledání existujících souborů a adresářů v izolovaném úložišti](https://msdn.microsoft.com/library/zd5e2z84.aspx)|  
|Číst nebo zapisovat do souboru v izolovaném úložišti|[Postupy: čtení a zápis do souborů v izolovaném úložišti](https://msdn.microsoft.com/library/xf96a1wz.aspx)|  
|Odstranit soubor nebo adresář v izolovaném úložišti|[Postupy: odstraňování souborů a adresářů v izolovaném úložišti](https://msdn.microsoft.com/library/kx3852wf.aspx)|  
