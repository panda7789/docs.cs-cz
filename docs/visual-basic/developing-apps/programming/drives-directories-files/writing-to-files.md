---
title: Zápis do souborů v jazyce Visual Basic
ms.date: 07/20/2015
helpviewer_keywords:
...
Tato část vysvětluje, jak provádět úlohy, které zahrnují zápis do souborů.  
...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Ukazuje, jak k zápisu do textových souborů.  
 ...
 Ukazuje, jak přidat text do textového souboru.  
 ...
 Ukazuje, jak k zápisu do binárního souboru.  
 ...
 Demonstruje postup vytvoření a zápis do nového textového souboru v **dokumenty** adresáře.  
 ...
 Ukazuje, jak k zápisu do souboru s <xref:System.IO.StreamWriter?displayProperty=nameWithType> objektu.  
  
## <a name="reference"></a>Odkaz  
 <xref:Microsoft.VisualBasic.FileIO.FileSystem>  
 Popisuje `My.Computer.FileSystem` objektu a jeho metod a vlastností.  
  
 <xref:Microsoft.VisualBasic.FileIO.FileSystem.OpenTextFileWriter%2A>  
 Popisuje `OpenTextFileWriter` metoda.  
  
 <xref:Microsoft.VisualBasic.FileIO.FileSystem.WriteAllBytes%2A>  
 Popisuje `WriteAllBytes` metoda.  
  
 <xref:Microsoft.VisualBasic.FileIO.FileSystem.WriteAllText%2A>  
 Popisuje `WriteAllText` metoda.  
...
## <a name="related-sections"></a>Související oddíly  
 ...
 Obsahuje přehled kódování souborů.
