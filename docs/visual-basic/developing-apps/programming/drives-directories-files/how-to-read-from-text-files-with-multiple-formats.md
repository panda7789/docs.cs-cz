...
<xref:Microsoft.VisualBasic.FileIO.TextFieldParser> Objekt poskytuje způsob, jak snadno a efektivně analyzovat strukturované textové soubory, jako jsou protokoly. Můžete zpracovat soubor s více formáty pomocí `PeekChars` metody k určení formátu každého řádku při analýze souboru.
...
3. Vytvořte nový <xref:Microsoft.VisualBasic.FileIO.TextFieldParser> objekt a definujte šířku a formát.
