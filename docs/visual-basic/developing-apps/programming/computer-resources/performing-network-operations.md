...
Následující tabulky seznam úkolů spojených s `My.Computer.Network` objektu.  
  
## <a name="in-this-section"></a>V tomto oddílu  
 [Postupy: Nahrání souboru](../../../../visual-basic/developing-apps/programming/computer-resources/how-to-upload-a-file.md)  
 Ukazuje, jak nahrát soubor a uložte ho do vzdáleného umístění pomocí `My.Computer.Network`.  
 ...
 Ukazuje, jak určit, zda má počítač fungující síťové připojení.  
  
## <a name="reference"></a>Odkaz  
 <xref:Microsoft.VisualBasic.Devices.Network>  
 Jsou uvedené metody, vlastnosti a události pro práci se sítí.  
  
 <xref:Microsoft.VisualBasic.Devices.Network.DownloadFile%2A>  
 Popisuje `DownloadFile` metoda.  
  
 <xref:Microsoft.VisualBasic.Devices.Network.Ping%2A>  
 Popisuje `Ping` metoda.  
  
 <xref:Microsoft.VisualBasic.Devices.Network.UploadFile%2A>  
 Popisuje `UploadFile` metoda.  
