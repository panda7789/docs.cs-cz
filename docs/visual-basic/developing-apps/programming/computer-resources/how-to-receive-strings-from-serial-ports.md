...
3. Use the `My.Computer.Ports.OpenSerialPort` method to obtain a reference to the port. Další informace najdete v tématu <xref:Microsoft.VisualBasic.Devices.Ports.OpenSerialPort%2A>.  
