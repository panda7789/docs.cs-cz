---
title: "Visual Basic Power Pack – ovládací prvky"
ms.date: 07/20/2015
ms.prod: .net
ms.suite: 
...
## <a name="in-this-section"></a>V tomto oddílu  
 [Čára a tvar – ovládací prvky](../../../visual-basic/developing-apps/windows-forms/line-and-shape-controls-visual-studio.md)  
 Ovládací prvky Line a Shape uvádí a poskytuje odkazy na další informace.  
  
 [Prvku DataRepeater](../../../visual-basic/developing-apps/windows-forms/datarepeater-control-visual-studio.md)  
 Uvádí ovládacího prvku DataRepeater a poskytuje odkazy na další informace.  
