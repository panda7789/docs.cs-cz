...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Uvádí a popisuje `DataRepeater` ovládacího prvku.  
 ...
 Ukazuje, jak používat `DataRepeater` zobrazte data ze zdroje dat ovládacího prvku.  
 ...
 Ukazuje, jak používat `DataRepeater` řízení zobrazíte další data.  
 ...
 Ukazuje, jak změnit orientaci `DataRepeater` ovládacího prvku.  
 ...
 Ukazuje, jak přizpůsobit `DataRepeater` ovládacího prvku v době návrhu a v době běhu.  
 ...
 Ukazuje, jak řídit ukazatele výběru na `DataRepeater` ovládacího prvku.  
 ...
 Ukazuje, jak zabránit uživatelům v přidávání nebo odstraňování položek v `DataRepeater` ovládacího prvku.  
 ...
 Ukazuje, jak implementovat funkce vyhledávání v `DataRepeater` ovládacího prvku.  
 ...
 Ukazuje, jak zobrazit související záznamy pomocí dvou `DataRepeater` ovládací prvky.  
 ...
 Poskytuje zahájení dokončení demonstraci toho, jak používat `DataRepeater` ovládacího prvku.  
 ...
 Popisuje potenciální problémy a jejich řešení.  
...
## <a name="related-sections"></a>Související oddíly  
 [Virtuální režim ovládacího prvku DataRepeater](../../../visual-basic/developing-apps/windows-forms/virtual-mode-in-the-datarepeater-control-visual-studio.md)
