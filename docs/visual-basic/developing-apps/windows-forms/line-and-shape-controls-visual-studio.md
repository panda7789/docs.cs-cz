...
Ovládací prvky jazyka Visual Basic Power Pack Line a Shape jsou grafické ovládací prvky, které vám umožní kreslení čar vodorovné, svislé a diagonálních, obdélníky, čtverce, elipsy, kroužky a obdélníky a čtverce s zaoblenými hranami ve formuláři nebo kontejneru.  
...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Uvádí a popisuje ovládací prvky Line a Shape a popisuje objektový model.  
 ...
 Ukazuje, jak používat <xref:Microsoft.VisualBasic.PowerPacks.LineShape> řízení kreslení čar v době návrhu a v době běhu.  
 ...
 Ukazuje, jak používat <xref:Microsoft.VisualBasic.PowerPacks.OvalShape> a <xref:Microsoft.VisualBasic.PowerPacks.RectangleShape> ovládací prvky pro kreslení tvarů v době návrhu a v době běhu.  
 ...
 Ukazuje, jak povolit uživatelům přesunovat mezi tvary pomocí klávesnice.  
