...
---
# <a name="type-lttypenamegt-has-no-type-parameters-and-so-cannot-have-type-arguments"></a>Typ '&lt;typename&gt;' nemá žádný typ parametrů, nemůže proto mít argumenty typu
