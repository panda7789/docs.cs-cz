...
ms.locfileid: "54639572"
---
# <a name="no-accessible-overloaded-ltmethodnamegt-can-be-called-with-these-arguments-without-a-narrowing-conversion"></a>Žádná dostupná přetížení "&lt;methodname&gt;" nelze volat s těmito argumenty bez zužujícího převodu
Byla volána přetížená metoda, ale žádná metoda byla shoda se seznamem zadané argumenty bez zužujícího převodu.  
  
## <a name="to-correct-this-error"></a>Oprava této chyby  
  
1.  Zadejte `Option Strict Off`.  
  
2.  Změna argumentů tak, aby odpovídala údajům přetížené metody.  
