...
---
# <a name="sorry-we-dont-have-specifics-on-this-visual-basic-error"></a>Omlouváme se, ale k téhle chybě Visual Basicu nemáme podrobnosti.
Je nám líto, ale nemáme žádné konkrétní informace o této chybě. Můžete vyhledat číslo chyby a text zprávy, abyste našli informace na webu. Nebo můžete požádat ostatní vývojáře, aby používali jedno z těchto fór:  
  
 [Visual Basic jazyk](https://social.msdn.microsoft.com/Forums/home?forum=vblanguage)  
 Poskytuje fórum pro otázky týkající se obecné diskuse o syntaxi a kompilátoru Visual Basic jazyka.  
  
 [Visual Basic spolupráce a upgrade](https://social.msdn.microsoft.com/Forums/home?forum=vbinterop)  
 Poskytuje fórum pro otázky týkající se problémů s upgradem na Visual Basic a práci s funkcemi interoperability.  
  
 [Visual Basic IDE](https://social.msdn.microsoft.com/Forums/home?forum=vbide)  
 Poskytuje fórum pro otázky týkající se práce v prostředí sady Visual Studio.  
  
 [Visual Basic obecné](https://social.msdn.microsoft.com/Forums/vstudio/home?forum=vbgeneral)  
 Poskytuje fórum pro otázky týkající se problémů s Visual Basic, které nejsou popsány v jiných fórech.  
  
 [StackOverflow](https://stackoverflow.com/questions/tagged/vb.net)  
 Poskytuje fórum pro otázky a problémy s Visual Basic.  
  
 Další zdroje informací:  
 [Další zdroje informací pro programátory, kteří používají Visual Basic](../getting-started/additional-resources.md)  
  
## <a name="see-also"></a>Viz také

- [Příručka k programování v jazyce Visual Basic](../programming-guide/index.md)
- [Odkaz v jazyce Visual Basic](../reference/index.md)
