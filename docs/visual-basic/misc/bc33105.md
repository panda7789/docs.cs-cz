...
Použití pojmenovaných argumentů v operandech operátoru `If` není platné. Následující příklad způsobí tuto chybu:  
...
```  
 ...
 To se liší od funkce @no__t 0, která umožňuje pojmenovaným argumentům, jak je znázorněno v následujícím kódu:  
