...
\<adresa > není platný soubor Vzdálená adresa. Platná adresa by měla obsahovat protokol, cestu a název souboru.  
 ...
 Byla zadána neplatná adresa pro operace odesílání nebo stahování. Adresy musí obsahovat protokol, jako například `ftp` nebo `http`, platnou cestu a název souboru. Tato chyba může být způsobeno nesprávně analýza cest k souborům.  
