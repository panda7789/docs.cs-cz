...
## <a name="example"></a>Příklad  
 V následujícím příkladu je `totalCustomers` sdílený člen.  
...
```  
 ...
 Vzhledem k tomu, že se sdílí `totalCustomers`, pokus o nastavení počáteční hodnoty v seznamu inicializátoru objektu způsobí tuto chybu.  
