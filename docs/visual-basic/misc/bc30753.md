...
---
# <a name="option-strict-on-disallows-implicit-conversions-from-lttype1gt-to-lttype2gt-the-visual-basic-60-collection-type-is-not-compatible-with-the-net-framework-collection-type"></a>Direktiva Option Strict On nepovoluje implicitní převod z '&lt;type1&gt;"do"&lt;type2&gt;"; typ kolekce jazyka Visual Basic 6.0 není kompatibilní s typem kolekce platformy .NET Framework
