...
---
# <a name="operands-of-type-object-used-for-operator-ltoperatorsymbolgt-use-the-isnot-operator-to-test-object-identity"></a>Operandy typu Object použité pro operátor '&lt;operatorsymbol&gt;"; k otestování identity objektu použijte operátor 'IsNot'
