...
---
# <a name="member-ltmembername1gt-implicitly-declares-ltimplicitmembernamegt-which-conflicts-with-a-member-in-the-base-class-ltbaseclassnamegt"></a>Člen '&lt;membername1&gt;implicitně deklaruje&lt;implicitmembername&gt;', který je v konfliktu se členem v základní třídě'&lt;baseclassname&gt;.
