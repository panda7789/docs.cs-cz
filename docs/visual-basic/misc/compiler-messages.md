...
---
# <a name="visual-basic-compiler-messages"></a>Zprávy kompilátoru Visual Basic
Tato část obsahuje Visual Basic chybové zprávy, ke kterým dochází v době kompilace.
