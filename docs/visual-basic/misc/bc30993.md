...
---
# <a name="property-ltpropertynamegt-cannot-be-initialized-in-an-object-initializer-expression-because-all-accessible-overloads-require-arguments"></a>Vlastnost "&lt;propertyname&gt;' nelze inicializovat ve výrazu inicializátoru objektu, protože všechna dostupná přetížení vyžadují argumenty
