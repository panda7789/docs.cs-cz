...
-   Pokud výraz odkazuje na rozhraní nebo třídy, ověřte, zda kompilátor má přístup k tomuto rozhraní nebo třídy. Možná budete muset kvalifikovat jeho název a možná budete muset přidat odkaz na projekt. Další informace najdete v tématu "Odkazy na projekty" v [NOTINBUILD: řešení referenční dokumentace při více proměnné mají stejný název](http://msdn.microsoft.com/en-us/9601e39f-1911-44e1-ace5-3f6e090408b9).  
  
## <a name="see-also"></a>Viz také  
 [Obecné typy v jazyce Visual Basic](../../visual-basic/programming-guide/language-features/data-types/generic-types.md)  
 [Typy hodnot a odkazové typy](../../visual-basic/programming-guide/language-features/data-types/value-types-and-reference-types.md)  
 [NOTINBUILD postupy: kvalifikovat název deklarovaný Element](http://msdn.microsoft.com/en-us/6bd112f5-df6f-42b8-9427-a9225bfcbaab)  
