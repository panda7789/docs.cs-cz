...
---
# <a name="member-ltmembernamegt-conflicts-with-member-ltmembernamegt-in-the-base-type-ltbasetypenamegt-and-so-should-not-be-declared-overloads"></a>Člen '&lt;membername&gt;"je v konfliktu s členem"&lt;membername&gt;"v základním typu"&lt;basetypename&gt;"a proto nelze deklarovat"přetížení.
