...
---
# <a name="anonymous-type-property-ltpropertynamegt-cannot-be-used-in-the-definition-of-a-lambda-expression-within-the-same-initialization-list"></a>Vlastnost anonymního typu "&lt;propertyname&gt;' nelze použít v definici výrazu lambda v rámci stejného inicializačního seznamu
