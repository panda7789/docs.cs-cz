...
ms.locfileid: "62024427"
---
# <a name="argument-argumentname-must-be-greater-than-zero"></a>Argument '\<název argumentu argumentname >' musí být větší než nula.
Argument není platný, protože je menší než nebo rovna nule.  
