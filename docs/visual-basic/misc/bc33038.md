...
---
# <a name="type-lttypenamegt-must-define-operator-ltoperatorgt-to-be-used-in-a-for-statement"></a>Typ '&lt;typename&gt;'musí definovat operátor'&lt;operátor&gt;"použitého v příkazu"For"
