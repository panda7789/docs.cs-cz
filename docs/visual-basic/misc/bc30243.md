...
---
# <a name="modifier-is-not-valid-on-an-event-declaration"></a>' \<modifier> ' není platný v deklaraci události.
`Event`Příkaz obsahuje neplatné klíčové slovo, například `ReadOnly` .  
  
 **ID chyby:** BC30243  
  
## <a name="to-correct-this-error"></a>Oprava této chyby  
  
1. Odeberte z příkazu neplatné klíčové slovo `Event` .  
