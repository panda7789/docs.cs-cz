...
---
# <a name="class-ltclassnamegt-must-declare-a-sub-new-because-the-ltconstructornamegt-in-its-base-class-ltbaseclassnamegt-is-marked-obsolete"></a>Třídy&lt;classname&gt;' musí deklarovat proceduru Sub New, protože "&lt;constructorname&gt;"v její základní třídě'&lt;baseclassname&gt;"je označená jako zastaralá
