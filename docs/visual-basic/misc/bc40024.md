...
---
# <a name="property-ltpropertynamegt-implicitly-declares-ltimplicitmembernamegt-which-conflicts-with-a-member-implicitly-declared-for-member-ltmembernamegt-in-the-base-class-ltbaseclassnamegt"></a>Vlastnost "&lt;propertyname&gt;implicitně deklaruje&lt;implicitmembername&gt;', který je v konfliktu se členem implicitně deklarovaným pro člena'&lt;membername&gt;" v základní třídě třídy&lt;baseclassname&gt;.
