...
ms.locfileid: "54551888"
---
# <a name="target-folder-is-a-file"></a>Cílová složka je soubor
Při pokusu o provedení akce související s složky zadáváte souboru.  
  
## <a name="to-correct-this-error"></a>Oprava této chyby  
  
-   Zkontrolujte cestu zadáváte Ujistěte se, že zadáváte složky, nikoli soubor.  
...
- [Souboru, složky a vlastnosti jednotky v jazyce Visual Basic](https://msdn.microsoft.com/library/131593e9-d1b0-4c89-9c03-ae8afc458829)
- [Postupy: Určení absolutní cesty souboru v jazyce Visual Basic](https://msdn.microsoft.com/library/4c6769df-e9b9-4b69-bfdf-ce4cfbda30ff)
