...
```  
 ...
 Počínaje verzí jazyka Visual Basic 2008, je možné deklarovat objekt jako instanci anonymního typu, v takovém případě nezadáte datový typ. V deklaracích anonymního typu, klíčové slovo `With` následuje `New`.  
