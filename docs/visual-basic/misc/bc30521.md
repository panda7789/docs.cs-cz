...
---
# <a name="overload-resolution-failed-because-no-accessible-ltmethodgt-is-most-specific-for-these-argumentslterrorgt"></a>Rozlišení přetěžování se nezdařilo, protože žádnou dostupnou "&lt;metoda&gt;" není nejvíce specifická pro tyto argumenty:&lt;chyba&gt;
