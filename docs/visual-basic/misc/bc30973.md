...
---
# <a name="a-class-used-in-the-expression-is-not-loaded-during-debugging-session-not-in-toc"></a>Třída používaná ve výrazu není načtené během ladicí relace (ne ve TOC)
Sem vložte úvod.  
