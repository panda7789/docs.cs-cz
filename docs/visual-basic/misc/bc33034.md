...
---
# <a name="return-and-parameter-types-of-ltlogicaloperatorgt-must-be-lttypenamegt-to-be-used-in-a-ltshortcircuitoperatorgt-expression"></a>Typy vrácených hodnot a parametrů "&lt;logicaloperator&gt;musí být&lt;typename&gt;" pro použití v "&lt;shortcircuitoperator&gt;" výraz
