...
|[CInt](../functions/type-conversion-functions.md)|[Class Constraint](../statements/type-list.md)|[Příkaz Class](../statements/class-statement.md)|[CLng](../functions/type-conversion-functions.md)|  
...
|[Each](../statements/for-each-next-statement.md)|[Else](../statements/else-statement.md)|[ElseIf](../statements/if-then-else-statement.md)|[Příkaz End](../statements/end-statement.md)|  
...
|[If](../statements/if-then-else-statement.md)|[If()](../operators/if-operator.md)|[Implements](../statements/implements-clause.md)|[Příkaz Implements](../statements/implements-statement.md)|  
|[Imports (.NET Namespace and Type)](../statements/imports-statement-net-namespace-and-type.md)|[Imports (XML Namespace)](../statements/imports-statement-xml-namespace.md)|[In](../statements/in-clause.md)|[In (generický modifikátor)](../modifiers/in-generic-modifier.md)|  
...
|[Narrowing](../modifiers/narrowing.md)|[New Constraint](../statements/type-list.md)|[Operátor New](../operators/new-operator.md)|[Next](../statements/for-next-statement.md)|
...
|[Resume](../statements/resume-statement.md)|[Return](../statements/return-statement.md)|[SByte](../data-types/sbyte-data-type.md)|[Výběr](../statements/select-case-statement.md)|
...
|[Řetězec](../data-types/string-data-type.md)|[Structure Constraint](../statements/type-list.md)|[Příkaz Structure](../statements/structure-statement.md)|[Sub](../statements/sub-statement.md)|
...
|Název|Popis|  
|-----------|-----------------|  
|[Souhrn polí](arrays-summary.md)|Lists language elements that are used to create, define, and use arrays.|  
|[Souhrn objektů kolekce](collection-object-summary.md)|Lists language elements that are used for collections.|  
|[Souhrn toku řízení](control-flow-summary.md)|Lists statements that are used for looping and controlling procedure flow.|  
|[Souhrn převodu](conversion-summary.md)|Lists functions that are used to convert numbers, dates, times, and strings.|  
|[Souhrn datových typů](data-types-summary.md)|Lists data types. Also lists functions that are used to convert between data types and verify data types.|  
|[Souhrn dat a časů](dates-and-times-summary.md)|Lists language elements that are used for dates and times.|  
|[Souhrn deklarací a konstant](declarations-and-constants-summary.md)|Lists statements that are used to declare variables, constants, classes, modules, and other programming elements. Also lists language elements that are used to obtain object information, handle events, and implement inheritance.|  
|[Souhrn adresářů a souborů](directories-and-files-summary.md)|Lists functions that are used to control the file system and to process files.|  
|[Souhrn chyb](errors-summary.md)|Lists language elements that are used to catch and return run-time error values.|  
|[Finanční souhrn](financial-summary.md)|Lists functions that are used to perform financial calculations.|  
|[Souhrn vstupu a výstupu](input-and-output-summary.md)|Lists functions that are used to read from and write to files, manage files, and print output.|  
|[Souhrn informací a interakce](information-and-interaction-summary.md)|Lists functions that are used to run other programs, obtain command-line arguments, manipulate COM objects, retrieve color information, and use control dialog boxes.|  
|[Matematický souhrn](math-summary.md)|Lists functions that are used to perform trigonometric and other mathematical calculations.|  
|[Referenční informace k funkci My](my-reference.md)|Lists the objects contained in `My`, a feature that provides access to frequently used methods, properties, and events of the computer on which the application is running, the current application, the application's resources, the application's settings, and so on.|  
|[Souhrn operátorů](operators-summary.md)|Lists assignment and comparison expressions and other operators.|  
|[Souhrn registru](registry-summary.md)|Lists functions that are used to read, save, and delete program settings.|  
|[Souhrn manipulace s řetězci](string-manipulation-summary.md)|Lists functions that are used to manipulate strings.|  
