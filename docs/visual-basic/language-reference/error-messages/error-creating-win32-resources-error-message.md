...
[!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] Kompilátoru volá Linker sestavení (Al.exe, také známé jako Alink) ke generování sestavení s manifestu. Linkeru ohlásilo chybu vytváření prostředek v paměti. Může se jednat o problém s prostředím nebo váš počítač může být nedostatek paměti.  
