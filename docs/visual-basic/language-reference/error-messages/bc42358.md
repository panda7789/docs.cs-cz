...
---
# <a name="because-this-call-is-not-awaited-execution-of-the-current-method-continues-before-the-call-is-completed"></a>Protože toto volání není očekáváno, vykonání aktuální metody pokračuje před dokončením volání.
...
- [Operátor Await](../operators/await-operator.md)
