...
---
# <a name="visual-basic-runtime-library-members"></a><span data-ttu-id="e2de7-102">Členové knihovny prostředí Runtime jazyka Visual Basic</span><span class="sxs-lookup"><span data-stu-id="e2de7-102">Visual Basic Runtime Library Members</span></span>

<span data-ttu-id="e2de7-103">`Microsoft.VisualBasic`Obor názvů obsahuje třídy, moduly, konstanty a výčty, které tvoří knihovnu modulu runtime Visual Basic.</span><span class="sxs-lookup"><span data-stu-id="e2de7-103">The `Microsoft.VisualBasic` namespace contains the classes, modules, constants, and enumerations that constitute the Visual Basic runtime library.</span></span> <span data-ttu-id="e2de7-104">Tyto členy knihovny poskytují procedury, vlastnosti a konstantní hodnoty, které můžete použít ve svém kódu.</span><span class="sxs-lookup"><span data-stu-id="e2de7-104">These library members provide procedures, properties, and constant values you can use in your code.</span></span> <span data-ttu-id="e2de7-105">Každý modul a třída představuje konkrétní kategorii funkcí.</span><span class="sxs-lookup"><span data-stu-id="e2de7-105">Each module and class represents a particular category of functionality.</span></span>  
  
## <a name="microsoftvisualbasiccollection-class"></a><span data-ttu-id="e2de7-106">Microsoft. VisualBasic. Collection – Třída</span><span class="sxs-lookup"><span data-stu-id="e2de7-106">Microsoft.VisualBasic.Collection Class</span></span>  
...
## <a name="microsoftvisualbasiccomclassattribute-class"></a><span data-ttu-id="e2de7-107">Microsoft. VisualBasic. ComClassAttribute – třída</span><span class="sxs-lookup"><span data-stu-id="e2de7-107">Microsoft.VisualBasic.ComClassAttribute Class</span></span>  
...
## <a name="microsoftvisualbasiccontrolchars-class"></a><span data-ttu-id="e2de7-108">Microsoft. VisualBasic. ControlChars – třída</span><span class="sxs-lookup"><span data-stu-id="e2de7-108">Microsoft.VisualBasic.ControlChars Class</span></span>  
...
## <a name="microsoftvisualbasicconstants-class"></a><span data-ttu-id="e2de7-109">Třída Microsoft. VisualBasic. konstanty</span><span class="sxs-lookup"><span data-stu-id="e2de7-109">Microsoft.VisualBasic.Constants Class</span></span>  
...
## <a name="microsoftvisualbasicconversion-module"></a><span data-ttu-id="e2de7-110">Microsoft. VisualBasic. Conversion – modul</span><span class="sxs-lookup"><span data-stu-id="e2de7-110">Microsoft.VisualBasic.Conversion Module</span></span>  
...
## <a name="microsoftvisualbasicdateandtime-module"></a><span data-ttu-id="e2de7-111">Microsoft. VisualBasic. DateAndTime – modul</span><span class="sxs-lookup"><span data-stu-id="e2de7-111">Microsoft.VisualBasic.DateAndTime Module</span></span>  
...
## <a name="microsoftvisualbasicerrobject-class"></a><span data-ttu-id="e2de7-112">Microsoft. VisualBasic. ErrObject – třída</span><span class="sxs-lookup"><span data-stu-id="e2de7-112">Microsoft.VisualBasic.ErrObject Class</span></span>  
...
## <a name="microsoftvisualbasicfilesystem-module"></a><span data-ttu-id="e2de7-113">Microsoft. VisualBasic. FileSystem – modul</span><span class="sxs-lookup"><span data-stu-id="e2de7-113">Microsoft.VisualBasic.FileSystem Module</span></span>  
...
## <a name="microsoftvisualbasicfinancial-module"></a><span data-ttu-id="e2de7-114">Microsoft. VisualBasic. Financial – modul</span><span class="sxs-lookup"><span data-stu-id="e2de7-114">Microsoft.VisualBasic.Financial Module</span></span>  
...
## <a name="microsoftvisualbasicglobals-module"></a><span data-ttu-id="e2de7-115">Microsoft. VisualBasic. Globals – modul</span><span class="sxs-lookup"><span data-stu-id="e2de7-115">Microsoft.VisualBasic.Globals Module</span></span>  
...
## <a name="microsoftvisualbasichidemodulenameattribute-class"></a><span data-ttu-id="e2de7-116">Microsoft. VisualBasic. HideModuleNameAttribute – třída</span><span class="sxs-lookup"><span data-stu-id="e2de7-116">Microsoft.VisualBasic.HideModuleNameAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## <a name="microsoftvisualbasicinformation-module"></a><span data-ttu-id="e2de7-117">Microsoft. VisualBasic. Information – modul</span><span class="sxs-lookup"><span data-stu-id="e2de7-117">Microsoft.VisualBasic.Information Module</span></span>  
...
## <a name="microsoftvisualbasicinteraction-module"></a><span data-ttu-id="e2de7-118">Microsoft. VisualBasic. interakcí – modul</span><span class="sxs-lookup"><span data-stu-id="e2de7-118">Microsoft.VisualBasic.Interaction Module</span></span>  
...
## <a name="microsoftvisualbasicmygroupcollectionattribute-class"></a><span data-ttu-id="e2de7-119">Microsoft. VisualBasic. MyGroupCollectionAttribute nedá – třída</span><span class="sxs-lookup"><span data-stu-id="e2de7-119">Microsoft.VisualBasic.MyGroupCollectionAttribute Class</span></span>  
...
## <a name="microsoftvisualbasicstrings-module"></a><span data-ttu-id="e2de7-120">Microsoft. VisualBasic. Strings – modul</span><span class="sxs-lookup"><span data-stu-id="e2de7-120">Microsoft.VisualBasic.Strings Module</span></span>  
...
## <a name="microsoftvisualbasicvbfixedarrayattribute-class"></a><span data-ttu-id="e2de7-121">Microsoft. VisualBasic. VBFixedArrayAttribute – Třída</span><span class="sxs-lookup"><span data-stu-id="e2de7-121">Microsoft.VisualBasic.VBFixedArrayAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Bounds%2A>|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Length%2A>|||  
  
## <a name="microsoftvisualbasicvbfixedstringattribute-class"></a><span data-ttu-id="e2de7-122">Microsoft. VisualBasic. VBFixedStringAttribute – Třída</span><span class="sxs-lookup"><span data-stu-id="e2de7-122">Microsoft.VisualBasic.VBFixedStringAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute.Length%2A>||||  
  
## <a name="microsoftvisualbasicvbmath-module"></a><span data-ttu-id="e2de7-123">Microsoft. VisualBasic. VbMath – modul</span><span class="sxs-lookup"><span data-stu-id="e2de7-123">Microsoft.VisualBasic.VbMath Module</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBMath.Randomize%2A>|<xref:Microsoft.VisualBasic.VBMath.Rnd%2A>|||  
  
## <a name="microsoftvisualbasic-constants-and-enumerations"></a><span data-ttu-id="e2de7-124">Konstanty a výčty Microsoft. VisualBasic</span><span class="sxs-lookup"><span data-stu-id="e2de7-124">Microsoft.VisualBasic Constants and Enumerations</span></span>  

 <span data-ttu-id="e2de7-125">`Microsoft.VisualBasic`Obor názvů poskytuje konstanty a výčty jako součást Visual Basic knihovny runtime.</span><span class="sxs-lookup"><span data-stu-id="e2de7-125">The `Microsoft.VisualBasic` namespace provides constants and enumerations as part of the Visual Basic run-time library.</span></span> <span data-ttu-id="e2de7-126">Tyto konstantní hodnoty můžete použít ve svém kódu.</span><span class="sxs-lookup"><span data-stu-id="e2de7-126">You can use these constant values in your code.</span></span> <span data-ttu-id="e2de7-127">Každý výčet představuje konkrétní kategorii funkcí.</span><span class="sxs-lookup"><span data-stu-id="e2de7-127">Each enumeration represents a particular category of functionality.</span></span> <span data-ttu-id="e2de7-128">Další informace naleznete v tématu [konstanty a výčty](constants-and-enumerations.md).</span><span class="sxs-lookup"><span data-stu-id="e2de7-128">For more information, see [Constants and Enumerations](constants-and-enumerations.md).</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="e2de7-129">Viz také</span><span class="sxs-lookup"><span data-stu-id="e2de7-129">See also</span></span>

- [<span data-ttu-id="e2de7-130">Konstanty a výčty</span><span class="sxs-lookup"><span data-stu-id="e2de7-130">Constants and Enumerations</span></span>](constants-and-enumerations.md)
- [<span data-ttu-id="e2de7-131">Klíčová slova</span><span class="sxs-lookup"><span data-stu-id="e2de7-131">Keywords</span></span>](keywords/index.md)
