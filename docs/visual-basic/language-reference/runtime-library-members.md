...
---
# <a name="visual-basic-runtime-library-members"></a><span data-ttu-id="fb16c-102">Členové knihovny prostředí Runtime jazyka Visual Basic</span><span class="sxs-lookup"><span data-stu-id="fb16c-102">Visual Basic Runtime Library Members</span></span>
<span data-ttu-id="fb16c-103">`Microsoft.VisualBasic` Obor názvů obsahuje třídy, moduly, konstanty a výčty, které tvoří [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] běhové knihovny.</span><span class="sxs-lookup"><span data-stu-id="fb16c-103">The `Microsoft.VisualBasic` namespace contains the classes, modules, constants, and enumerations that constitute the [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] runtime library.</span></span> <span data-ttu-id="fb16c-104">Členové tyto knihovny poskytují postupy, vlastnosti a konstantní hodnoty, které můžete použít v kódu.</span><span class="sxs-lookup"><span data-stu-id="fb16c-104">These library members provide procedures, properties, and constant values you can use in your code.</span></span> <span data-ttu-id="fb16c-105">Každý modul a třída představuje určité kategorie funkcí.</span><span class="sxs-lookup"><span data-stu-id="fb16c-105">Each module and class represents a particular category of functionality.</span></span>  
  
## <a name="microsoftvisualbasiccollection-class"></a><span data-ttu-id="fb16c-106">Microsoft.VisualBasic.Collection – třída</span><span class="sxs-lookup"><span data-stu-id="fb16c-106">Microsoft.VisualBasic.Collection Class</span></span>  
...
## <a name="microsoftvisualbasiccomclassattribute-class"></a><span data-ttu-id="fb16c-107">Microsoft.VisualBasic.ComClassAttribute – třída</span><span class="sxs-lookup"><span data-stu-id="fb16c-107">Microsoft.VisualBasic.ComClassAttribute Class</span></span>  
...
## <a name="microsoftvisualbasiccontrolchars-class"></a><span data-ttu-id="fb16c-108">Microsoft.VisualBasic.ControlChars – třída</span><span class="sxs-lookup"><span data-stu-id="fb16c-108">Microsoft.VisualBasic.ControlChars Class</span></span>  
...
## <a name="microsoftvisualbasicconstants-class"></a><span data-ttu-id="fb16c-109">Microsoft.VisualBasic.Constants – třída</span><span class="sxs-lookup"><span data-stu-id="fb16c-109">Microsoft.VisualBasic.Constants Class</span></span>  
...
## <a name="microsoftvisualbasicconversion-module"></a><span data-ttu-id="fb16c-110">Modul Microsoft.VisualBasic.Conversion</span><span class="sxs-lookup"><span data-stu-id="fb16c-110">Microsoft.VisualBasic.Conversion Module</span></span>  
...
## <a name="microsoftvisualbasicdateandtime-module"></a><span data-ttu-id="fb16c-111">Modul Microsoft.VisualBasic.DateAndTime</span><span class="sxs-lookup"><span data-stu-id="fb16c-111">Microsoft.VisualBasic.DateAndTime Module</span></span>  
...
## <a name="microsoftvisualbasicerrobject-class"></a><span data-ttu-id="fb16c-112">Microsoft.VisualBasic.ErrObject – třída</span><span class="sxs-lookup"><span data-stu-id="fb16c-112">Microsoft.VisualBasic.ErrObject Class</span></span>  
...
## <a name="microsoftvisualbasicfilesystem-module"></a><span data-ttu-id="fb16c-113">Modul Microsoft.VisualBasic.FileSystem</span><span class="sxs-lookup"><span data-stu-id="fb16c-113">Microsoft.VisualBasic.FileSystem Module</span></span>  
...
## <a name="microsoftvisualbasicfinancial-module"></a><span data-ttu-id="fb16c-114">Modul Microsoft.VisualBasic.Financial</span><span class="sxs-lookup"><span data-stu-id="fb16c-114">Microsoft.VisualBasic.Financial Module</span></span>  
...
## <a name="microsoftvisualbasicglobals-module"></a><span data-ttu-id="fb16c-115">Modul Microsoft.VisualBasic.Globals</span><span class="sxs-lookup"><span data-stu-id="fb16c-115">Microsoft.VisualBasic.Globals Module</span></span>  
...
## <a name="microsoftvisualbasichidemodulenameattribute-class"></a><span data-ttu-id="fb16c-116">Microsoft.VisualBasic.HideModuleNameAttribute – třída</span><span class="sxs-lookup"><span data-stu-id="fb16c-116">Microsoft.VisualBasic.HideModuleNameAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## <a name="microsoftvisualbasicinformation-module"></a><span data-ttu-id="fb16c-117">Modul Microsoft.VisualBasic.Information</span><span class="sxs-lookup"><span data-stu-id="fb16c-117">Microsoft.VisualBasic.Information Module</span></span>  
...
## <a name="microsoftvisualbasicinteraction-module"></a><span data-ttu-id="fb16c-118">Modul Microsoft.VisualBasic.Interaction</span><span class="sxs-lookup"><span data-stu-id="fb16c-118">Microsoft.VisualBasic.Interaction Module</span></span>  
...
## <a name="microsoftvisualbasicmygroupcollectionattribute-class"></a><span data-ttu-id="fb16c-119">Microsoft.VisualBasic.MyGroupCollectionAttribute – třída</span><span class="sxs-lookup"><span data-stu-id="fb16c-119">Microsoft.VisualBasic.MyGroupCollectionAttribute Class</span></span>  
...
## <a name="microsoftvisualbasicstrings-module"></a><span data-ttu-id="fb16c-120">Modul Microsoft.VisualBasic.Strings</span><span class="sxs-lookup"><span data-stu-id="fb16c-120">Microsoft.VisualBasic.Strings Module</span></span>  
...
## <a name="microsoftvisualbasicvbfixedarrayattribute-class"></a><span data-ttu-id="fb16c-121">Microsoft.VisualBasic.VBFixedArrayAttribute – třída</span><span class="sxs-lookup"><span data-stu-id="fb16c-121">Microsoft.VisualBasic.VBFixedArrayAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Bounds%2A>|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Length%2A>|||  
  
## <a name="microsoftvisualbasicvbfixedstringattribute-class"></a><span data-ttu-id="fb16c-122">Microsoft.VisualBasic.VBFixedStringAttribute – třída</span><span class="sxs-lookup"><span data-stu-id="fb16c-122">Microsoft.VisualBasic.VBFixedStringAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute.Length%2A>||||  
  
## <a name="microsoftvisualbasicvbmath-module"></a><span data-ttu-id="fb16c-123">Modul Microsoft.VisualBasic.VbMath</span><span class="sxs-lookup"><span data-stu-id="fb16c-123">Microsoft.VisualBasic.VbMath Module</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBMath.Randomize%2A>|<xref:Microsoft.VisualBasic.VBMath.Rnd%2A>|||  
  
## <a name="microsoftvisualbasic-constants-and-enumerations"></a><span data-ttu-id="fb16c-124">Microsoft.VisualBasic – konstanty a výčty</span><span class="sxs-lookup"><span data-stu-id="fb16c-124">Microsoft.VisualBasic Constants and Enumerations</span></span>  
 <span data-ttu-id="fb16c-125">`Microsoft.VisualBasic` Obor názvů obsahuje konstanty a výčty v rámci [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] běhové knihovny.</span><span class="sxs-lookup"><span data-stu-id="fb16c-125">The `Microsoft.VisualBasic` namespace provides constants and enumerations as part of the [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] run-time library.</span></span> <span data-ttu-id="fb16c-126">Můžete tyto hodnoty konstant ve vašem kódu.</span><span class="sxs-lookup"><span data-stu-id="fb16c-126">You can use these constant values in your code.</span></span> <span data-ttu-id="fb16c-127">Každý výčet představuje určité kategorie funkcí.</span><span class="sxs-lookup"><span data-stu-id="fb16c-127">Each enumeration represents a particular category of functionality.</span></span> <span data-ttu-id="fb16c-128">Další informace najdete v tématu [konstanty a výčty](../../visual-basic/language-reference/constants-and-enumerations.md).</span><span class="sxs-lookup"><span data-stu-id="fb16c-128">For more information, see [Constants and Enumerations](../../visual-basic/language-reference/constants-and-enumerations.md).</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="fb16c-129">Viz také</span><span class="sxs-lookup"><span data-stu-id="fb16c-129">See Also</span></span>  
 [<span data-ttu-id="fb16c-130">Konstanty a výčty</span><span class="sxs-lookup"><span data-stu-id="fb16c-130">Constants and Enumerations</span></span>](../../visual-basic/language-reference/constants-and-enumerations.md)  
 [<span data-ttu-id="fb16c-131">Klíčová slova</span><span class="sxs-lookup"><span data-stu-id="fb16c-131">Keywords</span></span>](../../visual-basic/language-reference/keywords/index.md)
