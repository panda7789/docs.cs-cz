...
---
# <a name="visual-basic-runtime-library-members"></a><span data-ttu-id="4ab3d-102">Členové knihovny prostředí Runtime jazyka Visual Basic</span><span class="sxs-lookup"><span data-stu-id="4ab3d-102">Visual Basic Runtime Library Members</span></span>
<span data-ttu-id="4ab3d-103">`Microsoft.VisualBasic` Obor názvů obsahuje třídy, moduly, konstanty a výčty, které tvoří knihovny prostředí runtime jazyka Visual Basic.</span><span class="sxs-lookup"><span data-stu-id="4ab3d-103">The `Microsoft.VisualBasic` namespace contains the classes, modules, constants, and enumerations that constitute the Visual Basic runtime library.</span></span> <span data-ttu-id="4ab3d-104">Členové tyto knihovny poskytují postupy, vlastnosti a konstantní hodnoty, které můžete používat ve vašem kódu.</span><span class="sxs-lookup"><span data-stu-id="4ab3d-104">These library members provide procedures, properties, and constant values you can use in your code.</span></span> <span data-ttu-id="4ab3d-105">Každý modul a třída představuje určité kategorie funkce.</span><span class="sxs-lookup"><span data-stu-id="4ab3d-105">Each module and class represents a particular category of functionality.</span></span>  
  
## <a name="microsoftvisualbasiccollection-class"></a><span data-ttu-id="4ab3d-106">Třída Microsoft.VisualBasic.Collection</span><span class="sxs-lookup"><span data-stu-id="4ab3d-106">Microsoft.VisualBasic.Collection Class</span></span>  
...
## <a name="microsoftvisualbasiccomclassattribute-class"></a><span data-ttu-id="4ab3d-107">Microsoft.VisualBasic.ComClassAttribute třídy</span><span class="sxs-lookup"><span data-stu-id="4ab3d-107">Microsoft.VisualBasic.ComClassAttribute Class</span></span>  
...
## <a name="microsoftvisualbasiccontrolchars-class"></a><span data-ttu-id="4ab3d-108">Microsoft.VisualBasic.ControlChars Class</span><span class="sxs-lookup"><span data-stu-id="4ab3d-108">Microsoft.VisualBasic.ControlChars Class</span></span>  
...
## <a name="microsoftvisualbasicconstants-class"></a><span data-ttu-id="4ab3d-109">Microsoft.VisualBasic.Constants Class</span><span class="sxs-lookup"><span data-stu-id="4ab3d-109">Microsoft.VisualBasic.Constants Class</span></span>  
...
## <a name="microsoftvisualbasicconversion-module"></a><span data-ttu-id="4ab3d-110">Microsoft.VisualBasic.Conversion Module</span><span class="sxs-lookup"><span data-stu-id="4ab3d-110">Microsoft.VisualBasic.Conversion Module</span></span>  
...
## <a name="microsoftvisualbasicdateandtime-module"></a><span data-ttu-id="4ab3d-111">Microsoft.VisualBasic.DateAndTime Module</span><span class="sxs-lookup"><span data-stu-id="4ab3d-111">Microsoft.VisualBasic.DateAndTime Module</span></span>  
...
## <a name="microsoftvisualbasicerrobject-class"></a><span data-ttu-id="4ab3d-112">Microsoft.VisualBasic.ErrObject Class</span><span class="sxs-lookup"><span data-stu-id="4ab3d-112">Microsoft.VisualBasic.ErrObject Class</span></span>  
...
## <a name="microsoftvisualbasicfilesystem-module"></a><span data-ttu-id="4ab3d-113">Microsoft.VisualBasic.FileSystem Module</span><span class="sxs-lookup"><span data-stu-id="4ab3d-113">Microsoft.VisualBasic.FileSystem Module</span></span>  
...
## <a name="microsoftvisualbasicfinancial-module"></a><span data-ttu-id="4ab3d-114">Microsoft.VisualBasic.Financial Module</span><span class="sxs-lookup"><span data-stu-id="4ab3d-114">Microsoft.VisualBasic.Financial Module</span></span>  
...
## <a name="microsoftvisualbasicglobals-module"></a><span data-ttu-id="4ab3d-115">Microsoft.VisualBasic.Globals Module</span><span class="sxs-lookup"><span data-stu-id="4ab3d-115">Microsoft.VisualBasic.Globals Module</span></span>  
...
## <a name="microsoftvisualbasichidemodulenameattribute-class"></a><span data-ttu-id="4ab3d-116">Microsoft.VisualBasic.HideModuleNameAttribute Class</span><span class="sxs-lookup"><span data-stu-id="4ab3d-116">Microsoft.VisualBasic.HideModuleNameAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## <a name="microsoftvisualbasicinformation-module"></a><span data-ttu-id="4ab3d-117">Microsoft.VisualBasic.Information modulu</span><span class="sxs-lookup"><span data-stu-id="4ab3d-117">Microsoft.VisualBasic.Information Module</span></span>  
...
## <a name="microsoftvisualbasicinteraction-module"></a><span data-ttu-id="4ab3d-118">Microsoft.VisualBasic.Interaction Module</span><span class="sxs-lookup"><span data-stu-id="4ab3d-118">Microsoft.VisualBasic.Interaction Module</span></span>  
...
## <a name="microsoftvisualbasicmygroupcollectionattribute-class"></a><span data-ttu-id="4ab3d-119">Microsoft.VisualBasic.MyGroupCollectionAttribute Class</span><span class="sxs-lookup"><span data-stu-id="4ab3d-119">Microsoft.VisualBasic.MyGroupCollectionAttribute Class</span></span>  
...
## <a name="microsoftvisualbasicstrings-module"></a><span data-ttu-id="4ab3d-120">Microsoft.VisualBasic.Strings Module</span><span class="sxs-lookup"><span data-stu-id="4ab3d-120">Microsoft.VisualBasic.Strings Module</span></span>  
...
## <a name="microsoftvisualbasicvbfixedarrayattribute-class"></a><span data-ttu-id="4ab3d-121">Microsoft.VisualBasic.VBFixedArrayAttribute Class</span><span class="sxs-lookup"><span data-stu-id="4ab3d-121">Microsoft.VisualBasic.VBFixedArrayAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Bounds%2A>|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Length%2A>|||  
  
## <a name="microsoftvisualbasicvbfixedstringattribute-class"></a><span data-ttu-id="4ab3d-122">Microsoft.VisualBasic.VBFixedStringAttribute Class</span><span class="sxs-lookup"><span data-stu-id="4ab3d-122">Microsoft.VisualBasic.VBFixedStringAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute.Length%2A>||||  
  
## <a name="microsoftvisualbasicvbmath-module"></a><span data-ttu-id="4ab3d-123">Microsoft.VisualBasic.VbMath Module</span><span class="sxs-lookup"><span data-stu-id="4ab3d-123">Microsoft.VisualBasic.VbMath Module</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBMath.Randomize%2A>|<xref:Microsoft.VisualBasic.VBMath.Rnd%2A>|||  
  
## <a name="microsoftvisualbasic-constants-and-enumerations"></a><span data-ttu-id="4ab3d-124">Microsoft.VisualBasic konstanty a výčty</span><span class="sxs-lookup"><span data-stu-id="4ab3d-124">Microsoft.VisualBasic Constants and Enumerations</span></span>  
 <span data-ttu-id="4ab3d-125">`Microsoft.VisualBasic` Obor názvů obsahuje konstanty a výčty jako součást knihovny run-time jazyka Visual Basic.</span><span class="sxs-lookup"><span data-stu-id="4ab3d-125">The `Microsoft.VisualBasic` namespace provides constants and enumerations as part of the Visual Basic run-time library.</span></span> <span data-ttu-id="4ab3d-126">Můžete použít tyto hodnoty konstant ve vašem kódu.</span><span class="sxs-lookup"><span data-stu-id="4ab3d-126">You can use these constant values in your code.</span></span> <span data-ttu-id="4ab3d-127">Každý výčet představuje konkrétní kategorii funkce.</span><span class="sxs-lookup"><span data-stu-id="4ab3d-127">Each enumeration represents a particular category of functionality.</span></span> <span data-ttu-id="4ab3d-128">Další informace najdete v tématu [konstanty a výčty](../../visual-basic/language-reference/constants-and-enumerations.md).</span><span class="sxs-lookup"><span data-stu-id="4ab3d-128">For more information, see [Constants and Enumerations](../../visual-basic/language-reference/constants-and-enumerations.md).</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="4ab3d-129">Viz také:</span><span class="sxs-lookup"><span data-stu-id="4ab3d-129">See also</span></span>

- [<span data-ttu-id="4ab3d-130">Konstanty a výčty</span><span class="sxs-lookup"><span data-stu-id="4ab3d-130">Constants and Enumerations</span></span>](../../visual-basic/language-reference/constants-and-enumerations.md)
- [<span data-ttu-id="4ab3d-131">Klíčová slova</span><span class="sxs-lookup"><span data-stu-id="4ab3d-131">Keywords</span></span>](../../visual-basic/language-reference/keywords/index.md)
