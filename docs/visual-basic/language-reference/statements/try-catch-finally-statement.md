...
## <a name="see-also"></a>Viz také  
 ...
 [Osvědčené postupy pro používání fragmentů kódu](/visualstudio/ide/best-practices-for-using-code-snippets)  
 [Zpracování výjimek](https://msdn.microsoft.com/library/dd997415)  
