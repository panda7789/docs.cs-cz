...
|`Of`|Volitelná. Určuje, že se jedná o obecné rozhraní.|  
...
|`Inherits`|Volitelná. Označuje, že toto rozhraní dědí atributy a členy jiného rozhraní nebo rozhraní. Viz [příkaz Inherits](../../../visual-basic/language-reference/statements/inherits-statement.md).|  
|`interfacenames`|Vyžaduje se, pokud použijete příkaz `Inherits`. Názvy rozhraní, ze kterých je toto rozhraní odvozeno.|  
|`modifiers`|Volitelná. Odpovídající modifikátory pro člena rozhraní, který je definován.|  
|`Property`|Volitelná. Definuje vlastnost, která je členem rozhraní.|  
|`Function`|Volitelná. Definuje proceduru `Function`, která je členem rozhraní.|  
|`Sub`|Volitelná. Definuje proceduru `Sub`, která je členem rozhraní.|  
|`Event`|Volitelná. Definuje událost, která je členem rozhraní.|  
|`Interface`|Volitelná. Definuje rozhraní, které je vnořené v rámci tohoto rozhraní. Definice vnořeného rozhraní musí končit příkazem `End Interface`.|  
|`Class`|Volitelná. Definuje třídu, která je členem rozhraní. Definice členské třídy musí končit příkazem `End Class`.|  
|`Structure`|Volitelná. Definuje strukturu, která je členem rozhraní. Definice struktury členů musí být ukončena příkazem `End Structure`.|  
 ...
 *Rozhraní* definuje sadu členů, jako jsou například vlastnosti a postupy, které mohou implementovat třídy a struktury. Rozhraní definuje pouze podpisy členů a nikoli jejich interní úkoly.  
 ...
 `Interface` můžete použít jenom na úrovni oboru názvů nebo modulu. To znamená, že *kontext deklarace* pro rozhraní musí být zdrojový soubor, obor názvů, třída, struktura, modul nebo rozhraní a nemůže být procedura nebo blok. Další informace najdete v tématu [deklarace kontextů a výchozích úrovní přístupu](../../../visual-basic/language-reference/statements/declaration-contexts-and-default-access-levels.md).  
