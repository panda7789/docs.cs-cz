...
|Termín|Definice|
|---|---|
|`attributelist`|Volitelné. Viz [seznam atributů](attribute-list.md).|
...
|`Shadows`|Volitelné. Viz [Shadows](../modifiers/shadows.md).|
|`Partial`|Volitelné. Označuje částečnou definici struktury. Zobrazit [částečné](../modifiers/partial.md).|
...
|`Implements`|Volitelné. Označuje, že tato struktura implementuje členy jednoho nebo více rozhraní. Viz [příkaz Implements](implements-statement.md).|
