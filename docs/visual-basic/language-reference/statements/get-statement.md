...
|`statements`|Volitelné. One or more statements that run when the `Get` property procedure is called.|  
|`End Get`|Požadováno. Terminates the definition of the `Get` property procedure.|  
