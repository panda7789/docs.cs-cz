...
Díky tomu, že se Azure stará o správu uzlů ve vašem clusteru AKS, už řadu úloh, například upgrady clusteru, nemusíte provádět ručně. Vzhledem k tomu, že Azure zpracovává tyto kritické úlohy údržby za vás, neposkytuje AKS přímý přístup (například s SSH) do clusteru.
...
Přechodná data založená na příkazech nebo událostech sloužících k orchestraci chování aplikace mohou používat fronty Azure Service Bus nebo Azure Storage. Azure Service Bus nabízí větší flexibilitu a jedná se o doporučenou službu pro netriviální zasílání zpráv v rámci aplikací a mezi nimi.
