...
Jedna z vlastních implementací do sběrnice Event v eShopOnContainers je v podstatě knihovna využívající rozhraní RabbitMQ API. (K dispozici je jiná implementace založená na Azure Service Bus.)
