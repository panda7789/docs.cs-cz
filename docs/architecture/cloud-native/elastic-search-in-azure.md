...
- Zástupný znak (s použitím filtrů\*nebo?)
...
- [CQRS (Command and Query Responsibility Segregation) (CQRS) – vzor](https://docs.microsoft.com/azure/architecture/patterns/cqrs)

- [Vzor zdroje událostí](https://docs.microsoft.com/azure/architecture/patterns/event-sourcing)

- [RDBMSs vs. databáze NoSQL: Přehled](https://maxivak.com/rdbms-vs-nosql-databases/)
...
- [Materializované zobrazení](https://docs.microsoft.com/azure/architecture/patterns/materialized-view)
...
- [Vzor kompenzační transakce](https://docs.microsoft.com/azure/architecture/patterns/compensating-transaction)
