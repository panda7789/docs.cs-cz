...
---
# <a name="front-end-client-communication"></a>Klientská komunikace front-endu
...
| Zjišťování služeb (s Consul a Eureka) | Omezování |
...
| QoS (Quality of Service) | Zásady opakování |
...
**Obrázek 4-5.** Application Gateway adaptér příchozího přenosu dat
...
![API Management Azure](./media/azure-api-management.png)

**Obrázek 4-6.** API Management Azure
...
> V době psaní je úroveň spotřeby ve verzi Preview v cloudu Azure.
...
**Obrázek 4-7.** Signál Azure

Další výhodou služby signalizace Azure je implementace cloudových služeb bez serveru. Je možné, že váš kód je spuštěn na vyžádání s Azure Functions triggery. Tento scénář může být obtížné, protože váš kód neudržuje dlouhá připojení ke klientům. Služba signalizace Azure může tuto situaci obsloužit, protože služba již pro vás spravuje připojení.
