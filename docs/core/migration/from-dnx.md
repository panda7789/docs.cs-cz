...
Pokud používáte jiné `dnx` cílí, jako je třeba `dnx451` budete muset změnit ty také. `dnx451` měli byste místo `net451`.
Najdete [.NET Standard](../../standard/net-standard.md) tématu pro další informace.
