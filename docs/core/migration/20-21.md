...
- Odeberte `<DotNetCliToolReference>` odkazy na nástroje, které jsou součástí sady SDK .NET Core 2,1 (v 2.1.300 nebo novější). Mezi tyto odkazy patří:
  ...
  - [dotnet-Watch](https://github.com/aspnet/DotNetTools/blob/master/src/dotnet-watch/README.md) (Microsoft. dotnet. sledovací proces. Tools)
  - [dotnet-User-tajná](https://github.com/aspnet/DotNetTools/blob/master/src/dotnet-user-secrets/README.md) (Microsoft. Extensions. SecretManager. Tools)
