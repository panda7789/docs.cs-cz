...
[Obecné pokyny](https://docs.microsoft.com/dotnet/standard/microservices-architecture/net-core-net-framework-containers/general-guidance) rozhodování mezi .NET Core a rozhraní .NET Framework pro vývoj kontejner Docker.
...
* [Microsoft Azure rozhraní příkazového řádku (CLI) Image na DockerHub](Docker image for Microsoft Azure Command Line Interface) 
...
* [Použití emulátoru DB Cosmos Azure pro místní vývoj a testování](https://docs.microsoft.com/azure/cosmos-db/local-emulator#developing-with-the-emulator)
...
* [Návrh a vývoj aplikace s více kontejneru a na základě Mikroslužbu .NET](../standard/microservices-architecture/multi-container-microservice-net-applications)
* [Rozšíření sady Visual Studio Code Docker](https://code.visualstudio.com/docs/languages/dockerfile) 
* [Naučte se používat Azure Service Fabric](https://docs.microsoft.com/azure/service-fabric/) 
...
* [Výhody Windows kontejnery](https://docs.microsoft.com/virtualization/windowscontainers/about/index#video-overview)
...
* [Další základní informace o Docker s .NET Core](../docker/docker-basics-dotnet-core.md)
* [Vytváření bitových kopií Docker .NET Core](../docker/building-net-docker-images)