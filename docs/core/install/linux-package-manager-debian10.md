...
---
# <a name="debian-10-package-manager---install-net-core"></a>Debian 10 Správce balíčků - Instalace .NET Core
...
Aktualizujte produkty, které jsou k dispozici pro instalaci, a nainstalujte ASP.NET runtime. V terminálu spusťte následující příkazy.
