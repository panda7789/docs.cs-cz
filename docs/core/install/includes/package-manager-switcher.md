...
<span data-ttu-id="cd045-116">_Instalace správce balíčků jsou podporovány pouze na architektuře **x64** _.</span><span class="sxs-lookup"><span data-stu-id="cd045-116">_Package manager installs are only supported on the **x64** architecture_.</span></span> <span data-ttu-id="cd045-117">Jiné architektury, například **ARM**, musí [ručně nainstalovat sadku .NET Core SDK](../sdk.md?pivots=os-linux#download-and-manually-install) nebo [ručně nainstalovat rozhraní .NET Core Runtime](../runtime.md?pivots=os-linux#download-and-manually-install).</span><span class="sxs-lookup"><span data-stu-id="cd045-117">Other architectures, such as **ARM**, must [manually install the .NET Core SDK](../sdk.md?pivots=os-linux#download-and-manually-install) or [manually install the .NET Core Runtime](../runtime.md?pivots=os-linux#download-and-manually-install).</span></span> <span data-ttu-id="cd045-118">Další informace naleznete v tématu [.NET Core závislosti a požadavky](../dependencies.md).</span><span class="sxs-lookup"><span data-stu-id="cd045-118">For more information, see [.NET Core dependencies and requirements](../dependencies.md).</span></span>
