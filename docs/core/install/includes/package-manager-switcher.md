...
_Instalace správce balíčků jsou podporovány pouze na architektuře **x64** _. Jiné architektury, například **ARM**, musí [ručně nainstalovat sadku .NET Core SDK](../sdk.md?pivots=os-linux#download-and-manually-install) nebo [ručně nainstalovat rozhraní .NET Core Runtime](../runtime.md?pivots=os-linux#download-and-manually-install). Další informace naleznete v tématu [.NET Core závislosti a požadavky](../dependencies.md).
