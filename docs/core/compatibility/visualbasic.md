...
ms.locfileid: "74567427"
---
# <a name="visual-basic-breaking-changes"></a>Visual Basic přerušující změny

Následuje seznam nejnovějších změn v Visual Basic verze .NET Core.
