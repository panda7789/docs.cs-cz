...
### <a name="nugetconfig-differences"></a><span data-ttu-id="4cf27-121">rozdíly v NuGet. config</span><span class="sxs-lookup"><span data-stu-id="4cf27-121">nuget.config differences</span></span>
