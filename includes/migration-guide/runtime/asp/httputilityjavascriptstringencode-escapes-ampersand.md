...
|Návrh|Pokud vaše aplikace závisí na předchozí chování tuto metodu, můžete přidat nastavení aspnet:JavaScriptDoNotEncodeAmpersand [ASP.NET appSettings element](https://msdn.microsoft.com/library/hh975440.aspx) v konfiguračním souboru.|
|Rozsah|Vedlejší|
|Version|4.5|
|Typ|Modul runtime|
