...
|Návrh|Kterákoli z následujících akcí:<ol><li>Upgrade na rozhraní .NET 4.7.</li><li>Nainstalujte nejnovější údržby oprava pro platformu .NET 4.6.2.</li><li>Nedošlo k odebrání sloupce dokud asynchronní odpověď na <xref:System.Windows.Controls.DataGrid.ScrollIntoView(System.Object)> byla dokončena.</li></ol>|
|Rozsah|Edge|
|Version|4.6.2|
|Typ|Modul runtime|
