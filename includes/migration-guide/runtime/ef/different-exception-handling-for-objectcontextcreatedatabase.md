...
|   |   |
|---|---|
|Podrobnosti|Od verze rozhraní .NET Framework 4.5, v případě selhání vytvoření databáze <code>CreateDatabase</code> metody se pokusí o odpojení prázdná databáze. Pokud tuto operace úspěšná, původní <xref:System.Data.SqlClient.SqlException?displayProperty=name> se rozšíří (místo <xref:System.InvalidOperationException?displayProperty=name> , vždy byla vydána v rozhraní .NET Framework 4.0)|
