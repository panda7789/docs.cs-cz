...
Metody analýzy s plovoucí desetinnou čárkou již nevyvolávají <xref:System.OverflowException> ani vracejí `false` při analýze řetězce, jehož číselná hodnota je mimo rozsah <xref:System.Single> nebo <xref:System.Double> typu s plovoucí desetinnou čárkou.
